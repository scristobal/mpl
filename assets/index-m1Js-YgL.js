...
(() => {
  ...
  for (let e = 0, t = 0; e < n.length; e++) (e % 2 ? R0 : Oh).push(t = t + n[e]);
})();
function Qw(n) {
  if (n < 768) return false;
  for (let e = 0, t = Oh.length; ; ) {
    let i = e + t >> 1;
    if (n < Oh[i]) t = i;
    else if (n >= R0[i]) e = i + 1;
    else return true;
    if (e == t) return false;
  }
}
...
const Rp = 8205;
function Xw(n, e, t = true, i = true) {
  return (t ? P0 : Zw)(n, e, i);
}
function P0(n, e, t) {
  if (e == n.length) return e;
  e && B0(n.charCodeAt(e)) && I0(n.charCodeAt(e - 1)) && e--;
  let i = Ff(n, e);
  for (e += Pp(i); e < n.length; ) {
    let r = Ff(n, e);
    if (i == Rp || r == Rp || t && Qw(r)) e += Pp(r), i = r;
    else if (Dp(r)) {
      let s = 0, o = e - 2;
      for (; o >= 0 && Dp(Ff(n, o)); ) s++, o -= 2;
      if (s % 2 == 0) break;
      e += 2;
    } else break;
  }
...
function Ff(n, e) {
  ...
  if (!I0(t) || e + 1 == n.length) return t;
  let i = n.charCodeAt(e + 1);
  return B0(i) ? (t - 55296 << 10) + (i - 56320) + 65536 : t;
}
function B0(n) {
...
let Qe = class N0 {
  ...
  static of(e) {
    ...
    return e.length == 1 && !e[0] ? N0.empty : e.length <= 32 ? new Rt(e) : rr.from(Rt.split(e, []));
  }
};
class Rt extends Qe {
  constructor(e, t = ex(e)) {
  ...
  lineInner(e, t, i, r) {
    for (let s = 0; ; s++) {
      ...
      if ((t ? i : l) >= e) return new tx(r, l, i, o);
      r = l + 1, i++;
    }
  }
  decompose(e, t, i, r) {
    let s = e <= 0 && t >= this.length ? this : new Rt(Bp(this.text, e, t), Math.min(t, this.length) - Math.max(0, e));
    if (r & 1) {
      let o = i.pop(), l = sc(s.text, o.text.slice(), 0, s.length);
  ...
  replace(e, t, i) {
    ...
    [e, t] = vo(this, e, t);
    let r = sc(this.text, sc(i.text, Bp(this.text, 0, e)), t), s = this.length + i.length - (t - e);
...
class rr extends Qe {
  ...
  replace(e, t, i) {
    if ([e, t] = vo(this, e, t), i.lines < this.lines) for (let r = 0, s = 0; r < this.children.length; r++) {
...
typeof Symbol < "u" && (Qe.prototype[Symbol.iterator] = function() {
  return this.iter();
}, Al.prototype[Symbol.iterator] = F0.prototype[Symbol.iterator] = H0.prototype[Symbol.iterator] = function() {
  return this;
});
class tx {
  constructor(e, t, i, r) {
...
function $n(n, e) {
  let t = n.charCodeAt(e);
  if (!ix(t) || e + 1 == n.length) return t;
  let i = n.charCodeAt(e + 1);
  return nx(i) ? (t - 55296 << 10) + (i - 56320) + 65536 : t;
}
function rd(n) {
...
class fr {
  ...
  mapDesc(e, t = false) {
    return e.empty ? this : Dh(this, e, t);
  }
...
class Ut extends fr {
  ...
  apply(e) {
    ...
    return Lh(this, (t, i, r, s, o) => e = e.replace(r, r + (i - t), o), false), e;
  }
  mapDesc(e, t = false) {
    return Dh(this, e, t, true);
  }
  invert(e) {
  ...
  compose(e) {
    return this.empty ? e : e.empty ? this : V0(this, e, true);
  }
  map(e, t = false) {
    return e.empty ? this : Dh(this, e, t, true);
  }
  ...
  static of(e, t, i) {
    ...
    function f(h) {
      if (Array.isArray(h)) for (let p of h) f(p);
        ...
        let S = b ? typeof b == "string" ? Qe.of(b.split(i || _h)) : b : Qe.empty, M = S.length;
        if (p == m && M == 0) return;
...
class be {
  constructor(e, t, i, r, s) {
    this.combine = e, this.compareInput = t, this.compare = i, this.isStatic = r, this.id = sd++, this.default = e([]), this.extensions = typeof s == "function" ? s(this) : s;
  }
  get reader() {
    return this;
  }
  static define(e = {}) {
    return new be(e.combine || ((t) => t), e.compareInput || ((t, i) => t === i), e.compare || (e.combine ? (t, i) => t === i : od), !!e.static, e.enables);
  }
  of(e) {
    return new oc([], this, 0, e);
  }
  compute(e, t) {
    if (this.isStatic) throw new Error("Can't compute a static facet");
    return new oc(e, this, 1, t);
  }
  computeN(e, t) {
    if (this.isStatic) throw new Error("Can't compute a static facet");
    return new oc(e, this, 2, t);
  }
  from(e, t) {
...
class oc {
  constructor(e, t, i, r) {
    this.dependencies = e, this.facet = t, this.type = i, this.value = r, this.id = sd++;
  }
  dynamicSlot(e) {
    var t;
    ...
    return { create(p) {
      ...
      if (a && m.docChanged || f && (m.docChanged || m.selection) || Rh(p, h)) {
        let b = i(p);
        if (l ? !Ip(b, p.values[o], r) : !r(b, p.values[o])) return p.values[o] = b, 1;
      }
      return 0;
    }, reconfigure: (p, m) => {
      ...
      if (S != null) {
        let M = Cc(m, S);
        if (this.dependencies.every((A) => A instanceof be ? m.facet(A) === p.facet(A) : A instanceof Yt ? m.field(A, false) == p.field(A, false) : true) || (l ? Ip(b = i(p), M, r) : r(b = i(p), M))) return p.values[o] = M, 0;
      } else b = i(p);
...
function Rh(n, e) {
  let t = false;
  for (let i of e) Tl(n, i) & 1 && (t = true);
  return t;
}
function rx(n, e, t) {
  ...
  return { create(a) {
    ...
    let h = Rh(a, i), p = f.config.facets[e.id], m = f.facet(e);
    if (p && !h && od(t, p)) return a.values[o] = m, 0;
    let b = l(a);
    return e.compare(b, m) ? (a.values[o] = m, 0) : (a.values[o] = b, 1);
  } };
}
const Ta = be.define({ static: true });
class Yt {
  constructor(e, t, i, r, s) {
    this.id = e, this.createF = t, this.updateF = i, this.compareF = r, this.spec = s, this.provides = void 0;
  }
  static define(e) {
    let t = new Yt(sd++, e.create, e.update, e.compare || ((i, r) => i === r), e);
    return e.provide && (t.provides = e.provide(t)), t;
  }
  create(e) {
    let t = e.facet(Ta).find((i) => i.field == this);
  ...
  slot(e) {
    ...
    return { create: (i) => (i.values[t] = this.create(i), 1), update: (i, r) => {
      ...
      let s = i.facet(Ta), o = r.facet(Ta), l;
  ...
  init(e) {
    return [this, Ta.of({ field: this, create: e })];
  }
  get extension() {
    return this;
  }
...
class kc {
  ...
  static resolve(e, t, i) {
    ...
    for (let m of sx(e, t, o)) m instanceof Yt ? r.push(m) : (s[m.facet.id] || (s[m.facet.id] = [])).push(m);
    ...
    for (let m in s) {
      ...
      if (b.every((A) => A.type == 0)) if (l[S.id] = a.length << 1 | 1, od(M, b)) a.push(i.facet(S));
      else {
        ...
        l[S.id] = f.length << 1, f.push((A) => rx(A, S, b));
      }
    }
    let p = f.map((m) => m(l));
    return new kc(e, o, p, l, a, s);
  }
}
function sx(n, e, t) {
  ...
  function s(o, l) {
    ...
    if (a != null) {
      if (a <= l) return;
      let f = i[a].indexOf(o);
      f > -1 && i[a].splice(f, 1), o instanceof Ph && t.delete(o.compartment);
    }
    ...
    } else if (o instanceof $0) s(o.inner, o.prec);
    else if (o instanceof Yt) i[l].push(o), o.provides && s(o.provides, l);
    else if (o instanceof oc) i[l].push(o), o.facet.extensions && s(o.facet.extensions, ks.default);
    else {
      let f = o.extension;
...
const z0 = be.define(), Bh = be.define({ combine: (n) => n.some((e) => e), static: true }), K0 = be.define({ combine: (n) => n.length ? n[0] : void 0, static: true }), j0 = be.define(), q0 = be.define(), U0 = be.define(), G0 = be.define({ combine: (n) => n.length ? n[0] : false });
class Er {
  constructor(e, t) {
...
_e.reconfigure = _e.define();
_e.appendConfig = _e.define();
class Gt {
  constructor(e, t, i, r, s, o) {
    this.startState = e, this.changes = t, this.selection = i, this.effects = r, this.annotations = s, this.scrollIntoView = o, this._doc = null, this._state = null, i && W0(i, t.newLength), s.some((l) => l.type == Gt.time) || (this.annotations = s.concat(Gt.time.of(Date.now())));
  }
...
function Y0(n, e, t) {
  var i;
  let r, s, o;
  return t ? (r = e.changes, s = Ut.empty(e.changes.length), o = n.changes.compose(e.changes)) : (r = e.changes.map(n.changes), s = n.changes.mapDesc(e.changes, true), o = n.changes.compose(r)), { changes: o, selection: e.selection ? e.selection.map(s) : (i = n.selection) === null || i === void 0 ? void 0 : i.map(r), effects: _e.mapEffects(n.effects, r).concat(_e.mapEffects(e.effects, s)), annotations: n.annotations.length ? n.annotations.concat(e.annotations) : e.annotations, scrollIntoView: n.scrollIntoView || e.scrollIntoView };
}
function Ih(n, e, t) {
  let i = e.selection, r = fo(e.annotations);
  return e.userEvent && (r = r.concat(Gt.userEvent.of(e.userEvent))), { changes: e.changes instanceof Ut ? e.changes : Ut.of(e.changes || [], t, n.facet(K0)), selection: i && (i instanceof j ? i : j.single(i.anchor, i.head)), effects: fo(e.effects), annotations: r, scrollIntoView: !!e.scrollIntoView };
}
function J0(n, e, t) {
  let i = Ih(n, e.length ? e[0] : {}, n.doc.length);
  e.length && e[0].filter === false && (t = false);
  for (let s = 1; s < e.length; s++) {
    e[s].filter === false && (t = false);
    let o = !!e[s].sequential;
    i = Y0(i, Ih(n, e[s], o ? i.changes.newLength : n.doc.length), o);
  }
...
function cx(n) {
  ...
  for (let r of e.facet(j0)) {
    ...
    Array.isArray(s) && (t = t === true ? s : ax(t, s));
  }
  if (t !== true) {
    let r, s;
    ...
    n = Gt.create(e, r, n.selection && n.selection.map(s), _e.mapEffects(n.effects, s), n.annotations, n.scrollIntoView);
  }
  let i = e.facet(q0);
  for (let r = i.length - 1; r >= 0; r--) {
    let s = i[r](n);
    s instanceof Gt ? n = s : Array.isArray(s) && s.length == 1 && s[0] instanceof Gt ? n = s[0] : n = J0(e, fo(s), false);
  }
  return n;
}
function fx(n) {
  let e = n.startState, t = e.facet(U0), i = n;
  for (let r = t.length - 1; r >= 0; r--) {
    let s = t[r](n);
    s && Object.keys(s).length && (i = Y0(i, Ih(e, s, n.changes.newLength), true));
  }
  return i == n ? n : Gt.create(e, n.changes, n.selection, i.effects, i.annotations, i.scrollIntoView);
}
const hx = [];
function fo(n) {
  return n == null ? hx : Array.isArray(n) ? n : [n];
}
var St = (function(n) {
  return n[n.Word = 0] = "Word", n[n.Space = 1] = "Space", n[n.Other = 2] = "Other", n;
})(St || (St = {}));
const ux = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/;
let Nh;
try {
  Nh = new RegExp("[\\p{Alphabetic}\\p{Number}_]", "u");
} catch {
}
function dx(n) {
  if (Nh) return Nh.test(n);
  for (let e = 0; e < n.length; e++) {
    let t = n[e];
    if (/\w/.test(t) || t > "\x80" && (t.toUpperCase() != t.toLowerCase() || ux.test(t))) return true;
  }
  return false;
}
function px(n) {
...
class $e {
  constructor(e, t, i, r, s, o) {
    ...
    for (let l = 0; l < this.config.dynamicSlots.length; l++) Tl(this, l << 1);
  ...
  field(e, t = true) {
    ...
    return Tl(this, i), Cc(this, i);
  }
  update(...e) {
    return J0(this, e, true);
  }
  applyTransaction(e) {
    let t = this.config, { base: i, compartments: r } = t;
    for (let l of e.effects) l.is(nr.reconfigure) ? (t && (r = /* @__PURE__ */ new Map(), t.compartments.forEach((a, f) => r.set(f, a)), t = null), r.set(l.value.compartment, l.value.extension)) : l.is(_e.reconfigure) ? (t = null, i = l.value) : l.is(_e.appendConfig) && (t = null, i = fo(i).concat(l.value));
    let s;
    t ? s = e.startState.values.slice() : (t = kc.resolve(i, r, this), s = new $e(t, this.doc, this.selection, t.dynamicSlots.map(() => null), (a, f) => f.reconfigure(a, this), null).values);
    let o = e.startState.facet(Bh) ? e.newSelection : e.newSelection.asSingle();
  ...
  changeByRange(e) {
    let t = this.selection, i = e(t.ranges[0]), r = this.changes(i.changes), s = [i.range], o = fo(i.effects);
    for (let l = 1; l < t.ranges.length; l++) {
      let a = e(t.ranges[l]), f = this.changes(a.changes), h = f.map(r);
      for (let m = 0; m < l; m++) s[m] = s[m].map(h);
      let p = r.mapDesc(f, true);
      s.push(a.range.map(p)), r = r.compose(h), o = _e.mapEffects(o, h).concat(_e.mapEffects(fo(a.effects), p));
    }
  ...
  toText(e) {
    return Qe.of(e.split(this.facet($e.lineSeparator) || _h));
  }
  ...
  facet(e) {
    ...
    return t == null ? e.default : (Tl(this, t), Cc(this, t));
  }
  toJSON(e) {
  ...
  static create(e = {}) {
    let t = kc.resolve(e.extensions || [], /* @__PURE__ */ new Map()), i = e.doc instanceof Qe ? e.doc : Qe.of((e.doc || "").split(t.staticFacet($e.lineSeparator) || _h)), r = e.selection ? e.selection instanceof j ? e.selection : j.single(e.selection.anchor, e.selection.head) : j.single(0);
    return W0(r, i.length), t.staticFacet(Bh) || (r = r.asSingle()), new $e(t, i, r, t.dynamicSlots.map(() => null), (s, o) => o.create(s), null);
  }
  get tabSize() {
...
`;
  ...
  languageDataAt(e, t, i = -1) {
    let r = [];
    for (let s of this.facet(z0)) for (let o of s(this, t, i)) Object.prototype.hasOwnProperty.call(o, e) && r.push(o[e]);
    return r;
  }
  charCategorizer(e) {
    return px(this.languageDataAt("wordChars", e).join(""));
  }
  wordAt(e) {
...
$e.transactionExtender = U0;
nr.reconfigure = _e.define();
function Or(n, e, t = {}) {
  let i = {};
...
class ld {
  ...
  map(e, t) {
    ...
    return { mapped: i.length ? new ld(r, s, i, l) : null, pos: o };
  }
}
class ze {
  constructor(e, t, i, r) {
  ...
  update(e) {
    ...
    if (i && (t = t.slice().sort(Hh)), this.isEmpty) return t.length ? ze.of(t) : this;
    let l = new X0(this, null, -1).goto(0), a = 0, f = [], h = new Ri();
  ...
  static compare(e, t, i, r, s = -1) {
    let o = e.filter((p) => p.maxPoint > 0 || !p.isEmpty && p.maxPoint >= s), l = t.filter((p) => p.maxPoint > 0 || !p.isEmpty && p.maxPoint >= s), a = Np(o, l, i), f = new sl(o, a, s), h = new sl(l, a, s);
    i.iterGaps((p, m, b) => Fp(f, p, h, m, b, r)), i.empty && i.length == 0 && Fp(f, 0, h, 0, 0, r);
  }
  static eq(e, t, i = 0, r) {
    r == null && (r = 999999999);
    ...
    let l = Np(s, o), a = new sl(s, l, 0).goto(i), f = new sl(o, l, 0).goto(i);
    for (; ; ) {
      if (a.to != f.to || !Vh(a.active, f.active) || a.point && (!f.point || !a.point.eq(f.point))) return false;
  ...
  static of(e, t = false) {
    let i = new Ri();
    for (let r of e instanceof Fh ? [e] : t ? gx(e) : e) i.add(r.from, r.to, r.value);
    return i.finish();
  }
  static join(e) {
...
function gx(n) {
  if (n.length > 1) for (let e = n[0], t = 1; t < n.length; t++) {
    let i = n[t];
    if (Hh(e, i) > 0) return n.slice().sort(Hh);
    e = i;
  }
  return n;
}
...
class Ri {
  finishChunk(e) {
    this.chunks.push(new ld(this.from, this.to, this.value, this.maxPoint)), this.chunkPos.push(this.chunkStart), this.chunkStart = -1, this.setMaxPoint = Math.max(this.setMaxPoint, this.maxPoint), this.maxPoint = -1, e && (this.from = [], this.to = [], this.value = []);
  }
  constructor() {
...
class Wl {
  ...
  static from(e, t = null, i = -1) {
    let r = [];
    for (let s = 0; s < e.length; s++) for (let o = e[s]; !o.isEmpty; o = o.nextLayer) o.maxPoint >= i && r.push(new X0(o, t, i, s));
  ...
  goto(e, t = -1e9) {
    ...
    for (let i = this.heap.length >> 1; i >= 0; i--) Hf(this.heap, i);
  ...
  next() {
    if (this.heap.length == 0) this.from = this.to = 1e9, this.value = null, this.rank = -1;
      ...
      let e = this.heap[0];
      this.from = e.from, this.to = e.to, this.value = e.value, this.rank = e.rank, e.value && e.next(), Hf(this.heap, 0);
    }
  }
}
function Hf(n, e) {
...
class sl {
  ...
  removeActive(e) {
    Ea(this.active, e), Ea(this.activeTo, e), Ea(this.activeRank, e), this.minActive = Hp(this.active, this.activeTo);
  }
  addActive(e) {
    let t = 0, { value: i, to: r, rank: s } = this.cursor;
    for (; t < this.activeRank.length && (s - this.activeRank[t] || r - this.activeTo[t]) > 0; ) t++;
    Oa(this.active, t, i), Oa(this.activeTo, t, r), Oa(this.activeRank, t, s), e && Oa(e, t, this.cursor.from), this.minActive = Hp(this.active, this.activeTo);
  }
  next() {
...
function Fp(n, e, t, i, r, s) {
  ...
  for (; ; ) {
    ...
    if (n.point || t.point ? n.point && t.point && (n.point == t.point || n.point.eq(t.point)) && Vh(n.activeForPoint(n.to), t.activeForPoint(t.to)) || s.comparePoint(l, m, n.point, t.point) : m > l && !Vh(n.active, t.active) && s.compareRange(l, m, n.active, t.active), p > o) break;
...
const $h = "\u037C", Vp = typeof Symbol > "u" ? "__" + $h : Symbol.for($h), zh = typeof Symbol > "u" ? "__styleSet" + Math.floor(Math.random() * 1e8) : Symbol("styleSet"), Wp = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : {};
class Yr {
  constructor(e, t) {
    this.rules = [];
    let { finish: i } = t || {};
...
`);
  ...
  static newName() {
    let e = Wp[Vp] || 1;
    return Wp[Vp] = e + 1, $h + e.toString(36);
  }
  static mount(e, t, i) {
    let r = e[zh], s = i && i.nonce;
    r ? s && r.setNonce(s) : r = new mx(e, s), r.mount(Array.isArray(t) ? t : [t], e);
  }
}
...
class mx {
  constructor(e, t) {
    ...
    if (!e.head && e.adoptedStyleSheets && r.CSSStyleSheet) {
      let s = $p.get(i);
      if (s) return e[zh] = s;
      this.sheet = new r.CSSStyleSheet(), $p.set(i, this);
...
for (var Vf in Jr) $l.hasOwnProperty(Vf) || ($l[Vf] = Jr[Vf]);
function bx(n) {
  var e = yx && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || vx && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", t = !e && n.key || (n.shiftKey ? $l : Jr)[n.keyCode] || n.key || "Unidentified";
...
function ct() {
  ...
  for (; e < arguments.length; e++) Z0(n, arguments[e]);
  return n;
}
function Z0(n, e) {
  if (typeof e == "string") n.appendChild(document.createTextNode(e));
  else if (e != null) if (e.nodeType != null) n.appendChild(e);
  else if (Array.isArray(e)) for (var t = 0; t < e.length; t++) Z0(n, e[t]);
  else throw new RangeError("Unsupported child node: " + e);
}
let Dn = typeof navigator < "u" ? navigator : { userAgent: "", vendor: "", platform: "" }, Kh = typeof document < "u" ? document : { documentElement: { style: {} } };
const jh = /Edge\/(\d+)/.exec(Dn.userAgent), ey = /MSIE \d/.test(Dn.userAgent), qh = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Dn.userAgent), ef = !!(ey || qh || jh), zp = !ef && /gecko\/(\d+)/i.test(Dn.userAgent), Wf = !ef && /Chrome\/(\d+)/.exec(Dn.userAgent), wx = "webkitFontSmoothing" in Kh.documentElement.style, Uh = !ef && /Apple Computer/.test(Dn.vendor), Kp = Uh && (/Mobile\/\w+/.test(Dn.userAgent) || Dn.maxTouchPoints > 2);
var ue = { mac: Kp || /Mac/.test(Dn.platform), windows: /Win/.test(Dn.platform), linux: /Linux|X11/.test(Dn.platform), ie: ef, ie_version: ey ? Kh.documentMode || 6 : qh ? +qh[1] : jh ? +jh[1] : 0, gecko: zp, gecko_version: zp ? +(/Firefox\/(\d+)/.exec(Dn.userAgent) || [0, 0])[1] : 0, chrome: !!Wf, chrome_version: Wf ? +Wf[1] : 0, ios: Kp, android: /Android\b/.test(Dn.userAgent), webkit_version: wx ? +(/\bAppleWebKit\/(\d+)/.exec(Dn.userAgent) || [0, 0])[1] : 0, safari: Uh, safari_version: Uh ? +(/\bVersion\/(\d+(\.\d+)?)/.exec(Dn.userAgent) || [0, 0])[1] : 0, tabSize: Kh.documentElement.style.tabSize != null ? "tab-size" : "-moz-tab-size" };
function zl(n) {
  let e;
...
function El(n, e, t, i) {
  return t ? jp(n, e, t, i, -1) || jp(n, e, t, i, 1) : false;
}
function Ns(n) {
...
function Sx(n, e, t, i, r, s, o, l) {
  ...
  for (let h = n, p = false; h && !p; ) if (h.nodeType == 1) {
    ...
    if (b) m = xx(f);
      ...
      ({ scaleX: S, scaleY: M } = ty(h, R)), m = { left: R.left, right: R.left + h.clientWidth * S, top: R.top, bottom: R.top + h.clientHeight * M };
    }
    let A = 0, _ = 0;
...
let qp;
function Fs(n, e, t = e) {
  let i = qp || (qp = document.createRange());
...
function sy(n, e) {
  for (let t = n, i = e; ; ) {
    ...
    } else if (t.parentNode && !Mc(t)) i = Ns(t), t = t.parentNode;
    else return null;
  }
}
function oy(n, e) {
  for (let t = n, i = e; ; ) {
    ...
    } else if (t.parentNode && !Mc(t)) i = Ns(t) + 1, t = t.parentNode;
    else return null;
  }
}
class gn {
...
class lt {
  ...
  sync(e, t) {
    if (this.flags & 2) {
      ...
      for (let o of this.children) {
        ...
        if (s = r ? r.nextSibling : i.firstChild, t && !t.written && t.node == i && s != o.dom && (t.written = true), o.dom.parentNode == i) for (; s && s != o.dom; ) s = Up(s);
        else i.insertBefore(o.dom, s);
        r = o.dom;
      }
      for (s = r ? r.nextSibling : i.firstChild, s && t && t.node == i && (t.written = true); s; ) s = Up(s);
  ...
  childCursor(e = this.length) {
    return new ly(this.children, e, this.children.length);
  }
  childPos(e, t = 1) {
...
function cy(n, e, t, i, r, s) {
  ...
  n.length += p, ay(n, f, h, l, a, i, 0, r, s);
}
const Tx = 256;
class Pi extends lt {
  constructor(e) {
  ...
  merge(e, t, i) {
    return this.flags & 8 || i && (!(i instanceof Pi) || this.length - (t - e) + i.length > Tx || i.flags & 8) ? false : (this.text = this.text.slice(0, e) + (i ? i.text : "") + this.text.slice(t), this.markDirty(), true);
  }
  split(e) {
...
class Ar extends lt {
  ...
  setAttrs(e) {
    if (iy(e), this.mark.class && (e.className = this.mark.class), this.mark.attrs) for (let t in this.mark.attrs) e.setAttribute(t, this.mark.attrs[t]);
    return e;
  }
  canReuseDOM(e) {
  ...
  merge(e, t, i, r, s, o) {
    return i && (!(i instanceof Ar && i.mark.eq(this.mark)) || e && s <= 0 || t < this.length && o <= 0) ? false : (cy(this, e, t, i ? i.children.slice() : [], s - 1, o - 1), this.markDirty(), true);
  }
  split(e) {
    let t = [], i = 0, r = -1, s = 0;
...
function Ex(n, e, t) {
  ...
  return ue.safari && !o && a.width == 0 && (a = Array.prototype.find.call(l, (f) => f.width) || a), o ? tf(a, o < 0) : a || null;
}
class jr extends lt {
  static create(e, t, i) {
    return new jr(e, t, i);
...
Pi.prototype.children = jr.prototype.children = bo.prototype.children = ad;
function fy(n, e) {
...
function hy(n, e, t) {
  let i, { children: r } = n;
  t > 0 && e instanceof Ar && r.length && (i = r[r.length - 1]) instanceof Ar && i.mark.eq(e.mark) ? hy(i, e.children[0], t - 1) : (r.push(e), e.setParent(n)), n.length += e.length;
}
function uy(n, e, t) {
  ...
  function l(f, h) {
    for (let p = 0, m = 0; p < f.children.length && m <= h; p++) {
      ...
      S >= h && (b.children.length ? l(b, h - m) : (!s || s.isHidden && (t > 0 || _x(s, b))) && (S > h || m == S && b.getSide() > 0) ? (s = b, o = h - m) : (m < h || m == S && b.getSide() < 0 && !b.isHidden) && (i = b, r = h - m)), m = S;
    }
  }
  l(n, e);
  let a = (t < 0 ? i : s) || i || s;
  return a ? a.coordsAt(Math.max(0, a == i ? r : o), t) : Ox(n);
}
function Ox(n) {
...
class ta extends ve {
  constructor(e) {
    let { start: t, end: i } = dy(e);
    super(t ? -1 : 5e8, i ? 1 : -6e8, null, e), this.tagName = e.tagName || "span", this.class = e.class || "", this.attrs = e.attributes || null;
  }
  eq(e) {
    var t, i;
    return this == e || e instanceof ta && this.tagName == e.tagName && (this.class || ((t = this.attrs) === null || t === void 0 ? void 0 : t.class)) == (e.class || ((i = e.attrs) === null || i === void 0 ? void 0 : i.class)) && Ac(this.attrs, e.attrs, "class");
  }
  range(e, t = e) {
...
class na extends ve {
  ...
  eq(e) {
    return e instanceof na && this.spec.class == e.spec.class && Ac(this.spec.attributes, e.spec.attributes);
  }
  range(e, t = e) {
...
class Qr extends ve {
  ...
  eq(e) {
    return e instanceof Qr && Dx(this.widget, e.widget) && this.block == e.block && this.startSide == e.startSide && this.endSide == e.endSide;
  }
  range(e, t = e) {
...
class Wt extends lt {
  ...
  merge(e, t, i, r, s, o) {
    ...
    return r && this.setDeco(i ? i.attrs : null), cy(this, e, t, i ? i.children.slice() : [], s, o), true;
  }
  split(e) {
    let t = new Wt();
  ...
  setDeco(e) {
    Ac(this.attrs, e) || (this.dom && (this.prevAttrs = this.attrs, this.markDirty()), this.attrs = e);
  }
  append(e, t) {
    hy(this, e, t);
  }
  addLineDeco(e) {
    ...
    t && (this.attrs = Yh(t, this.attrs || {})), i && (this.attrs = Yh({ class: i }, this.attrs || {}));
  }
  domAtPos(e) {
    return fy(this, e);
  }
  ...
  sync(e, t) {
    var i;
    this.dom ? this.flags & 4 && (iy(this.dom), this.dom.className = "cm-line", this.prevAttrs = this.attrs ? null : void 0) : (this.setDOM(document.createElement("div")), this.dom.className = "cm-line", this.prevAttrs = this.attrs ? null : void 0), this.prevAttrs !== void 0 && (Jh(this.dom, this.prevAttrs, this.attrs), this.dom.classList.add("cm-line"), this.prevAttrs = void 0), super.sync(e, t);
  ...
  become(e) {
    return e instanceof Wt && this.children.length == 0 && e.children.length == 0 && Ac(this.attrs, e.attrs) && this.breakAfter == e.breakAfter;
  }
  covers() {
    return true;
  }
...
class kr extends lt {
  ...
  coordsAt(e, t) {
    let i = this.widget.coordsAt(this.dom, e, t);
    return i || (this.widget instanceof Qh ? null : tf(this.dom.getBoundingClientRect(), this.length ? e == 0 : t <= 0));
  }
  destroy() {
    super.destroy(), this.dom && this.widget.destroy(this.dom);
  }
...
class Ol {
  ...
  flushBuffer(e = this.bufferMarks) {
    this.pendingBuffer && (this.curLine.append(_a(new bo(-1), e), e.length), this.pendingBuffer = 0);
  }
  addBlockWidget(e) {
  ...
  buildText(e, t, i) {
    for (; e > 0; ) {
      ...
      this.flushBuffer(t.slice(t.length - i)), this.getLine().append(_a(new Pi(this.text.slice(this.textOff, this.textOff + s)), t), i), this.atCursorPos = true, this.textOff += s, e -= s, i = r <= s ? 0 : t.length;
    }
  }
  span(e, t, i, r) {
  ...
  point(e, t, i, r, s, o) {
    ...
    let l = t - e;
    if (i instanceof Qr) if (i.block) i.startSide > 0 && !this.posCovered() && this.getLine(), this.addBlockWidget(new kr(i.widget || wo.block, l, i));
    else {
      let a = jr.create(i.widget || wo.inline, l, l ? 0 : i.startSide), f = this.atCursorPos && !a.isEditable && s <= r.length && (e < t || i.startSide > 0), h = !a.isEditable && (e < t || s > r.length || i.startSide <= 0), p = this.getLine();
      this.pendingBuffer == 2 && !f && !a.isEditable && (this.pendingBuffer = 0), this.flushBuffer(r), f && (p.append(_a(new bo(1), r), s), s = r.length + Math.max(0, s - r.length)), p.append(_a(a, r), s), this.atCursorPos = h, this.pendingBuffer = h ? e < t || s > r.length ? 1 : 2 : 0, this.pendingBuffer && (this.bufferMarks = r.slice());
    }
...
wo.inline = new wo("span");
wo.block = new wo("div");
var gt = (function(n) {
  return n[n.LTR = 0] = "LTR", n[n.RTL = 1] = "RTL", n;
})(gt || (gt = {}));
const Hs = gt.LTR, cd = gt.RTL;
function py(n) {
  let e = [];
  for (let t = 0; t < n.length; t++) e.push(1 << +n[t]);
  return e;
}
const Rx = py("88888888888888888888888888888888888666888888787833333333337888888000000000000000000000000008888880000000000000000000000000088888888888888888888888888888888888887866668888088888663380888308888800000000000000000000000800000000000000000000000000000008"), Px = py("4444448826627288999999999992222222222222222222222222222222222222222222222229999999999999999999994444444444644222822222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222999999949999999229989999223333333333"), Xh = /* @__PURE__ */ Object.create(null), Gi = [];
for (let n of ["()", "[]", "{}"]) {
  let e = n.charCodeAt(0), t = n.charCodeAt(1);
  Xh[e] = t, Xh[t] = -e;
}
function gy(n) {
  return n <= 247 ? Rx[n] : 1424 <= n && n <= 1524 ? 2 : 1536 <= n && n <= 1785 ? Px[n - 1536] : 1774 <= n && n <= 2220 ? 4 : 8192 <= n && n <= 8204 ? 256 : 64336 <= n && n <= 65023 ? 4 : 1;
}
const Bx = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\ufb50-\ufdff]/;
class qr {
  get dir() {
    return this.level % 2 ? cd : Hs;
  }
  constructor(e, t, i) {
...
function my(n, e) {
  ...
  for (let t = 0; t < n.length; t++) {
    let i = n[t], r = e[t];
    if (i.from != r.from || i.to != r.to || i.direction != r.direction || !my(i.inner, r.inner)) return false;
  }
  return true;
}
const ft = [];
...
function Nx(n, e, t, i, r) {
  ...
  for (let o = 0, l = 0, a = 0; o <= i.length; o++) {
    ...
    for (let p = f, m, b, S; p < h; p++) if (b = Xh[m = n.charCodeAt(p)]) if (b < 0) {
  ...
  if (i % 2 == r % 2) for (let a = e, f = 0; a < t; ) {
    ...
    e: for (; ; ) if (f < s.length && S == s[f].from) {
      ...
      if (f++, m) m.push(M);
        ...
        eu(n, A ? i + 1 : i, r, M.inner, M.from, M.to, o), a = M.to;
      }
      S = M.to;
    } else {
    ...
    m ? Zh(n, a, S, i + 1, r, m, o) : a < S && o.push(new qr(a, S, b)), a = S;
  }
    ...
    e: for (; ; ) if (f && S == s[f - 1].to) {
      ...
      if (m) m.push(M);
        ...
        let A = M.direction == Hs != !(b % 2);
        eu(n, A ? i + 1 : i, r, M.inner, M.from, M.to, o), a = M.from;
      }
      S = M.from;
    } else {
    ...
    m ? Zh(n, S, a, i + 1, r, m, o) : S < a && o.push(new qr(S, a, b)), a = S;
  }
}
function eu(n, e, t, i, r, s, o) {
  let l = e % 2 ? 2 : 1;
  Ix(n, r, s, i, l), Nx(n, r, s, i, l), Fx(r, s, i, l), Zh(n, r, s, e, t, i, o);
}
function Hx(n, e, t) {
  if (!n) return [new qr(0, 0, e == cd ? 1 : 0)];
  if (e == Hs && !t.length && !Bx.test(n)) return yy(n.length);
  if (t.length) for (; n.length > ft.length; ) ft[ft.length] = 256;
  let i = [], r = e == Hs ? 0 : 1;
  return eu(n, r, r, t, 0, n.length, i), i;
}
function yy(n) {
  return [new qr(0, n, 0)];
}
...
function Vx(n, e, t, i, r) {
  ...
  (h < a.from || h > a.to) && (h = f), vy = n.text.slice(Math.min(o, h), Math.max(o, h));
...
function Wx(n, e, t) {
  for (let i = e; i < t; i++) {
    let r = gy(n.charCodeAt(i));
    if (r == 1) return Hs;
    if (r == 2 || r == 4) return cd;
  }
  return Hs;
}
const by = be.define(), wy = be.define(), xy = be.define(), Sy = be.define(), tu = be.define(), ky = be.define(), Cy = be.define(), fd = be.define(), hd = be.define(), My = be.define({ combine: (n) => n.some((e) => e) }), Ay = be.define({ combine: (n) => n.some((e) => e) }), Ty = be.define();
class uo {
  ...
  map(e) {
    return e.empty ? this : new uo(this.range.map(e), this.y, this.x, this.yMargin, this.xMargin, this.isSnapshot);
  }
  clip(e) {
    return this.range.to <= e.doc.length ? this : new uo(j.cursor(e.doc.length), this.y, this.x, this.yMargin, this.xMargin, this.isSnapshot);
  }
}
const La = _e.define({ map: (n, e) => n.map(e) }), Ey = _e.define();
function Rn(n, e, t) {
  let i = n.facet(Sy);
...
class kt {
  constructor(e, t, i, r, s) {
    this.id = e, this.create = t, this.domEventHandlers = i, this.domEventObservers = r, this.baseExtensions = s(this), this.extension = this.baseExtensions.concat(ao.of({ plugin: this, arg: void 0 }));
  }
  of(e) {
    return this.baseExtensions.concat(ao.of({ plugin: this, arg: e }));
  }
  static define(e, t) {
    const { eventHandlers: i, eventObservers: r, provide: s, decorations: o } = t || {};
    return new kt($x++, e, i, r, (l) => {
      let a = [];
...
const Oy = be.define(), ud = be.define(), jl = be.define(), _y = be.define(), ia = be.define(), Ly = be.define();
function Yp(n, e) {
  let t = n.state.facet(Ly);
  ...
  return ze.spans(i, e.from, e.to, { point() {
    ...
    for (let m = l.length - 1; m >= 0; m--, a--) {
      ...
      if (b == null && (b = Wx(e.text, f, h)), a > 0 && p.length && (S = p[p.length - 1]).to == f && S.direction == b) S.to = h, p = S.inner;
      else {
...
class Jp extends lt {
  ...
  update(e) {
    ...
    let r = -1;
    this.view.inputState.composing >= 0 && !this.view.observer.editContext && (!((t = this.domChanged) === null || t === void 0) && t.newSel ? r = this.domChanged.newSel.head : !Yx(e.changes, this.hasComposition) && !e.selectionSet && (r = e.state.selection.main.head));
    let s = r > -1 ? Kx(this.view, e.changes, r) : null;
    ...
    let o = this.decorations, l = this.updateDeco(), a = Ux(o, l, e.changes);
  ...
  updateInner(e, t, i) {
    ...
    let s = [];
    if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length) for (let o of this.children) o instanceof kr && o.widget instanceof Qh && s.push(o.dom);
    r.updateGaps(s);
  }
  updateChildren(e, t, i) {
    ...
    for (let o = r.length - 1; ; o--) {
      ...
      ay(this, R, N, A, _, m, b, S, M);
    }
    i && this.fixCompositionDOM(i);
  }
  updateEditContextFormatting(e) {
    this.editContextFormatting = this.editContextFormatting.map(e.changes);
    for (let t of e.transactions) for (let i of t.effects) i.is(Ey) && (this.editContextFormatting = i.value);
  }
  compositionView(e) {
  ...
  updateSelection(e = false, t = false) {
    ...
    let i = this.view.root.activeElement, r = i == this.dom, s = !r && !(this.view.state.facet(wr) || this.dom.tabIndex > -1) && lc(this.dom, this.view.observer.selectionRange) && !(i && this.dom.contains(i));
    if (!(r || t || s)) return;
    ...
    if (ue.gecko && l.empty && !this.hasComposition && zx(a)) {
    ...
    (o || !h.focusNode || (!El(a.node, a.offset, h.anchorNode, h.anchorOffset) || !El(f.node, f.offset, h.focusNode, h.focusOffset)) && !this.suppressWidgetCursorChange(h, l)) && (this.view.observer.ignore(() => {
      ue.android && ue.chrome && this.dom.contains(h.focusNode) && Gx(h.focusNode, this.dom) && (this.dom.blur(), this.dom.focus({ preventScroll: true }));
      let p = zl(this.view.root);
      if (p) if (l.empty) {
        if (ue.gecko) {
          let m = jx(a.node, a.offset);
          if (m && m != 3) {
            let b = (m == 1 ? sy : oy)(a.node, a.offset);
  ...
  childCursor(e = this.length) {
    ...
    return t && (e -= this.children[--t].length), new ly(this.children, e, t);
  }
  computeBlockGapDeco() {
    ...
    for (let i = 0, r = 0; ; r++) {
      ...
      if (o > i) {
        ...
        e.push(ve.replace({ widget: new Qh(l), block: true, inclusive: true, isBlockGap: true }).range(i, o));
      }
      if (!s) break;
      i = s.to + 1;
    }
  ...
  updateDeco() {
    let e = 1, t = this.view.state.facet(jl).map((s) => (this.dynamicDecorationMap[e++] = typeof s == "function") ? s(this.view) : s), i = false, r = this.view.state.facet(_y).map((s, o) => {
  ...
  scrollIntoView(e) {
    ...
    for (let f of this.view.state.facet(Ty)) try {
    ...
    let s = dd(this.view), o = { left: i.left - s.left, top: i.top - s.top, right: i.right + s.right, bottom: i.bottom + s.bottom }, { offsetWidth: l, offsetHeight: a } = this.view.scrollDOM;
    Sx(this.view.scrollDOM, o, t.head < t.anchor ? -1 : 1, e.x, e.y, Math.max(Math.min(e.xMargin, l), -l), Math.max(Math.min(e.yMargin, a), -a), this.view.textDirection == gt.LTR);
  }
}
function zx(n) {
...
function Ry(n, e) {
  ...
  let i = sy(t.focusNode, t.focusOffset), r = oy(t.focusNode, t.focusOffset), s = i || r;
...
function Kx(n, e, t) {
  ...
  for (let p = r.parentNode; ; p = p.parentNode) {
    ...
    if (m instanceof Ar) h.push({ node: p, deco: m.mark });
      ...
      if (p != n.contentDOM) h.push({ node: p, deco: new ta({ inclusive: true, attributes: Lx(p), tagName: p.tagName.toLowerCase() }) });
      else return null;
    }
  }
}
...
function nu(n, e, t) {
  ...
  for (let S = n.firstChild; S; S = S.nextSibling) {
    ...
    for (let A = 0; A < M.length; A++) {
      let _ = M[A];
      r && zf(r, _) && (_ = Qp(Xp(_, r.bottom), r.top));
      let R = Qx(e, _), N = Xx(t, _);
      if (R == 0 && N == 0) return S.nodeType == 3 ? Zp(S, e, t) : nu(S, e, t);
      (!i || o > N || o == N && s > R) && (i = S, r = _, s = R, o = N, l = R ? e < _.left ? A > 0 : A < M.length - 1 : true), R == 0 ? t > _.bottom && (!h || h.bottom < _.bottom) ? (a = S, h = _) : t < _.top && (!p || p.top > _.top) && (f = S, p = _) : h && zf(h, _) ? h = Xp(h, _.bottom) : p && zf(p, _) && (p = Qp(p, _.top));
    }
  }
  if (h && h.bottom >= t ? (i = a, r = h) : p && p.top <= t && (i = f, r = p), !i) return { node: n, offset: 0 };
  let m = Math.max(r.left, Math.min(r.right, e));
  if (i.nodeType == 3) return Zp(i, m, t);
  if (l && i.contentEditable != "false") return nu(i, m, t);
...
function Py(n, e, t, i = -1) {
  ...
  p = l + m;
  let b = a.from;
  if (b < n.viewport.from) return n.viewport.from == 0 ? 0 : t ? null : eg(n, o, a, h, p);
  if (b > n.viewport.to) return n.viewport.to == n.state.doc.length ? n.state.doc.length : t ? null : eg(n, o, a, h, p);
  ...
  if (A && ((r = n.docView.nearest(A)) === null || r === void 0 ? void 0 : r.isEditable) != false) {
    ...
    _ && (!n.contentDOM.contains(_) || ue.safari && Zx(_, R, h) || ue.chrome && eS(_, R, h)) && (_ = void 0), _ && (R = Math.min(ur(_), R));
  }
  if (!_ || !n.docView.dom.contains(_)) {
    let B = Wt.find(n.docView, b);
    if (!B) return m > a.top + a.height / 2 ? a.to : a.from;
    ({ node: _, offset: R } = nu(B.dom, h, p));
  }
...
function eg(n, e, t, i, r) {
  ...
  return t.from + Wh(o, s, n.state.tabSize);
}
function By(n, e, t) {
  let i, r = n;
...
function tS(n, e, t, i) {
  let r = iu(n, e.head, e.assoc || -1), s = !i || r.type != Bn.Text || !(n.lineWrapping || r.widgetLineBreaks) ? null : n.coordsAtPos(e.assoc < 0 && e.head > r.from ? e.head - 1 : e.head);
  if (s) {
...
function iS(n, e, t, i) {
  ...
  for (let b = 0; ; b += 10) {
    let S = l + (m + b) * s, M = Py(n, { x: p, y: S }, false, s);
...
function Kf(n, e, t) {
  let i = _l(n.state.facet(ia).map((r) => r(n)), t.from, e.head > t.from ? -1 : 1);
...
class rS {
  ...
  readRange(e, t) {
    ...
    for (let r = e; ; ) {
      ...
      (l && a ? l.breakAfter : (l ? l.breakAfter : Mc(r)) || Mc(o) && (r.nodeName != "BR" || r.cmIgnore) && this.text.length > s) && !oS(o, t) && this.lineBreak(), r = o;
    }
  ...
  findPointInside(e, t) {
    for (let i of this.points) (e.nodeType == 3 ? i.node == e : e.contains(i.node)) && (i.pos = this.text.length + (sS(e, i.node, i.offset) ? t : 0));
  }
}
function sS(n, e, t) {
  for (; ; ) {
...
class lS {
  constructor(e, t, i, r) {
    ...
    if (e.state.readOnly && t > -1) this.newSel = null;
      ...
      let l = s || o ? [] : cS(e), a = new rS(l, e.state);
      a.readRange(this.bounds.startDOM, this.bounds.endDOM), this.text = a.text, this.newSel = fS(l, this.bounds.from);
    } else {
      let l = e.observer.selectionRange, a = s && s.node == l.focusNode && s.offset == l.focusOffset || !Gh(e.contentDOM, l.focusNode) ? e.state.selection.main.head : e.docView.posFromDOM(l.focusNode, l.focusOffset), f = o && o.node == l.anchorNode && o.offset == l.anchorOffset || !Gh(e.contentDOM, l.anchorNode) ? e.state.selection.main.anchor : e.docView.posFromDOM(l.anchorNode, l.anchorOffset), h = e.viewport;
...
function Ny(n, e) {
  ...
  if (e.bounds) {
    ...
    let h = Fy(n.state.doc.sliceString(o, l, ml), e.text, a - o, f);
 ...
 ` && n.lineWrapping && (i && (i = j.single(i.main.anchor - 1, i.main.head - 1)), t = { from: r.from, to: r.to, insert: Qe.of([" "]) }), t) return pd(n, t, i, s);
  if (i && !i.main.eq(r)) {
    let o = false, l = "select";
    return n.inputState.lastSelectionTime > Date.now() - 50 && (n.inputState.lastSelectionOrigin == "select" && (o = true), l = n.inputState.lastSelectionOrigin, l == "select.pointer" && (i = Iy(n.state.facet(ia).map((a) => a(n)), i))), n.dispatch({ selection: i, scrollIntoView: o, userEvent: l }), true;
  } else return false;
}
function pd(n, e, t, i = -1) {
  if (ue.ios && n.inputState.flushIOSKey(e)) return true;
  let r = n.state.selection.main;
  if (ue.android && (e.to == r.to && (e.from == r.from || e.from == r.from - 1 && n.state.sliceDoc(e.from, r.from) == " ") && e.insert.length == 1 && e.insert.lines == 2 && ho(n.contentDOM, "Enter", 13) || (e.from == r.from - 1 && e.to == r.to && e.insert.length == 0 || i == 8 && e.insert.length < e.to - e.from && e.to > r.head) && ho(n.contentDOM, "Backspace", 8) || e.from == r.from && e.to == r.to + 1 && e.insert.length == 0 && ho(n.contentDOM, "Delete", 46))) return true;
  let s = e.insert.toString();
  n.inputState.composing >= 0 && n.inputState.composing++;
  let o, l = () => o || (o = aS(n, e, t));
  return n.state.facet(ky).some((a) => a(n, e.from, e.to, s, l)) || n.dispatch(l()), true;
}
function aS(n, e, t) {
  let i, r = n.state, s = r.selection.main, o = -1;
  if (e.from == e.to && e.from < s.from || e.from > s.to) {
    let a = e.from < s.from ? -1 : 1, f = a < 0 ? s.from : s.to, h = _l(r.facet(ia).map((p) => p(n)), f, a);
    e.from == h && (o = h);
  }
  if (o > -1) i = { changes: e, selection: j.cursor(e.from + e.insert.length, -1) };
    ...
    if (r.selection.ranges.length > 1 && n.inputState.composing >= 0 && e.to <= s.to && e.to >= s.to - 10) {
      let h = n.state.sliceDoc(e.from, e.to), p, m = t && Ry(n, t.main.head);
      if (m) {
...
function cS(n) {
  ...
  return t && (e.push(new ng(t, i)), (r != t || s != i) && e.push(new ng(r, s))), e;
}
function fS(n, e) {
...
class hS {
  ...
  ensureHandlers(e) {
    let t = uS(e), i = this.handlers, r = this.view.contentDOM;
  ...
  keydown(e) {
    ...
    if (this.tabFocusMode > 0 && e.keyCode != 27 && Vy.indexOf(e.keyCode) < 0 && (this.tabFocusMode = -1), ue.android && ue.chrome && !e.synthetic && (e.keyCode == 13 || e.keyCode == 8)) return this.view.observer.delayAndroidKey(e.key, e.keyCode), true;
    let t;
    return ue.ios && !e.synthetic && !e.altKey && !e.metaKey && ((t = Hy.find((i) => i.keyCode == e.keyCode)) && !e.ctrlKey || dS.indexOf(e.key) > -1 && e.ctrlKey && !e.shiftKey) ? (this.pendingIOSKey = t || e, setTimeout(() => this.flushIOSKey(), 250), true) : (e.keyCode != 229 && this.view.observer.forceFlush(), false);
  }
  flushIOSKey(e) {
    let t = this.pendingIOSKey;
    return !t || t.key == "Enter" && e && e.from < e.to && /^\S+$/.test(e.insert.toString()) ? false : (this.pendingIOSKey = void 0, ho(this.view.contentDOM, t.key, t.keyCode, t instanceof KeyboardEvent ? t : void 0));
  }
...
function uS(n) {
  ...
  for (let i of n) {
    ...
    if (s) for (let l in s) {
      let a = s[l];
      a && t(l).handlers.push(ig(i.value, a));
    }
    if (o) for (let l in o) {
      let a = o[l];
      a && t(l).observers.push(ig(i.value, a));
    }
  }
...
const Hy = [{ key: "Backspace", keyCode: 8, inputType: "deleteContentBackward" }, { key: "Enter", keyCode: 13, inputType: "insertParagraph" }, { key: "Enter", keyCode: 13, inputType: "insertLineBreak" }, { key: "Delete", keyCode: 46, inputType: "deleteContentForward" }], dS = "dthko", Vy = [16, 17, 18, 20, 91, 92, 224, 225], Da = 6;
function Ra(n) {
...
class gS {
  constructor(e, t, i, r) {
    this.view = e, this.startEvent = t, this.style = i, this.mustSelect = r, this.scrollSpeed = { x: 0, y: 0 }, this.scrolling = -1, this.lastEvent = t, this.scrollParents = kx(e.contentDOM), this.atoms = e.state.facet(ia).map((o) => o(e));
    let s = e.contentDOM.ownerDocument;
    s.addEventListener("mousemove", this.move = this.move.bind(this)), s.addEventListener("mouseup", this.up = this.up.bind(this)), this.extend = t.shiftKey, this.multiple = e.state.facet($e.allowMultipleSelections) && mS(e, t), this.dragging = vS(e, t) && zy(t) == 1 ? null : false;
  }
  start(e) {
  ...
  move(e) {
    ...
    if (this.dragging || this.dragging == null && pS(this.startEvent, e) < 10) return;
    ...
    let a = dd(this.view);
    e.clientX - a.left <= r + Da ? t = -Ra(r - e.clientX) : e.clientX + a.right >= o - Da && (t = Ra(e.clientX - o)), e.clientY - a.top <= s + Da ? i = -Ra(s - e.clientY) : e.clientY + a.bottom >= l - Da && (i = Ra(e.clientY - l)), this.setScrollSpeed(t, i);
  }
  up(e) {
  ...
  select(e) {
    let { view: t } = this, i = Iy(this.atoms, this.style.get(e, this.extend, this.multiple));
...
const Bi = /* @__PURE__ */ Object.create(null), wi = /* @__PURE__ */ Object.create(null), Wy = ue.ie && ue.ie_version < 15 || ue.ios && ue.webkit_version < 604;
function wS(n) {
  let e = n.dom.parentNode;
  if (!e) return;
  let t = e.appendChild(document.createElement("textarea"));
  t.style.cssText = "position: fixed; left: -10000px; top: 10px", t.focus(), setTimeout(() => {
    n.focus(), t.remove(), $y(n, t.value);
  }, 50);
}
function nf(n, e, t) {
...
function $y(n, e) {
  ...
  if (ru != null && t.selection.ranges.every((a) => a.empty) && ru == s.toString()) {
    let a = -1;
    i = t.changeByRange((f) => {
...
Bi.mousedown = (n, e) => {
  ...
  let t = null;
  for (let i of n.state.facet(xy)) if (t = i(n, e), t) break;
  if (!t && e.button == 0 && (t = kS(n, e)), t) {
    let i = !n.hasFocus;
...
let sg = (n, e, t) => e >= t.top && e <= t.bottom && n >= t.left && n <= t.right;
function xS(n, e, t, i) {
  ...
  if (o && sg(t, i, o)) return -1;
  let l = r.coordsAt(s, 1);
  return l && sg(t, i, l) ? 1 : o && o.bottom >= i ? -1 : 1;
}
function og(n, e) {
  let t = n.posAtCoords({ x: e.clientX, y: e.clientY }, false);
  return { pos: t, bias: xS(n, t, e.clientX, e.clientY) };
}
const SS = ue.ie && ue.ie_version <= 11;
let lg = null, ag = 0, cg = 0;
function zy(n) {
  if (!SS) return n.detail;
  let e = lg, t = cg;
  return lg = n, cg = Date.now(), ag = !e || t > Date.now() - 400 && Math.abs(e.clientX - n.clientX) < 2 && Math.abs(e.clientY - n.clientY) < 2 ? (ag + 1) % 3 : 1;
}
function kS(n, e) {
  let t = og(n, e), i = zy(e), r = n.state.selection;
  return { update(s) {
    s.docChanged && (t.pos = s.changes.mapPos(t.pos), r = r.map(s.changes));
  }, get(s, o, l) {
    let a = og(n, s), f, h = rg(n, a.pos, a.bias, i);
    if (t.pos != a.pos && !o) {
      let p = rg(n, t.pos, t.bias, i), m = Math.min(p.from, h.from), b = Math.max(p.to, h.to);
      h = m < h.from ? j.range(m, b) : j.range(b, m);
    }
    return o ? r.replaceRange(r.main.extend(h.from, h.to)) : l && i == 1 && r.ranges.length > 1 && (f = CS(r, a.pos)) ? f : l ? r.addRange(h) : j.create([h]);
  } };
}
function CS(n, e) {
...
Bi.dragstart = (n, e) => {
  ...
  let { inputState: i } = n;
  return i.mouseSelection && (i.mouseSelection.dragging = true), i.draggedContent = t, e.dataTransfer && (e.dataTransfer.setData("Text", nf(n.state, hd, n.state.sliceDoc(t.from, t.to))), e.dataTransfer.effectAllowed = "copyMove"), false;
};
Bi.dragend = (n) => (n.inputState.draggedContent = null, false);
function fg(n, e, t, i) {
  if (t = nf(n.state, fd, t), !t) return;
  let r = n.posAtCoords({ x: e.clientX, y: e.clientY }, false), { draggedContent: s } = n.inputState, o = i && s && yS(n, e) ? { from: s.from, to: s.to } : null, l = { from: r, insert: t }, a = n.state.changes(o ? [o, l] : l);
...
Bi.drop = (n, e) => {
  ...
  if (t && t.length) {
    let i = Array(t.length), r = 0, s = () => {
      ++r == t.length && fg(n, e, i.filter((o) => o != null).join(n.state.lineBreak), false);
    };
    ...
    if (i) return fg(n, e, i, true), true;
  }
  return false;
};
Bi.paste = (n, e) => {
  ...
  return t ? ($y(n, t.getData("text/plain") || t.getData("text/uri-list")), true) : (wS(n), false);
};
function MS(n, e) {
...
function AS(n) {
  ...
  return { text: nf(n, hd, e.join(n.lineBreak)), ranges: t, linewise: i };
}
let ru = null;
Bi.copy = Bi.cut = (n, e) => {
  let { text: t, ranges: i, linewise: r } = AS(n.state);
  if (!t && !r) return false;
  ru = r ? t : null, e.type == "cut" && !n.state.readOnly && n.dispatch({ changes: i, scrollIntoView: true, userEvent: "delete.cut" });
  let s = Wy ? null : e.clipboardData;
  return s ? (s.clearData(), s.setData("text/plain", t), true) : (MS(n, t), false);
};
const Ky = Er.define();
function jy(n, e) {
  let t = [];
  for (let i of n.facet(Cy)) {
    let r = i(n, e);
    r && t.push(r);
  }
  return t.length ? n.update({ effects: t, annotations: Ky.of(true) }) : null;
}
function qy(n) {
  setTimeout(() => {
    let e = n.hasFocus;
...
Bi.beforeinput = (n, e) => {
  ...
  if (e.inputType == "insertReplacementText" && n.observer.editContext) {
    ...
    if (s && o.length) {
      ...
      return pd(n, { from: a, to: f, insert: n.state.toText(s) }, null), true;
    }
  }
  let r;
  if (ue.chrome && ue.android && (r = Hy.find((s) => s.inputType == e.inputType)) && (n.observer.delayAndroidKey(r.key, r.keyCode), r.key == "Backspace" || r.key == "Delete")) {
...
function TS(n) {
  hg.has(n) || (hg.add(n), n.addEventListener("copy", () => {
  }), n.addEventListener("cut", () => {
  }));
}
const ug = ["pre-wrap", "normal", "pre-line", "break-spaces"];
let xo = false;
function dg() {
  xo = false;
}
class ES {
  ...
  mustRefreshForWrapping(e) {
    return ug.indexOf(e) > -1 != this.lineWrapping;
  }
  ...
  refresh(e, t, i, r, s, o) {
    let l = ug.indexOf(e) > -1, a = Math.round(t) != Math.round(this.lineHeight) || this.lineWrapping != l;
...
class In {
  ...
  setHeight(e) {
    this.height != e && (Math.abs(this.height - e) > cc && (xo = true), this.height = e);
  }
  replace(e, t, i) {
    return In.of(i);
  }
  ...
  applyChanges(e, t, i, r) {
    ...
    for (let l = r.length - 1; l >= 0; l--) {
      ...
      h += m.from - a, a = m.from;
      let S = gd.build(i.setDoc(o), e, h, p);
      s = Ec(s, s.replace(a, f, S));
    }
  ...
  static of(e) {
    ...
    let o = 0;
    return e[t - 1] == null ? (o = 1, t--) : e[t] == null && (o = 1, i++), new _S(In.of(e.slice(0, t)), o, In.of(e.slice(i)));
  }
}
function Ec(n, e) {
  return n == e ? n : (n.constructor != e.constructor && (xo = true), e);
}
In.prototype.size = 1;
class Uy extends In {
  constructor(e, t, i) {
  ...
  updateHeight(e, t = 0, i = false, r) {
    ...
    if (r && r.from <= t + this.length && r.more) {
      ...
      for (r.from > t && o.push(new sn(r.from - t - 1).updateHeight(e, t)); l <= s && r.more; ) {
        ...
        a == -1 ? a = p : Math.abs(p - a) >= cc && (a = -2);
        let m = new ni(h, p);
        m.outdated = false, o.push(m), l += h + 1;
      }
      l <= s && o.push(null, new sn(s - l).updateHeight(e, l));
      let f = In.of(o);
      return (a < 0 || Math.abs(f.height - this.height) >= cc || Math.abs(a - this.heightMetrics(e, t).perLine) >= cc) && (xo = true), Ec(this, f);
...
class _S extends In {
  ...
  replace(e, t, i) {
    ...
    if (e > 0 && pg(s, o - 1), t < this.length) {
      let l = s.length;
      this.decomposeRight(t, s), pg(s, l);
    }
    return In.of(s);
  }
  decomposeLeft(e, t) {
  ...
  balanced(e, t) {
    return e.size > 2 * t.size || t.size > 2 * e.size ? In.of(this.break ? [e, null, t] : [e, t]) : (this.left = Ec(this.left, e), this.right = Ec(this.right, t), this.setHeight(e.height + t.height), this.outdated = e.outdated || t.outdated, this.size = e.size + t.size, this.length = e.length + this.break + t.length, this);
  }
  updateHeight(e, t = 0, i = false, r) {
...
class gd {
  ...
  point(e, t, i) {
    if (e < t || i.heightRelevant) {
      ...
      let o = t - e;
      i.block ? this.addBlock(new Uy(o, r, i)) : (o || s || r >= LS) && this.addLineDeco(r, s, o);
...
class RS {
  ...
  comparePoint(e, t, i, r) {
    (e < t || i && i.heightRelevant || r && r.heightRelevant) && ac(e, t, this.changes, 5);
  }
}
function PS(n, e) {
...
class jf {
  ...
  draw(e, t) {
    return ve.replace({ widget: new NS(this.displaySize * (t ? e.scaleY : e.scaleX), t) }).range(this.from, this.to);
  }
}
class NS extends Ni {
  constructor(e, t) {
...
class gg {
  constructor(e) {
    this.state = e, this.pixelViewport = { left: 0, right: window.innerWidth, top: 0, bottom: 0 }, this.inView = true, this.paddingTop = 0, this.paddingBottom = 0, this.contentDOMWidth = 0, this.contentDOMHeight = 0, this.editorHeight = 0, this.editorWidth = 0, this.scrollTop = 0, this.scrolledToBottom = false, this.scaleX = 1, this.scaleY = 1, this.scrollAnchorPos = 0, this.scrollAnchorHeight = -1, this.scaler = mg, this.scrollTarget = null, this.printing = false, this.mustMeasureContent = true, this.defaultTextDirection = gt.LTR, this.visibleRanges = [], this.mustEnforceCursorAssoc = false;
    let t = e.facet(ud).some((i) => typeof i != "function" && i.class == "cm-lineWrapping");
    this.heightOracle = new ES(t), this.stateDeco = e.facet(jl).filter((i) => typeof i != "function"), this.heightMap = In.empty().applyChanges(this.stateDeco, Qe.empty, this.heightOracle.setDoc(e.doc), [new vi(0, 0, 0, e.doc.length)]);
  ...
  updateScaler() {
    let e = this.scaler;
    return this.scaler = this.heightMap.height <= 7e6 ? mg : new md(this.heightOracle, this.heightMap, this.viewports), e.eq(this.scaler) ? 0 : 2;
  }
  updateViewportLines() {
  ...
  update(e, t = null) {
    ...
    let r = e.changedRanges, s = vi.extendWithRanges(r, DS(i, this.stateDeco, e ? e.changes : Ut.empty(this.state.doc.length))), o = this.heightMap.height, l = this.scrolledToBottom ? null : this.scrollAnchorAt(this.scrollTop);
    dg(), this.heightMap = this.heightMap.applyChanges(this.stateDeco, e.startState.doc, this.heightOracle.setDoc(this.state.doc), s), (this.heightMap.height != o || xo) && (e.flags |= 2), l ? (this.scrollAnchorPos = e.changes.mapPos(l.from, -1), this.scrollAnchorHeight = l.top) : (this.scrollAnchorPos = -1, this.scrollAnchorHeight = o);
  ...
  measure(e) {
    ...
    this.scrollTop != b && (this.scrollAnchorHeight = -1, this.scrollTop = b), this.scrolledToBottom = ry(e.scrollDOM);
    let S = (this.printing ? IS : PS)(t, this.paddingTop), M = S.top - this.pixelViewport.top, A = S.bottom - this.pixelViewport.bottom;
    ...
    if (_ != this.inView && (this.inView = _, _ && (a = true)), !this.inView && !this.scrollTarget && !BS(e.dom)) return 0;
    let R = l.width;
    if ((this.contentDOMWidth != R || this.editorHeight != e.scrollDOM.clientHeight) && (this.contentDOMWidth = l.width, this.editorHeight = e.scrollDOM.clientHeight, f |= 16), a) {
      ...
      M > 0 && A > 0 ? h = Math.max(M, A) : M < 0 && A < 0 && (h = Math.min(M, A)), dg();
      for (let W of this.viewports) {
        let H = W.from == this.viewport.from ? B : e.docView.measureVisibleLineHeights(W);
        this.heightMap = (o ? In.empty().applyChanges(this.stateDeco, Qe.empty, this.heightOracle, [new vi(0, 0, 0, e.state.doc.length)]) : this.heightMap).updateHeight(r, 0, o, new OS(W.from, H));
      }
      xo && (f |= 2);
    }
  ...
  getViewport(e, t) {
    let i = 0.5 - Math.max(-0.5, Math.min(0.5, e / 1e3 / 2)), r = this.heightMap, s = this.heightOracle, { visibleTop: o, visibleBottom: l } = this, a = new Pa(r.lineAt(o - i * 1e3, wt.ByHeight, s, 0, 0).from, r.lineAt(l + (1 - i) * 1e3, wt.ByHeight, s, 0, 0).to);
    if (t) {
      let { head: f } = t.range;
      if (f < a.from || f > a.to) {
        let h = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top), p = r.lineAt(f, wt.ByPos, s, 0, 0), m;
        t.y == "center" ? m = (p.top + p.bottom) / 2 - h / 2 : t.y == "start" || t.y == "nearest" && f < a.from ? m = p.top : m = p.bottom - h, a = new Pa(r.lineAt(m - 1e3 / 2, wt.ByHeight, s, 0, 0).from, r.lineAt(m + h + 1e3 / 2, wt.ByHeight, s, 0, 0).to);
      }
    }
    return a;
  }
  mapViewport(e, t) {
    ...
    return new Pa(this.heightMap.lineAt(i, wt.ByPos, this.heightOracle, 0, 0).from, this.heightMap.lineAt(r, wt.ByPos, this.heightOracle, 0, 0).to);
  }
  ...
  ensureLineGaps(e, t) {
    ...
    let l = [], a = (h, p, m, b) => {
      ...
      let A = HS(e, (_) => _.from >= m.from && _.to <= m.to && Math.abs(_.from - h) < s && Math.abs(_.to - p) < s && !M.some((R) => _.from < R && _.to > R));
      if (!A) {
      ...
      let p = FS(h.from, h.to, this.stateDeco);
      if (p.total < o) return;
      ...
      if (i) {
        ...
        if (m != null) {
          let R = Ia(p, m), N = ((this.visibleBottom - this.visibleTop) / 2 + M) / h.height;
          A = R - N, _ = R + N;
...
class md {
  ...
  eq(e) {
    return e instanceof md ? this.scale == e.scale && this.viewports.length == e.viewports.length && this.viewports.every((t, i) => t.from == e.viewports[i].from && t.to == e.viewports[i].to) : false;
  }
}
function yl(n, e) {
...
const Na = be.define({ combine: (n) => n.join(" ") }), su = be.define({ combine: (n) => n.indexOf(true) > -1 }), ou = Yr.newName(), Gy = Yr.newName(), Yy = Yr.newName(), Jy = { "&light": "." + Gy, "&dark": "." + Yy };
function lu(n, e, t) {
...
const VS = lu("." + ou, { "&": { position: "relative !important", boxSizing: "border-box", "&.cm-focused": { outline: "1px dotted #212121" }, display: "flex !important", flexDirection: "column" }, ".cm-scroller": { display: "flex !important", alignItems: "flex-start !important", fontFamily: "monospace", lineHeight: 1.4, height: "100%", overflowX: "auto", position: "relative", zIndex: 0, overflowAnchor: "none" }, ".cm-content": { margin: 0, flexGrow: 2, flexShrink: 0, display: "block", whiteSpace: "pre", wordWrap: "normal", boxSizing: "border-box", minHeight: "100%", padding: "4px 0", outline: "none", "&[contenteditable=true]": { WebkitUserModify: "read-write-plaintext-only" } }, ".cm-lineWrapping": { whiteSpace_fallback: "pre-wrap", whiteSpace: "break-spaces", wordBreak: "break-word", overflowWrap: "anywhere", flexShrink: 1 }, "&light .cm-content": { caretColor: "black" }, "&dark .cm-content": { caretColor: "white" }, ".cm-line": { display: "block", padding: "0 2px 0 6px" }, ".cm-layer": { position: "absolute", left: 0, top: 0, contain: "size style", "& > *": { position: "absolute" } }, "&light .cm-selectionBackground": { background: "#d9d9d9" }, "&dark .cm-selectionBackground": { background: "#222" }, "&light.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground": { background: "#d7d4f0" }, "&dark.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground": { background: "#233" }, ".cm-cursorLayer": { pointerEvents: "none" }, "&.cm-focused > .cm-scroller > .cm-cursorLayer": { animation: "steps(1) cm-blink 1.2s infinite" }, "@keyframes cm-blink": { "0%": {}, "50%": { opacity: 0 }, "100%": {} }, "@keyframes cm-blink2": { "0%": {}, "50%": { opacity: 0 }, "100%": {} }, ".cm-cursor, .cm-dropCursor": { borderLeft: "1.2px solid black", marginLeft: "-0.6px", pointerEvents: "none" }, ".cm-cursor": { display: "none" }, "&dark .cm-cursor": { borderLeftColor: "#ddd" }, ".cm-dropCursor": { position: "absolute" }, "&.cm-focused > .cm-scroller > .cm-cursorLayer .cm-cursor": { display: "block" }, ".cm-iso": { unicodeBidi: "isolate" }, ".cm-announced": { position: "fixed", top: "-10000px" }, "@media print": { ".cm-announced": { display: "none" } }, "&light .cm-activeLine": { backgroundColor: "#cceeff44" }, "&dark .cm-activeLine": { backgroundColor: "#99eeff33" }, "&light .cm-specialChar": { color: "red" }, "&dark .cm-specialChar": { color: "#f78" }, ".cm-gutters": { flexShrink: 0, display: "flex", height: "100%", boxSizing: "border-box", zIndex: 200 }, ".cm-gutters-before": { insetInlineStart: 0 }, ".cm-gutters-after": { insetInlineEnd: 0 }, "&light .cm-gutters": { backgroundColor: "#f5f5f5", color: "#6c6c6c", border: "0px solid #ddd", "&.cm-gutters-before": { borderRightWidth: "1px" }, "&.cm-gutters-after": { borderLeftWidth: "1px" } }, "&dark .cm-gutters": { backgroundColor: "#333338", color: "#ccc" }, ".cm-gutter": { display: "flex !important", flexDirection: "column", flexShrink: 0, boxSizing: "border-box", minHeight: "100%", overflow: "hidden" }, ".cm-gutterElement": { boxSizing: "border-box" }, ".cm-lineNumbers .cm-gutterElement": { padding: "0 3px 0 5px", minWidth: "20px", textAlign: "right", whiteSpace: "nowrap" }, "&light .cm-activeLineGutter": { backgroundColor: "#e2f2ff" }, "&dark .cm-activeLineGutter": { backgroundColor: "#222227" }, ".cm-panels": { boxSizing: "border-box", position: "sticky", left: 0, right: 0, zIndex: 300 }, "&light .cm-panels": { backgroundColor: "#f5f5f5", color: "black" }, "&light .cm-panels-top": { borderBottom: "1px solid #ddd" }, "&light .cm-panels-bottom": { borderTop: "1px solid #ddd" }, "&dark .cm-panels": { backgroundColor: "#333338", color: "white" }, ".cm-dialog": { padding: "2px 19px 4px 6px", position: "relative", "& label": { fontSize: "80%" } }, ".cm-dialog-close": { position: "absolute", top: "3px", right: "4px", backgroundColor: "inherit", border: "none", font: "inherit", fontSize: "14px", padding: "0" }, ".cm-tab": { display: "inline-block", overflow: "hidden", verticalAlign: "bottom" }, ".cm-widgetBuffer": { verticalAlign: "text-top", height: "1em", width: 0, display: "inline" }, ".cm-placeholder": { color: "#888", display: "inline-block", verticalAlign: "top", userSelect: "none" }, ".cm-highlightSpace": { backgroundImage: "radial-gradient(circle at 50% 55%, #aaa 20%, transparent 5%)", backgroundPosition: "center" }, ".cm-highlightTab": { backgroundImage: `url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="20"><path stroke="%23888" stroke-width="1" fill="none" d="M1 10H196L190 5M190 15L196 10M197 4L197 16"/></svg>')`, backgroundSize: "auto 100%", backgroundPosition: "right 90%", backgroundRepeat: "no-repeat" }, ".cm-trailingSpace": { backgroundColor: "#ff332255" }, ".cm-button": { verticalAlign: "middle", color: "inherit", fontSize: "70%", padding: ".2em 1em", borderRadius: "1px" }, "&light .cm-button": { backgroundImage: "linear-gradient(#eff1f5, #d9d9df)", border: "1px solid #888", "&:active": { backgroundImage: "linear-gradient(#b4b4b4, #d0d3d6)" } }, "&dark .cm-button": { backgroundImage: "linear-gradient(#393939, #111)", border: "1px solid #888", "&:active": { backgroundImage: "linear-gradient(#111, #333)" } }, ".cm-textfield": { verticalAlign: "middle", color: "inherit", fontSize: "70%", border: "1px solid silver", padding: ".2em .5em" }, "&light .cm-textfield": { backgroundColor: "white" }, "&dark .cm-textfield": { border: "1px solid #555", backgroundColor: "inherit" } }, Jy), WS = { childList: true, characterData: true, subtree: true, attributes: true, characterDataOldValue: true }, qf = ue.ie && ue.ie_version <= 11;
class $S {
  constructor(e) {
    this.view = e, this.active = false, this.editContext = null, this.selectionRange = new Cx(), this.selectionChanged = false, this.delayedFlush = -1, this.resizeTimeout = -1, this.queue = [], this.delayedAndroidKey = null, this.flushingAndroidKey = -1, this.lastChange = 0, this.scrollTargets = [], this.intersection = null, this.resizeScroll = null, this.intersecting = false, this.gapIntersection = null, this.gaps = [], this.printQuery = null, this.parentCheck = -1, this.dom = e.contentDOM, this.observer = new MutationObserver((t) => {
    ...
    }), window.EditContext && ue.android && e.constructor.EDIT_CONTEXT !== false && !(ue.chrome && ue.chrome_version < 126) && (this.editContext = new KS(e), e.state.facet(wr) && (e.contentDOM.editContext = this.editContext.editContext)), qf && (this.onCharData = (t) => {
  ...
  onSelectionChange(e) {
    ...
    if (i.state.facet(wr) ? i.root.activeElement != this.dom : !lc(this.dom, r)) return;
  ...
  readSelectionRange() {
    ...
    if (!t) return false;
    let i = ue.safari && e.root.nodeType == 11 && e.root.activeElement == this.dom && zS(this.view, t) || t;
    if (!i || this.selectionRange.eq(i)) return false;
    let r = lc(this.dom, i);
    return r && !this.selectionChanged && e.inputState.lastFocusTime > Date.now() - 200 && e.inputState.lastTouchTime < Date.now() - 300 && Ax(this.dom, i) ? (this.view.inputState.lastFocusTime = 0, e.docView.updateSelection(), false) : (this.selectionRange.setRange(i), r && (this.selectionChanged = true), true);
  }
  ...
  start() {
    this.active || (this.observer.observe(this.dom, WS), qf && this.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.active = true);
  }
  stop() {
  ...
  delayAndroidKey(e, t) {
    ...
    if (!this.delayedAndroidKey) {
      let r = () => {
        ...
        s && (this.clearDelayedAndroidKey(), this.view.inputState.lastKeyCode = s.keyCode, this.view.inputState.lastKeyTime = Date.now(), !this.flush() && s.force && ho(this.dom, s.key, s.keyCode));
      };
  ...
  readChange() {
    let { from: e, to: t, typeOver: i } = this.processRecords(), r = this.selectionChanged && lc(this.dom, this.selectionRange);
    if (e < 0 && !r) return null;
    e > -1 && (this.lastChange = Date.now()), this.view.inputState.lastFocusTime = 0, this.selectionChanged = false;
    let s = new lS(this.view, e, t, i);
  ...
  flush(e = true) {
    ...
    let i = this.view.state, r = Ny(this.view, t);
  ...
  readMutation(e) {
    ...
    if (t.markDirty(e.type == "attributes"), e.type == "attributes" && (t.flags |= 4), e.type == "childList") {
      let i = yg(t, e.previousSibling || e.target.previousSibling, -1), r = yg(t, e.nextSibling || e.target.nextSibling, 1);
...
function zS(n, e) {
  ...
  return n.contentDOM.addEventListener("beforeinput", i, true), n.dom.ownerDocument.execCommand("indent"), n.contentDOM.removeEventListener("beforeinput", i, true), t ? vg(n, t) : null;
}
class KS {
  constructor(e) {
    ...
    this.handlers.textupdate = (i) => {
      ...
      let h = Fy(e.state.sliceDoc(l, a), i.text, (f ? r.from : r.to) - l, f ? "end" : null);
      if (!h) {
...
`)) };
      if ((ue.mac || ue.android) && p.from == o - 1 && /^\. ?$/.test(i.text) && e.contentDOM.getAttribute("autocorrect") == "off" && (p = { from: l, to: a, insert: Qe.of([i.text.replace(".", " ")]) }), this.pendingContextChange = p, !e.state.readOnly) {
        ...
        pd(e, p, j.single(this.toEditorPos(i.selectionStart, m), this.toEditorPos(i.selectionEnd, m)));
      }
      ...
      e.dispatch({ effects: Ey.of(ve.set(r)) });
...
class he {
  ...
  constructor(e = {}) {
    ...
    let { dispatch: i } = e;
    this.dispatchTransactions = e.dispatchTransactions || i && ((r) => r.forEach((s) => i(s, this))) || ((r) => this.update(r)), this.dispatch = this.dispatch.bind(this), this._root = e.root || Mx(e.parent) || document, this.viewState = new gg(e.state || $e.create(e)), e.scrollTo && e.scrollTo.is(La) && (this.viewState.scrollTarget = e.scrollTo.value.clip(this.viewState.state)), this.plugins = this.state.facet(ao).map((r) => new $f(r));
    for (let r of this.plugins) r.update(this);
    this.observer = new $S(this), this.inputState = new hS(this), this.inputState.ensureHandlers(this.plugins), this.docView = new Jp(this), this.mountStyles(), this.updateAttrs(), this.updateState = 0, this.requestMeasure(), !((t = document.fonts) === null || t === void 0) && t.ready && document.fonts.ready.then(() => this.requestMeasure());
  }
  dispatch(...e) {
  ...
  update(e) {
    ...
    e.some((m) => m.annotation(Ky)) ? (this.inputState.notifiedFocused = o, l = 1) : o != this.inputState.notifiedFocused && (this.inputState.notifiedFocused = o, a = jy(s, o), a || (l = 1));
    ...
    try {
      ...
      for (let m of e) {
        if (p && (p = p.map(m.changes)), m.scrollIntoView) {
          ...
          p = new uo(b.empty ? b : j.cursor(b.head, b.head > b.anchor ? -1 : 1));
        }
        for (let b of m.effects) b.is(La) && (p = b.value.clip(this.state));
      }
      this.viewState.update(r, p), this.bidiCache = Oc.update(this.bidiCache, r.changes), r.empty || (this.updatePlugins(r), this.inputState.update(r)), t = this.docView.update(r), this.state.facet(gl) != this.styleModules && this.mountStyles(), i = this.updateAttrs(), this.showAnnouncements(e), this.docView.updateSelection(t, e.some((m) => m.isUserEvent("select.pointer")));
    } finally {
      this.updateState = 0;
    }
    if (r.startState.facet(Na) != r.state.facet(Na) && (this.viewState.mustMeasureContent = true), (t || i || p || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) && this.requestMeasure(), t && this.docViewUpdate(), !r.empty) for (let m of this.state.facet(tu)) try {
      m(r);
    } catch (b) {
      Rn(this.state, b, "update listener");
    }
    (a || h) && Promise.resolve().then(() => {
      a && this.state == a.startState && this.dispatch(a), h && !Ny(this, h) && f.force && ho(this.contentDOM, f.key, f.keyCode);
    });
  }
  setState(e) {
    ...
    try {
      ...
      this.viewState = new gg(e), this.plugins = e.facet(ao).map((i) => new $f(i)), this.pluginMap.clear();
      for (let i of this.plugins) i.update(this);
      this.docView.destroy(), this.docView = new Jp(this), this.inputState.ensureHandlers(this.plugins), this.mountStyles(), this.updateAttrs(), this.bidiCache = [];
    } finally {
      this.updateState = 0;
    }
  ...
  updatePlugins(e) {
    let t = e.startState.facet(ao), i = e.state.facet(ao);
    if (t != i) {
      let r = [];
      for (let s of i) {
        let o = t.indexOf(s);
        if (o < 0) r.push(new $f(s));
        else {
  ...
  measure(e = true) {
    ...
    try {
      for (let l = 0; ; l++) {
        if (o < 0) if (ry(i)) s = -1, o = this.viewState.heightMap.height;
        else {
        ...
        for (let b = 0; b < f.length; b++) if (h[b] != bg) try {
          let S = f[b];
    ...
    if (t && !t.empty) for (let l of this.state.facet(tu)) l(t);
  }
  get themeClasses() {
    return ou + " " + (this.state.facet(su) ? Yy : Gy) + " " + this.state.facet(Na);
  }
  updateAttrs() {
    let e = wg(this, Oy, { class: "cm-editor" + (this.hasFocus ? " cm-focused " : " ") + this.themeClasses }), t = { spellcheck: "false", autocorrect: "off", autocapitalize: "off", writingsuggestions: "false", translate: "no", contenteditable: this.state.facet(wr) ? "true" : "false", class: "cm-content", style: `${ue.tabSize}: ${this.state.tabSize}`, role: "textbox", "aria-multiline": "true" };
    this.state.readOnly && (t["aria-readonly"] = "true"), wg(this, ud, t);
    let i = this.observer.ignore(() => {
      let r = Jh(this.contentDOM, this.contentAttrs, t), s = Jh(this.dom, this.editorAttrs, e);
      return r || s;
    });
  ...
  mountStyles() {
    ...
    Yr.mount(this.root, this.styleModules.concat(VS).reverse(), e ? { nonce: e } : void 0);
  }
  readMeasured() {
  ...
  moveByChar(e, t, i) {
    return Kf(this, e, tg(this, e, t, i));
  }
  moveByGroup(e, t) {
    return Kf(this, e, tg(this, e, t, (i) => nS(this, e.head, i)));
  }
  visualLineSide(e, t) {
  ...
  moveToLineBoundary(e, t, i = true) {
    return tS(this, e, t, i);
  }
  moveVertically(e, t, i) {
    return Kf(this, e, iS(this, e, t, i));
  }
  domAtPos(e) {
  ...
  posAtCoords(e, t = true) {
    return this.readMeasured(), Py(this, e, t);
  }
  coordsAtPos(e, t = 1) {
    this.readMeasured();
  ...
  textDirectionAt(e) {
    return !this.state.facet(My) || e < this.viewport.from || e > this.viewport.to ? this.textDirection : (this.readMeasured(), this.docView.textDirectionAt(e));
  }
  get lineWrapping() {
    return this.viewState.heightOracle.lineWrapping;
  }
  bidiSpans(e) {
    if (e.length > jS) return yy(e.length);
    let t = this.textDirectionAt(e.from), i;
    for (let s of this.bidiCache) if (s.from == e.from && s.dir == t && (s.fresh || my(s.isolates, i = Yp(this, e)))) return s.order;
    i || (i = Yp(this, e));
    let r = Hx(e.text, t, i);
    return this.bidiCache.push(new Oc(e.from, e.to, t, i, true, r)), r;
  }
  get hasFocus() {
    var e;
  ...
  focus() {
    this.observer.ignore(() => {
      ny(this.contentDOM), this.docView.updateSelection();
    });
  }
  setRoot(e) {
  ...
  static scrollIntoView(e, t = {}) {
    return La.of(new uo(typeof e == "number" ? j.cursor(e) : e, t.y, t.x, t.yMargin, t.xMargin));
  }
  scrollSnapshot() {
    let { scrollTop: e, scrollLeft: t } = this.scrollDOM, i = this.viewState.scrollAnchorAt(e);
    return La.of(new uo(j.cursor(i.from), "start", "start", i.top - e, t, true));
  }
  setTabFocusMode(e) {
  ...
  static theme(e, t) {
    let i = Yr.newName(), r = [Na.of(i), gl.of(lu(`.${i}`, e))];
    return t && t.dark && r.push(su.of(true)), r;
  }
  static baseTheme(e) {
    return os.lowest(gl.of(lu("." + ou, e, Jy)));
  }
...
he.styleModule = gl;
he.inputHandler = ky;
he.clipboardInputFilter = fd;
he.clipboardOutputFilter = hd;
he.scrollHandler = Ty;
he.focusChangeEffect = Cy;
he.perLineTextDirection = My;
he.exceptionSink = Sy;
he.updateListener = tu;
he.editable = wr;
he.mouseSelectionStyle = xy;
he.dragMovesSelection = wy;
he.clickAddsSelectionRange = by;
he.decorations = jl;
he.outerDecorations = _y;
he.atomicRanges = ia;
he.bidiIsolatedRanges = Ly;
he.scrollMargins = Dy;
he.darkTheme = su;
he.cspNonce = be.define({ combine: (n) => n.length ? n[0] : "" });
he.contentAttributes = ud;
he.editorAttributes = Oy;
he.lineWrapping = he.contentAttributes.of({ class: "cm-lineWrapping" });
he.announce = _e.define();
const jS = 4096, bg = {};
class Oc {
  constructor(e, t, i, r, s, o) {
  ...
  static update(e, t) {
    ...
    for (let s = Math.max(0, e.length - 10); s < e.length; s++) {
      let o = e[s];
      o.dir == r && !t.touchesRange(o.from, o.to) && i.push(new Oc(t.mapPos(o.from, 1), t.mapPos(o.to, -1), o.dir, o.isolates, false, o.order));
    }
    return i;
  }
}
...
const qS = ue.mac ? "mac" : ue.windows ? "win" : ue.linux ? "linux" : "key";
function US(n, e) {
  const t = n.split(/-(?!$)/);
  let i = t[t.length - 1];
  i == "Space" && (i = " ");
...
const GS = os.default(he.domEventHandlers({ keydown(n, e) {
  return Xy(Qy(e.state), n, e, "editor");
} })), yd = be.define({ enables: GS }), xg = /* @__PURE__ */ new WeakMap();
function Qy(n) {
  let e = n.facet(yd), t = xg.get(e);
  return t || xg.set(e, t = JS(e.reduce((i, r) => i.concat(r), []))), t;
}
function vs(n, e, t) {
  return Xy(Qy(n.state), e, n, t);
}
let zr = null;
const YS = 4e3;
function JS(n, e = qS) {
  let t = /* @__PURE__ */ Object.create(null), i = /* @__PURE__ */ Object.create(null), r = (o, l) => {
    ...
    var p, m;
    let b = t[o] || (t[o] = /* @__PURE__ */ Object.create(null)), S = l.split(/ (?!$)/).map((_) => US(_, e));
  ...
  for (let o of n) {
    ...
    if (o.any) for (let f of l) {
      ...
      let { any: p } = o;
      for (let m in h) h[m].run.push((b) => p(b, au));
    }
    let a = o[e] || o.key;
...
function Xy(n, e, t, i) {
  au = e;
  let r = bx(e), s = $n(r, 0), o = sr(s) == r.length && r != " ", l = "", a = false, f = false, h = false;
  zr && zr.view == t && zr.scope == i && (l = zr.prefix + " ", Vy.indexOf(e.keyCode) < 0 && (f = true, zr = null));
  ...
  return b && (m(b[l + Fa(r, e, !o)]) ? a = true : o && (e.altKey || e.metaKey || e.ctrlKey) && !(ue.windows && e.ctrlKey && e.altKey) && !(ue.mac && e.altKey && !(e.ctrlKey || e.metaKey)) && (S = Jr[e.keyCode]) && S != r ? (m(b[l + Fa(S, e, true)]) || e.shiftKey && (M = $l[e.keyCode]) != r && M != S && m(b[l + Fa(M, e, false)])) && (a = true) : o && e.shiftKey && m(b[l + Fa(r, e, true)]) && (a = true), !a && m(b._any) && (a = true)), f && (a = true), a && h && e.stopPropagation(), au = null, a;
}
class ra {
  constructor(e, t, i, r, s) {
...
function QS(n, e, t) {
  ...
  let i = Math.max(t.from, n.viewport.from), r = Math.min(t.to, n.viewport.to), s = n.textDirection == gt.LTR, o = n.contentDOM, l = o.getBoundingClientRect(), a = Zy(n), f = o.querySelector(".cm-line"), h = f && window.getComputedStyle(f), p = l.left + (h ? parseInt(h.paddingLeft) + Math.min(0, parseInt(h.textIndent)) : 0), m = l.right - (h ? parseInt(h.paddingRight) : 0), b = iu(n, i, 1), S = iu(n, r, -1), M = b.type == Bn.Text ? b : null, A = S.type == Bn.Text ? S : null;
  if (M && (n.lineWrapping || b.widgetLineBreaks) && (M = Sg(n, i, 1, M)), A && (n.lineWrapping || S.widgetLineBreaks) && (A = Sg(n, r, -1, A)), M && A && M.from == A.from && M.to == A.to) return R(N(t.from, t.to, M));
  {
  ...
  function _(W, H, K, ee) {
    return new ra(e, W - a.left, H - a.top, K - W, ee - H);
  }
...
class ZS {
  ...
  update(e) {
    e.startState.facet(fc) != e.state.facet(fc) && this.setOrder(e.state), (this.layer.update(e, this.dom) || e.geometryChanged) && (this.scale(), e.view.requestMeasure(this.measureReq));
  }
  docViewUpdate(e) {
    this.layer.updateOnDocViewUpdate !== false && e.requestMeasure(this.measureReq);
  }
  setOrder(e) {
    let t = 0, i = e.facet(fc);
  ...
  draw(e) {
    if (e.length != this.drawn.length || e.some((t, i) => !XS(t, this.drawn[i]))) {
...
const fc = be.define();
function ev(n) {
  return [kt.define((e) => new ZS(e, n)), fc.of(n)];
}
...
function ek(n = {}) {
  return [So.of(n), nk, ik, rk, Ay.of(true)];
}
function tk(n) {
  return n.facet(So);
}
function tv(n) {
  return n.startState.facet(So) != n.state.facet(So);
}
const nk = ev({ above: true, markers(n) {
  let { state: e } = n, t = e.facet(So), i = [];
  ...
  let t = tv(n);
  return t && kg(n.state, e), n.docChanged || n.selectionSet || t;
}, mount(n, e) {
  kg(e.state, n);
}, class: "cm-cursorLayer" });
function kg(n, e) {
  e.style.animationDuration = n.facet(So).cursorBlinkRate + "ms";
}
const ik = ev({ above: false, markers(n) {
  return n.state.selection.ranges.map((e) => e.empty ? [] : ra.forRange(n, "cm-selectionBackground", e)).reduce((e, t) => e.concat(t));
}, update(n, e) {
  return n.docChanged || n.selectionSet || n.viewportChanged || tv(n);
}, class: "cm-selectionLayer" }), rk = os.highest(he.theme({ ".cm-line": { "& ::selection, &::selection": { backgroundColor: "transparent !important" }, caretColor: "transparent !important" }, ".cm-content": { caretColor: "transparent !important", "& :focus": { caretColor: "initial !important", "&::selection, & ::selection": { backgroundColor: "Highlight !important" } } } })), nv = _e.define({ map(n, e) {
  return n == null ? null : e.mapPos(n);
} }), vl = Yt.define({ create() {
  return null;
}, update(n, e) {
  return n != null && (n = e.changes.mapPos(n)), e.effects.reduce((t, i) => i.is(nv) ? i.value : t, n);
} }), sk = kt.fromClass(class {
  constructor(n) {
  ...
  setDropPos(n) {
    this.view.state.field(vl) != n && this.view.dispatch({ effects: nv.of(n) });
  }
...
class ak {
  ...
  createDeco(e) {
    ...
    for (let { from: r, to: s } of lk(e, this.maxLength)) Cg(e.state.doc, this.regexp, r, s, (o, l) => this.addMatch(l, e, o, i));
    return t.finish();
  }
  updateDeco(e, t) {
    let i = 1e9, r = -1;
  ...
  updateRange(e, t, i, r) {
    for (let s of e.visibleRanges) {
      ...
      if (l >= o) {
        ...
        else Cg(e.state.doc, this.regexp, h, p, (M, A) => this.addMatch(A, e, M, S));
...
const cu = /x/.unicode != null ? "gu" : "g", ck = new RegExp(`[\0-\b
-\x7F-\x9F\xAD\u061C\u200B\u200E\u200F\u2028\u2029\u202D\u202E\u2066\u2067\u2069\uFEFF\uFFF9-\uFFFC]`, cu), fk = { 0: "null", 7: "bell", 8: "backspace", 10: "newline", 11: "vertical tab", 13: "carriage return", 27: "escape", 8203: "zero width space", 8204: "zero width non-joiner", 8205: "zero width joiner", 8206: "left-to-right mark", 8207: "right-to-left mark", 8232: "line separator", 8237: "left-to-right override", 8238: "right-to-left override", 8294: "left-to-right isolate", 8295: "right-to-left isolate", 8297: "pop directional isolate", 8233: "paragraph separator", 65279: "zero width no-break space", 65532: "object replacement" };
let Uf = null;
function hk() {
  var n;
  if (Uf == null && typeof document < "u" && document.body) {
    let e = document.body.style;
    Uf = ((n = e.tabSize) !== null && n !== void 0 ? n : e.MozTabSize) != null;
  }
  return Uf || false;
}
const hc = be.define({ combine(n) {
  let e = Or(n, { render: null, specialChars: ck, addSpecialChars: null });
  return (e.replaceTabs = !hk()) && (e.specialChars = new RegExp("	|" + e.specialChars.source, cu)), e.addSpecialChars && (e.specialChars = new RegExp(e.specialChars.source + "|" + e.addSpecialChars.source, cu)), e;
} });
function uk(n = {}) {
  return [hc.of(n), dk()];
}
let Mg = null;
function dk() {
  return Mg || (Mg = kt.fromClass(class {
    constructor(n) {
      this.view = n, this.decorations = ve.none, this.decorationCache = /* @__PURE__ */ Object.create(null), this.decorator = this.makeDecorator(n.state.facet(hc)), this.decorations = this.decorator.createDeco(n);
    }
    makeDecorator(n) {
      return new ak({ regexp: n.specialChars, decoration: (e, t, i) => {
        let { doc: r } = t.state, s = $n(e[0], 0);
        if (s == 9) {
          let o = r.lineAt(i), l = t.state.tabSize, a = Do(o.text, l, i - o.from);
          return ve.replace({ widget: new yk((l - a % l) * this.view.defaultCharacterWidth / this.view.scaleX) });
        }
        return this.decorationCache[s] || (this.decorationCache[s] = ve.replace({ widget: new mk(n, s) }));
      }, boundary: n.replaceTabs ? void 0 : /[^]/ });
    }
    update(n) {
      let e = n.state.facet(hc);
      n.startState.facet(hc) != e ? (this.decorator = this.makeDecorator(e), this.decorations = this.decorator.createDeco(n.view)) : this.decorations = this.decorator.updateDeco(n, this.decorations);
    }
  }, { decorations: (n) => n.decorations }));
}
const pk = "\u2022";
function gk(n) {
  return n >= 32 ? pk : n == 10 ? "\u2424" : String.fromCharCode(9216 + n);
}
class mk extends Ni {
  constructor(e, t) {
  ...
  toDOM(e) {
    let t = gk(this.code), i = e.state.phrase("Control character") + " " + (fk[this.code] || "0x" + this.code.toString(16)), r = this.options.render && this.options.render(this.code, i, t);
    if (r) return r;
...
const bk = ve.line({ class: "cm-activeLine" }), wk = kt.fromClass(class {
  constructor(n) {
  ...
  getDeco(n) {
    ...
    for (let i of n.state.selection.ranges) {
      ...
      r.from > e && (t.push(bk.range(r.from)), e = r.from);
    }
    return ve.set(t);
  }
}, { decorations: (n) => n.decorations }), fu = 2e3;
function xk(n, e, t) {
  let i = Math.min(e.line, t.line), r = Math.max(e.line, t.line), s = [];
  if (e.off > fu || t.off > fu || e.col < 0 || t.col < 0) {
    ...
    for (let a = i; a <= r; a++) {
      let f = n.doc.line(a), h = Wh(f.text, o, n.tabSize, true);
      if (h < 0) s.push(j.cursor(f.to));
      else {
        let p = Wh(f.text, l, n.tabSize);
...
function Ag(n, e) {
  let t = n.posAtCoords({ x: e.clientX, y: e.clientY }, false), i = n.state.doc.lineAt(t), r = t - i.from, s = r > fu ? -1 : r == i.length ? Sk(n, e.clientX) : Do(i.text, n.state.tabSize, t - i.from);
  return { line: i.number, col: s, off: r };
}
function kk(n, e) {
  let t = Ag(n, e), i = n.state.selection;
  return t ? { update(r) {
    if (r.docChanged) {
    ...
    let l = Ag(n, r);
    if (!l) return i;
    let a = xk(n.state, t, l);
    return a.length ? o ? j.create(a.concat(i.ranges)) : j.create(a) : i;
  } } : null;
}
function Ck(n) {
  let e = ((t) => t.altKey && t.button == 0);
  return he.mouseSelectionStyle.of((t, i) => e(i) ? kk(t, i) : null);
}
const Mk = { Alt: [18, (n) => !!n.altKey], Control: [17, (n) => !!n.ctrlKey], Shift: [16, (n) => !!n.shiftKey], Meta: [91, (n) => !!n.metaKey] }, Ak = { style: "cursor: crosshair" };
function Tk(n = {}) {
  let [e, t] = Mk[n.key || "Alt"], i = kt.fromClass(class {
    constructor(r) {
  ...
  return [i, he.contentAttributes.of((r) => {
    var s;
    return !((s = r.plugin(i)) === null || s === void 0) && s.isDown ? Ak : null;
  })];
}
const ol = "-10000px";
class iv {
...
const Gf = be.define({ combine: (n) => {
  var e, t, i;
  return { position: ue.ios ? "absolute" : ((e = n.find((r) => r.position)) === null || e === void 0 ? void 0 : e.position) || "fixed", parent: ((t = n.find((r) => r.parent)) === null || t === void 0 ? void 0 : t.parent) || null, tooltipSpace: ((i = n.find((r) => r.tooltipSpace)) === null || i === void 0 ? void 0 : i.tooltipSpace) || Ek };
} }), Tg = /* @__PURE__ */ new WeakMap(), vd = kt.fromClass(class {
  constructor(n) {
    this.view = n, this.above = [], this.inView = true, this.madeAbsolute = false, this.lastTransaction = 0, this.measureTimeout = -1;
    let e = n.state.facet(Gf);
    this.position = e.position, this.parent = e.parent, this.classes = n.themeClasses, this.createContainer(), this.measureReq = { read: this.readMeasure.bind(this), write: this.writeMeasure.bind(this), key: this }, this.resizeObserver = typeof ResizeObserver == "function" ? new ResizeObserver(() => this.measureSoon()) : null, this.manager = new iv(n, rf, (t, i) => this.createTooltip(t, i), (t) => {
  ...
  update(n) {
    ...
    let t = e || n.geometryChanged, i = n.state.facet(Gf);
  ...
  readMeasure() {
    ...
    let i = this.view.scrollDOM.getBoundingClientRect(), r = dd(this.view);
    ...
    }), size: this.manager.tooltipViews.map(({ dom: s }) => s.getBoundingClientRect()), space: this.view.state.facet(Gf).tooltipSpace(this.view), scaleX: n, scaleY: e, makeAbsolute: t };
  }
  writeMeasure(n) {
    var e;
    if (n.makeAbsolute) {
    ...
    for (let l = 0; l < this.manager.tooltips.length; l++) {
      ...
      let b = a.arrow ? f.dom.querySelector(".cm-tooltip-arrow") : null, S = b ? 7 : 0, M = m.right - m.left, A = (e = Tg.get(f)) !== null && e !== void 0 ? e : m.bottom - m.top, _ = f.offset || _k, R = this.view.textDirection == gt.LTR, N = m.width > i.right - i.left ? R ? i.left : i.right - m.width : R ? Math.max(i.left, Math.min(p.left - (b ? 14 : 0) + _.x, i.right - M)) : Math.min(Math.max(i.left, p.left - M + (b ? 14 : 0) - _.x), i.right - M), B = this.above[l];
      ...
      if (W < A && f.resize !== false) {
        ...
        Tg.set(f, A), h.style.height = (A = W) / s + "px";
      ...
      if (this.position == "absolute" ? (h.style.top = (H - n.parent.top) / s + "px", Eg(h, (N - n.parent.left) / r)) : (h.style.top = H / s + "px", Eg(h, N / r)), b) {
...
const Ok = he.baseTheme({ ".cm-tooltip": { zIndex: 500, boxSizing: "border-box" }, "&light .cm-tooltip": { border: "1px solid #bbb", backgroundColor: "#f5f5f5" }, "&light .cm-tooltip-section:not(:first-child)": { borderTop: "1px solid #bbb" }, "&dark .cm-tooltip": { backgroundColor: "#333338", color: "white" }, ".cm-tooltip-arrow": { height: "7px", width: "14px", position: "absolute", zIndex: -1, overflow: "hidden", "&:before, &:after": { content: "''", position: "absolute", width: 0, height: 0, borderLeft: "7px solid transparent", borderRight: "7px solid transparent" }, ".cm-tooltip-above &": { bottom: "-7px", "&:before": { borderTop: "7px solid #bbb" }, "&:after": { borderTop: "7px solid #f5f5f5", bottom: "1px" } }, ".cm-tooltip-below &": { top: "-7px", "&:before": { borderBottom: "7px solid #bbb" }, "&:after": { borderBottom: "7px solid #f5f5f5", top: "1px" } } }, "&dark .cm-tooltip .cm-tooltip-arrow": { "&:before": { borderTopColor: "#333338", borderBottomColor: "#333338" }, "&:after": { borderTopColor: "transparent", borderBottomColor: "transparent" } } }), _k = { x: 0, y: 0 }, rf = be.define({ enables: [vd, Ok] }), _c = be.define({ combine: (n) => n.reduce((e, t) => e.concat(t), []) });
class sf {
  static create(e) {
    return new sf(e);
  }
  constructor(e) {
    this.view = e, this.mounted = false, this.dom = document.createElement("div"), this.dom.classList.add("cm-tooltip-hover"), this.manager = new iv(e, _c, (t, i) => this.createHostedView(t, i), (t) => t.dom.remove());
  }
...
const Lk = rf.compute([_c], (n) => {
  let e = n.facet(_c);
  return e.length === 0 ? null : { pos: Math.min(...e.map((t) => t.pos)), end: Math.max(...e.map((t) => {
    var i;
    return (i = t.end) !== null && i !== void 0 ? i : t.pos;
  })), create: sf.create, above: e[0].above, arrow: e.some((t) => t.arrow) };
});
class Dk {
  constructor(e, t, i, r, s) {
  ...
  get tooltip() {
    let e = this.view.plugin(vd), t = e ? e.manager.tooltips.findIndex((i) => i.create == sf.create) : -1;
  ...
  mousemove(e) {
    ...
    if (r.length && s && !Rk(s.dom, e) || this.pending) {
      let { pos: o } = r[0] || this.pending, l = (i = (t = r[0]) === null || t === void 0 ? void 0 : t.end) !== null && i !== void 0 ? i : o;
      (o == l ? this.view.posAtCoords(this.lastMove) != o : !Pk(this.view, o, l, e.clientX, e.clientY)) && (this.view.dispatch({ effects: this.setHover.of([]) }), this.pending = null);
    }
  }
  mouseleave(e) {
...
function Rk(n, e) {
  ...
  return e.clientX >= t - Ha && e.clientX <= i + Ha && e.clientY >= r - Ha && e.clientY <= s + Ha;
}
...
function rv(n, e = {}) {
  let t = _e.define(), i = Yt.define({ create() {
    return [];
  }, update(r, s) {
    ...
    for (let o of s.effects) o.is(t) && (r = o.value), o.is(Bk) && (r = []);
    return r;
  }, provide: (r) => _c.from(r) });
  return { active: i, extension: [i, kt.define((r) => new Dk(r, n, i, t, e.hoverTime || 300)), Lk] };
}
function sv(n, e) {
  let t = n.plugin(vd);
  if (!t) return null;
...
const Bk = _e.define(), Og = be.define({ combine(n) {
  let e, t;
  for (let i of n) e = e || i.topContainer, t = t || i.bottomContainer;
  return { topContainer: e, bottomContainer: t };
} });
function ql(n, e) {
  let t = n.plugin(ov), i = t ? t.specs.indexOf(e) : -1;
  return i > -1 ? t.panels[i] : null;
}
const ov = kt.fromClass(class {
  constructor(n) {
    this.input = n.state.facet(Vs), this.specs = this.input.filter((t) => t), this.panels = this.specs.map((t) => t(n));
    let e = n.state.facet(Og);
    this.top = new Va(n, true, e.topContainer), this.bottom = new Va(n, false, e.bottomContainer), this.top.sync(this.panels.filter((t) => t.top)), this.bottom.sync(this.panels.filter((t) => !t.top));
    for (let t of this.panels) t.dom.classList.add("cm-panel"), t.mount && t.mount();
  }
  update(n) {
    let e = n.state.facet(Og);
    this.top.container != e.topContainer && (this.top.sync([]), this.top = new Va(n.view, true, e.topContainer)), this.bottom.container != e.bottomContainer && (this.bottom.sync([]), this.bottom = new Va(n.view, false, e.bottomContainer)), this.top.syncClasses(), this.bottom.syncClasses();
...
const uc = be.define(), Ik = be.define(), Nk = { class: "", renderEmptyElements: false, elementStyle: "", markers: () => ze.empty, lineMarker: () => null, widgetMarker: () => null, lineMarkerChange: null, initialSpacer: null, updateSpacer: null, domEventHandlers: {}, side: "before" }, dc = be.define();
function Fk(n) {
  return [Hk(), dc.of({ ...Nk, ...n })];
}
const Lg = be.define({ combine: (n) => n.some((e) => e) });
function Hk(n) {
  return [Vk];
}
const Vk = kt.fromClass(class {
  constructor(n) {
    this.view = n, this.domAfter = null, this.prevViewport = n.viewport, this.dom = document.createElement("div"), this.dom.className = "cm-gutters cm-gutters-before", this.dom.setAttribute("aria-hidden", "true"), this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px", this.gutters = n.state.facet(dc).map((e) => new Rg(n, e)), this.fixed = !n.state.facet(Lg);
  ...
  update(n) {
    ...
    this.view.state.facet(Lg) != !this.fixed && (this.fixed = !this.fixed, this.dom.style.position = this.fixed ? "sticky" : "", this.domAfter && (this.domAfter.style.position = this.fixed ? "sticky" : "")), this.prevViewport = n.view.viewport;
  }
  syncGutters(n) {
    let e = this.dom.nextSibling;
    n && (this.dom.remove(), this.domAfter && this.domAfter.remove());
    let t = ze.iter(this.view.state.facet(uc), this.view.viewport.from), i = [], r = this.gutters.map((s) => new Wk(s, this.view.viewport, -this.view.documentPadding.top));
  ...
  updateGutters(n) {
    let e = n.startState.facet(dc), t = n.state.facet(dc), i = n.docChanged || n.heightChanged || n.viewportChanged || !ze.eq(n.startState.facet(uc), n.state.facet(uc), n.view.viewport.from, n.view.viewport.to);
    if (e == t) for (let r of this.gutters) r.update(n) && (i = true);
      ...
      for (let s of t) {
        let o = e.indexOf(s);
        o < 0 ? r.push(new Rg(this.view, s)) : (this.gutters[o].update(n), r.push(this.gutters[o]));
      }
...
class Wk {
  ...
  line(e, t, i) {
    let r = [];
    hu(this.cursor, r, t.from), i.length && (r = r.concat(i));
...
class Rg {
  constructor(e, t) {
    ...
    this.markers = Dg(t.markers(e)), t.initialSpacer && (this.spacer = new lv(e, 0, 0, [t.initialSpacer(e)]), this.dom.appendChild(this.spacer.dom), this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none");
  }
  update(e) {
    let t = this.markers;
    if (this.markers = Dg(this.config.markers(e.view)), this.spacer && this.config.updateSpacer) {
...
class lv {
  ...
  update(e, t, i, r) {
    this.height != t && (this.height = t, this.dom.style.height = t + "px"), this.above != i && (this.dom.style.marginTop = (this.above = i) ? i + "px" : ""), $k(this.markers, r) || this.setMarkers(e, r);
  }
  setMarkers(e, t) {
...
const zk = new class extends Xr {
  constructor() {
    super(...arguments), this.elementClass = "cm-activeLineGutter";
  }
}(), Kk = uc.compute(["selection"], (n) => {
  let e = [], t = -1;
  for (let i of n.selection.ranges) {
    let r = n.doc.lineAt(i.head).from;
    r > t && (t = r, e.push(zk.range(r)));
  }
  return ze.of(e);
});
function jk() {
...
class We {
  constructor(e = {}) {
    this.id = Uk++, this.perNode = !!e.perNode, this.deserialize = e.deserialize || (() => {
...
const Gk = /* @__PURE__ */ Object.create(null);
class xi {
  constructor(e, t, i, r = 0) {
    this.name = e, this.props = t, this.id = i, this.flags = r;
  }
  static define(e) {
    let t = e.props && e.props.length ? /* @__PURE__ */ Object.create(null) : Gk, i = (e.top ? 1 : 0) | (e.skipped ? 2 : 0) | (e.error ? 4 : 0) | (e.name == null ? 8 : 0), r = new xi(e.name || "", t, e.id, i);
    if (e.props) {
...
const Wa = /* @__PURE__ */ new WeakMap(), Pg = /* @__PURE__ */ new WeakMap();
var ln;
(function(n) {
...
class mn {
  ...
  cursor(e = 0) {
    return new du(this.topNode, e);
  }
  cursorAt(e, t = 0, i = 0) {
    let r = Wa.get(this) || this.topNode, s = new du(r);
    return s.moveTo(e, t), Wa.set(this, s._tree), s;
  }
  get topNode() {
    return new bi(this, 0, 0, null);
  }
  resolve(e, t = 0) {
    let i = Ul(Wa.get(this) || this.topNode, e, t, false);
    return Wa.set(this, i), i;
  }
  resolveInner(e, t = 0) {
    let i = Ul(Pg.get(this) || this.topNode, e, t, true);
    return Pg.set(this, i), i;
  }
  resolveStack(e, t = 0) {
    return Qk(this, e, t);
  }
  ...
  balance(e = {}) {
    return this.children.length <= 8 ? this : xd(xi.none, this.children, this.positions, 0, this.children.length, 0, this.length, (t, i, r) => new mn(this.type, t, i, r, this.propValues), e.makeTree || ((t, i, r) => new mn(xi.none, t, i, r)));
  }
  static build(e) {
    return Xk(e);
  }
...
class bd {
  ...
  fork() {
    return new bd(this.buffer, this.index);
  }
}
class Zr {
  constructor(e, t, i) {
  ...
  findChild(e, t, i, r, s) {
    ...
    for (let a = e; a != t && !(av(s, r, o[a + 1], o[a + 2]) && (l = a, i > 0)); a = o[a + 3]) ;
    return l;
  }
  slice(e, t, i) {
...
class bi extends cv {
  ...
  nextChild(e, t, i, r, s = 0) {
    for (let o = this; ; ) {
      for (let { children: l, positions: a } = o._tree, f = t > 0 ? l.length : -1; e != f; e += t) {
        ...
        if (av(r, i, p, p + h.length)) {
          if (h instanceof Zr) {
            if (s & ln.ExcludeBuffers) continue;
            let m = h.findChild(0, h.buffer.length, t, i - p, r);
            if (m > -1) return new Ur(new Yk(o, h, e, p), null, m);
          } else if (s & ln.IncludeAnonymous || !h.type.isAnonymous || wd(h)) {
            let m;
            if (!(s & ln.IgnoreMounts) && (m = Lc.get(h)) && !m.overlay) return new bi(m.tree, p, e, o);
  ...
  enter(e, t, i = 0) {
    let r;
    if (!(i & ln.IgnoreOverlays) && (r = Lc.get(this._tree)) && r.overlay) {
      let s = e - this.from;
...
function fv(n) {
  ...
  return i ? r[e] = i : r.splice(e, 1), new Jk(r, t);
}
class Jk {
  constructor(e, t) {
...
class du {
  ...
  atLastNode(e) {
    ...
    for (; i; { index: t, _parent: i } = i) if (t > -1) for (let s = t + e, o = e < 0 ? -1 : i._tree.children.length; s != o; s += e) {
      ...
      if (this.mode & ln.IncludeAnonymous || l instanceof Zr || !l.type.isAnonymous || wd(l)) return false;
    }
    return true;
  }
  move(e, t) {
  ...
  matchContext(e) {
    if (!this.buffer) return uu(this.node.parent, e);
    let { buffer: t } = this.buffer, { types: i } = t.set;
    for (let r = e.length - 1, s = this.stack.length - 1; r >= 0; s--) {
      if (s < 0) return uu(this._tree, e, r);
...
function wd(n) {
  return n.children.some((e) => e instanceof Zr || !e.type.isAnonymous || wd(e));
}
function Xk(n) {
  var e;
  let { buffer: t, nodeSet: i, maxBufferLength: r = qk, reused: s = [], minRepeatType: o = i.types.length } = n, l = Array.isArray(t) ? new bd(t, t.length) : t, a = i.types, f = 0, h = 0;
  function p(W, H, K, ee, oe, re) {
    ...
    if (J - Z <= r && (Te = A(l.pos - H, oe))) {
      ...
      if (Ke >= 0 && De > 0 && De < ye.length && S(ye, fe, Z, De, Z, Ge, Ke, ie, ke), ye.reverse(), fe.reverse(), Ke > -1 && De > 0) {
        let Ne = b(ae, ke);
        te = xd(ae, ye, fe, 0, ye.length, 0, J - Z, Ne, Ne);
...
function xd(n, e, t, i, r, s, o, l, a) {
  let f = 0;
  for (let S = i; S < r; S++) f += pc(n, e[S]);
  let h = Math.ceil(f * 1.5 / 8), p = [], m = [];
  function b(S, M, A, _, R) {
    for (let N = A; N < _; ) {
      let B = N, W = M[N], H = pc(n, S[N]);
      for (N++; N < _; N++) {
        let K = pc(n, S[N]);
        if (H + K >= h) break;
        H += K;
      ...
      if (N == B + 1) {
        ...
        p.push(xd(n, S, M, B, N, W, K, null, a));
      }
      m.push(W + R - s);
    }
  }
...
class Zk {
  startParse(e, t, i) {
    return typeof e == "string" && (e = new eC(e)), i = i ? i.length ? i.map((r) => new Yf(r.from, r.to)) : [new Yf(0, 0)] : [new Yf(0, e.length)], this.createParse(e, t || [], i);
  }
  parse(e, t, i) {
...
class di {
  constructor(e, t, i, r) {
    this.name = e, this.set = t, this.base = i, this.modified = r, this.id = tC++;
  }
  toString() {
    let { name: e } = this;
  ...
  static defineModifier(e) {
    let t = new Dc(e);
    return (i) => i.modified.indexOf(t) > -1 ? i : Dc.get(i.base || i, i.modified.concat(t).sort((r, s) => r.id - s.id));
  }
}
let nC = 0;
class Dc {
  ...
  static get(e, t) {
    if (!t.length) return e;
    let i = t[0].instances.find((l) => l.base == e && iC(t, l.modified));
    if (i) return i;
    let r = [], s = new di(e.name, r, e, t);
    for (let l of t) l.instances.push(s);
    let o = rC(t);
    for (let l of e.set) if (!l.modified.length) for (let a of o) r.push(Dc.get(l, a));
    return s;
  }
}
function iC(n, e) {
...
function sC(n) {
  ...
  for (let t in n) {
    ...
    for (let r of t.split(" ")) if (r) {
      ...
      let h = new Rc(i, o, a > 0 ? s.slice(0, a) : null);
      e[f] = h.sort(e[f]);
    }
  }
  return hv.add(e);
...
function lC(n, e, t, i = 0, r = n.length) {
  let s = new aC(i, Array.isArray(e) ? e : [e], t);
...
class aC {
  ...
  highlightRange(e, t, i, r, s) {
    ...
    let f = r, h = cC(e) || Rc.empty, p = oC(s, h.tags);
...
function cC(n) {
  let e = n.type.prop(hv);
  for (; e && e.context && !n.matchContext(e.context); ) e = e.next;
  return e || null;
}
const le = di.define, $a = le(), Vr = le(), Ng = le(Vr), Fg = le(Vr), Wr = le(), za = le(Wr), Jf = le(Wr), Zi = le(), ps = le(Zi), Yi = le(), Ji = le(), pu = le(), ll = le(pu), Ka = le(), U = { comment: $a, lineComment: le($a), blockComment: le($a), docComment: le($a), name: Vr, variableName: le(Vr), typeName: Ng, tagName: le(Ng), propertyName: Fg, attributeName: le(Fg), className: le(Vr), labelName: le(Vr), namespace: le(Vr), macroName: le(Vr), literal: Wr, string: za, docString: le(za), character: le(za), attributeValue: le(za), number: Jf, integer: le(Jf), float: le(Jf), bool: le(Wr), regexp: le(Wr), escape: le(Wr), color: le(Wr), url: le(Wr), keyword: Yi, self: le(Yi), null: le(Yi), atom: le(Yi), unit: le(Yi), modifier: le(Yi), operatorKeyword: le(Yi), controlKeyword: le(Yi), definitionKeyword: le(Yi), moduleKeyword: le(Yi), operator: Ji, derefOperator: le(Ji), arithmeticOperator: le(Ji), logicOperator: le(Ji), bitwiseOperator: le(Ji), compareOperator: le(Ji), updateOperator: le(Ji), definitionOperator: le(Ji), typeOperator: le(Ji), controlOperator: le(Ji), punctuation: pu, separator: le(pu), bracket: ll, angleBracket: le(ll), squareBracket: le(ll), paren: le(ll), brace: le(ll), content: Zi, heading: ps, heading1: le(ps), heading2: le(ps), heading3: le(ps), heading4: le(ps), heading5: le(ps), heading6: le(ps), contentSeparator: le(Zi), list: le(Zi), quote: le(Zi), emphasis: le(Zi), strong: le(Zi), link: le(Zi), monospace: le(Zi), strikethrough: le(Zi), inserted: le(), deleted: le(), changed: le(), invalid: le(), meta: Ka, documentMeta: le(Ka), annotation: le(Ka), processingInstruction: le(Ka), definition: di.defineModifier("definition"), constant: di.defineModifier("constant"), function: di.defineModifier("function"), standard: di.defineModifier("standard"), local: di.defineModifier("local"), special: di.defineModifier("special") };
for (let n in U) {
  let e = U[n];
  e instanceof di && (e.name = n);
}
uv([{ tag: U.link, class: "tok-link" }, { tag: U.heading, class: "tok-heading" }, { tag: U.emphasis, class: "tok-emphasis" }, { tag: U.strong, class: "tok-strong" }, { tag: U.keyword, class: "tok-keyword" }, { tag: U.atom, class: "tok-atom" }, { tag: U.bool, class: "tok-bool" }, { tag: U.url, class: "tok-url" }, { tag: U.labelName, class: "tok-labelName" }, { tag: U.inserted, class: "tok-inserted" }, { tag: U.deleted, class: "tok-deleted" }, { tag: U.literal, class: "tok-literal" }, { tag: U.string, class: "tok-string" }, { tag: U.number, class: "tok-number" }, { tag: [U.regexp, U.escape, U.special(U.string)], class: "tok-string2" }, { tag: U.variableName, class: "tok-variableName" }, { tag: U.local(U.variableName), class: "tok-variableName tok-local" }, { tag: U.definition(U.variableName), class: "tok-variableName tok-definition" }, { tag: U.special(U.variableName), class: "tok-variableName2" }, { tag: U.definition(U.propertyName), class: "tok-propertyName tok-definition" }, { tag: U.typeName, class: "tok-typeName" }, { tag: U.namespace, class: "tok-namespace" }, { tag: U.className, class: "tok-className" }, { tag: U.macroName, class: "tok-macroName" }, { tag: U.propertyName, class: "tok-propertyName" }, { tag: U.operator, class: "tok-operator" }, { tag: U.comment, class: "tok-comment" }, { tag: U.meta, class: "tok-meta" }, { tag: U.invalid, class: "tok-invalid" }, { tag: U.punctuation, class: "tok-punctuation" }]);
var Qf;
const bl = new We(), fC = new We();
class Di {
  constructor(e, t, i = [], r = "") {
    this.data = e, this.name = r, $e.prototype.hasOwnProperty("tree") || Object.defineProperty($e.prototype, "tree", { get() {
      ...
      let a = Hg(s, o, l), f = a.type.prop(bl);
      if (!f) return [];
      let h = s.facet(f), p = a.type.prop(fC);
      if (p) {
  ...
  isActiveAt(e, t, i = -1) {
    return Hg(e, t, i).type.prop(bl) == this.data;
  }
  findRegions(e) {
    let t = e.facet(es);
...
class Pc {
  ...
  static create(e, t, i) {
    return new Pc(e, t, [], mn.empty, 0, i, [], null);
  }
  startParse() {
    return this.parser.startParse(new hC(this.state.doc), this.fragments);
  }
  work(e, t) {
  ...
  withoutTempSkipped(e) {
    for (let t; t = this.tempSkipped.pop(); ) e = Vg(e, t.from, t.to);
    return e;
  }
  changes(e, t) {
    ...
    return new Pc(this.parser, t, i, r, s, o, l, this.scheduleOn);
  }
  updateViewport(e) {
    ...
    for (let i = 0; i < this.skipped.length; i++) {
      ...
      r < e.to && s > e.from && (this.fragments = Vg(this.fragments, r, s), this.skipped.splice(i--, 1));
    }
...
class ko {
  ...
  apply(e) {
    ...
    return t.work(20, i) || t.takeTree(), new ko(t);
  }
  static init(e) {
    let t = Math.min(3e3, e.doc.length), i = Pc.create(e.facet(es).parser, e, { from: 0, to: t });
    return i.work(20, t) || i.takeTree(), new ko(i);
  }
}
Di.state = Yt.define({ create: ko.init, update(n, e) {
  for (let t of e.effects) if (t.is(Di.setState)) return t.value;
  return e.startState.facet(es) != e.state.facet(es) ? ko.init(e.state) : n.apply(e);
} });
let pv = (n) => {
  let e = setTimeout(() => n(), 500);
  return () => clearTimeout(e);
};
typeof requestIdleCallback < "u" && (pv = (n) => {
  let e = -1, t = setTimeout(() => {
    e = requestIdleCallback(n, { timeout: 400 });
  }, 100);
  return () => e < 0 ? clearTimeout(t) : cancelIdleCallback(e);
});
const Xf = typeof navigator < "u" && (!((Qf = navigator.scheduling) === null || Qf === void 0) && Qf.isInputPending) ? () => navigator.scheduling.isInputPending() : null, uC = kt.fromClass(class {
  constructor(e) {
  ...
  scheduleWork() {
    ...
    (t.tree != t.context.tree || !t.context.isDone(e.doc.length)) && (this.working = pv(this.work));
  }
  work(e) {
    this.working = null;
    let t = Date.now();
    ...
    let o = Date.now() + Math.min(this.chunkBudget, 100, e && !Xf ? Math.max(25, e.timeRemaining() - 5) : 1e9), l = s.context.treeLen < r && i.doc.length > r + 1e3, a = s.context.work(() => Xf && Xf() || Date.now() > o, r + (l ? 0 : 1e5));
    this.chunkBudget -= Date.now() - t, (a || this.chunkBudget <= 0) && (s.context.takeTree(), this.view.dispatch({ effects: Di.setState.of(new ko(s.context)) })), this.chunkBudget > 0 && !(a && !l) && this.scheduleWork(), this.checkAsyncSchedule(s.context);
  }
...
}, enables: (n) => [Di.state, uC, he.contentAttributes.compute([n], (e) => {
  let t = e.facet(n);
  return t && t.name ? { "data-language": t.name } : {};
})] }), dC = be.define(), Gl = be.define({ combine: (n) => {
  if (!n.length) return "  ";
  let e = n[0];
...
function Sd(n, e) {
  n instanceof $e && (n = new of(n));
  for (let i of n.state.facet(dC)) {
    let r = i(n, e);
    if (r !== void 0) return r;
  }
  let t = vn(n.state);
  return t.length >= e ? gC(n, t, e) : null;
}
class of {
  constructor(e, t = {}) {
...
function yC(n) {
  let e = n.type.prop(pC);
  if (e) return e;
  let t = n.firstChild, i;
  if (t && (i = t.type.prop(We.closedBy))) {
    let r = n.lastChild, s = r && i.indexOf(r.name) > -1;
    return (o) => xC(o, true, 1, void 0, s && !mC(o) ? r.from : void 0);
  }
  return n.parent == null ? vC : null;
}
function vC() {
  return 0;
}
class kd extends of {
  ...
  continue() {
    return gv(this.context.next, this.base, this.pos);
  }
}
function bC(n, e) {
...
function AC(n, e, t) {
  ...
  for (let o = r; o; o = o.next) {
    ...
    if (s && l.from < e) break;
    let a = l.type.prop(MC);
    if (a && (l.to < i.length - 50 || i.length == n.doc.length || !TC(l))) {
      let f = a(l, n);
...
const lf = _e.define({ map: mv }), sa = _e.define({ map: mv });
function yv(n) {
  let e = [];
...
const Ws = Yt.define({ create() {
  ...
  e.isUserEvent("delete") && e.changes.iterChangedRanges((t, i) => n = Wg(n, t, i)), n = n.map(e.changes);
  for (let t of e.effects) if (t.is(lf) && !EC(n, t.value.from, t.value.to)) {
    let { preparePlaceholder: i } = e.state.facet(xv), r = i ? ve.replace({ widget: new PC(i(e.state, t.value)) }) : $g;
  ...
  return e.selection && (n = Wg(n, e.selection.main.head)), n;
...
function vv(n, e) {
  return n.field(Ws, false) ? e : e.concat(_e.appendConfig.of(Sv()));
}
const bv = (n) => {
  for (let e of yv(n)) {
    let t = Ic(n.state, e.from, e.to);
    if (t) return n.dispatch({ effects: vv(n.state, [lf.of(t), wv(n, t)]) }), true;
  }
  return false;
}, OC = (n) => {
  ...
  let e = [];
  for (let t of yv(n)) {
    let i = Nc(n.state, t.from, t.to);
    i && e.push(sa.of(i), wv(n, i, false));
  }
  return e.length && n.dispatch({ effects: e }), e.length > 0;
};
function wv(n, e, t = true) {
...
const _C = (n) => {
  ...
  for (let i = 0; i < e.doc.length; ) {
    let r = n.lineBlockAt(i), s = Ic(e, r.from, r.to);
    s && t.push(lf.of(s)), i = (s ? n.lineBlockAt(s.to) : r).to + 1;
  }
  return t.length && n.dispatch({ effects: vv(n.state, t) }), !!t.length;
}, LC = (n) => {
...
}, DC = [{ key: "Ctrl-Shift-[", mac: "Cmd-Alt-[", run: bv }, { key: "Ctrl-Shift-]", mac: "Cmd-Alt-]", run: OC }, { key: "Ctrl-Alt-[", run: _C }, { key: "Ctrl-Alt-]", run: LC }], RC = { placeholderDOM: null, preparePlaceholder: null, placeholderText: "\u2026" }, xv = be.define({ combine(n) {
  return Or(n, RC);
} });
function Sv(n) {
  return [Ws, NC];
...
function kv(n, e) {
  let { state: t } = n, i = t.facet(xv), r = (o) => {
    let l = n.lineBlockAt(n.posAtDOM(o.target)), a = Nc(n.state, l.from, l.to);
...
const $g = ve.replace({ widget: new class extends Ni {
  toDOM(n) {
    return kv(n, null);
  }
}() });
class PC extends Ni {
  ...
  toDOM(e) {
    return kv(e, this.value);
  }
}
const BC = { openText: "\u2304", closedText: "\u203A", markerDOM: null, domEventHandlers: {}, foldingChanged: () => false };
class Zf extends Xr {
  constructor(e, t) {
...
function IC(n = {}) {
  let e = { ...BC, ...n }, t = new Zf(e, true), i = new Zf(e, false), r = kt.fromClass(class {
    constructor(o) {
    ...
    buildMarkers(o) {
      ...
      for (let a of o.viewportLineBlocks) {
        let f = Nc(o.state, a.from, a.to) ? i : Ic(o.state, a.from, a.to) ? t : null;
        f && l.add(a.from, a.from, f);
      }
      return l.finish();
    }
  }), { domEventHandlers: s } = e;
  return [r, Fk({ class: "cm-foldGutter", markers(o) {
    var l;
    return ((l = o.plugin(r)) === null || l === void 0 ? void 0 : l.markers) || ze.empty;
  }, initialSpacer() {
    return new Zf(e, false);
  }, domEventHandlers: { ...s, click: (o, l, a) => {
    if (s.click && s.click(o, l, a)) return true;
    let f = Nc(o.state, l.from, l.to);
    if (f) return o.dispatch({ effects: sa.of(f) }), true;
    let h = Ic(o.state, l.from, l.to);
    return h ? (o.dispatch({ effects: lf.of(h) }), true) : false;
  } } }), Sv()];
}
const NC = he.baseTheme({ ".cm-foldPlaceholder": { backgroundColor: "#eee", border: "1px solid #ddd", color: "#888", borderRadius: ".2em", margin: "0 1px", padding: "0 1px", cursor: "pointer" }, ".cm-foldGutter span": { padding: "0 1px", cursor: "pointer" } });
class oa {
  constructor(e, t) {
    this.specs = e;
    let i;
    ...
    this.scope = o instanceof Di ? (l) => l.prop(bl) == o.data : o ? (l) => l == o : void 0, this.style = uv(e.map((l) => ({ tag: l.tag, class: l.class || r(Object.assign({}, l, { tag: null })) })), { all: s }).style, this.module = i ? new Yr(i) : null, this.themeType = t.themeType;
  }
  static define(e, t) {
    return new oa(e, t || {});
  }
}
const gu = be.define(), Cv = be.define({ combine(n) {
  return n.length ? [n[0]] : null;
} });
function eh(n) {
  let e = n.facet(gu);
  return e.length ? e : n.facet(Cv);
}
function Mv(n, e) {
  let t = [HC], i;
  return n instanceof oa && (n.module && t.push(he.styleModule.of(n.module)), i = n.themeType), (e == null ? void 0 : e.fallback) ? t.push(Cv.of(n)) : i ? t.push(gu.computeN([he.darkTheme], (r) => r.facet(he.darkTheme) == (i == "dark") ? [n] : [])) : t.push(gu.of(n)), t;
}
class FC {
  constructor(e) {
    this.markCache = /* @__PURE__ */ Object.create(null), this.tree = vn(e.state), this.decorations = this.buildDeco(e, eh(e.state)), this.decoratedTo = e.viewport.to;
  }
  update(e) {
    let t = vn(e.state), i = eh(e.state), r = i != eh(e.startState), { viewport: s } = e.view, o = e.changes.mapPos(this.decoratedTo, 1);
  ...
  buildDeco(e, t) {
    ...
    let i = new Ri();
    for (let { from: r, to: s } of e.visibleRanges) lC(this.tree, t, (o, l, a) => {
      i.add(o, l, this.markCache[a] || (this.markCache[a] = ve.mark({ class: a })));
    }, r, s);
    return i.finish();
  }
}
const HC = os.high(kt.fromClass(FC, { decorations: (n) => n.decorations })), VC = oa.define([{ tag: U.meta, color: "#404740" }, { tag: U.link, textDecoration: "underline" }, { tag: U.heading, textDecoration: "underline", fontWeight: "bold" }, { tag: U.emphasis, fontStyle: "italic" }, { tag: U.strong, fontWeight: "bold" }, { tag: U.strikethrough, textDecoration: "line-through" }, { tag: U.keyword, color: "#708" }, { tag: [U.atom, U.bool, U.url, U.contentSeparator, U.labelName], color: "#219" }, { tag: [U.literal, U.inserted], color: "#164" }, { tag: [U.string, U.deleted], color: "#a11" }, { tag: [U.regexp, U.escape, U.special(U.string)], color: "#e40" }, { tag: U.definition(U.variableName), color: "#00f" }, { tag: U.local(U.variableName), color: "#30a" }, { tag: [U.typeName, U.namespace], color: "#085" }, { tag: U.className, color: "#167" }, { tag: [U.special(U.variableName), U.macroName], color: "#256" }, { tag: U.definition(U.propertyName), color: "#00c" }, { tag: U.comment, color: "#940" }, { tag: U.invalid, color: "#f00" }]), WC = he.baseTheme({ "&.cm-focused .cm-matchingBracket": { backgroundColor: "#328c8252" }, "&.cm-focused .cm-nonmatchingBracket": { backgroundColor: "#bb555544" } }), Av = 1e4, Tv = "()[]{}", Ev = be.define({ combine(n) {
  return Or(n, { afterCursor: true, brackets: Tv, maxScanDistance: Av, renderMatch: KC });
} }), $C = ve.mark({ class: "cm-matchingBracket" }), zC = ve.mark({ class: "cm-nonmatchingBracket" });
function KC(n) {
  let e = [], t = n.matched ? $C : zC;
  return e.push(t.range(n.start.from, n.start.to)), n.end && e.push(t.range(n.end.from, n.end.to)), e;
}
const jC = Yt.define({ create() {
  return ve.none;
}, update(n, e) {
  if (!e.docChanged && !e.selection) return n;
  let t = [], i = e.state.facet(Ev);
...
}, provide: (n) => he.decorations.from(n) }), qC = [jC, WC];
function UC(n = {}) {
  return [Ev.of(n), qC];
}
const GC = new We();
...
function pi(n, e, t, i = {}) {
  let r = i.maxScanDistance || Av, s = i.brackets || Tv, o = vn(n), l = o.resolveInner(e, t);
  for (let a = l; a; a = a.parent) {
    let f = mu(a.type, t, s);
    if (f && a.from < a.to) {
      let h = yu(a);
      if (h && (t > 0 ? e >= h.from && e < h.to : e > h.from && e <= h.to)) return YC(n, e, t, a, h, f, s);
    }
  }
  return JC(n, e, t, o, l.type, r, s);
}
function YC(n, e, t, i, r, s, o) {
  ...
  if (h && (t < 0 ? h.childBefore(i.from) : h.childAfter(i.to))) do
    if (t < 0 ? h.to <= i.from : h.from >= i.to) {
      ...
      } else if (mu(h.type, t, o)) f++;
      else if (mu(h.type, -t, o)) {
        if (f == 0) {
          let p = yu(h);
...
class QC {
  ...
  column() {
    return this.lastColumnPos < this.start && (this.lastColumnValue = zg(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue), this.lastColumnPos = this.start), this.lastColumnValue;
  }
  indentation() {
    var e;
    return (e = this.overrideIndent) !== null && e !== void 0 ? e : zg(this.string, null, this.tabSize);
  }
  match(e, t, i) {
    if (typeof e == "string") {
...
const XC = /* @__PURE__ */ Object.create(null), Kg = [xi.none], jg = [], qg = /* @__PURE__ */ Object.create(null), ZC = /* @__PURE__ */ Object.create(null);
for (let [n, e] of [["variable", "variableName"], ["variable-2", "variableName.special"], ["string-2", "string.special"], ["def", "variableName.definition"], ["tag", "tagName"], ["attribute", "attributeName"], ["type", "typeName"], ["builtin", "variableName.standard"], ["qualifier", "modifier"], ["error", "invalid"], ["header", "heading"], ["property", "propertyName"]]) ZC[n] = eM(XC, e);
function th(n, e) {
  jg.indexOf(n) > -1 || (jg.push(n), console.warn(e));
}
function eM(n, e) {
  let t = [];
  for (let l of e.split(" ")) {
    ...
    for (let f of l.split(".")) {
      let h = n[f] || U[f];
      h ? typeof h == "function" ? a.length ? a = a.map(h) : th(f, `Modifier ${f} used at start of tag`) : a.length ? th(f, `Tag ${f} used as modifier`) : a = Array.isArray(h) ? h : [h] : th(f, `Unknown highlighting tag ${f}`);
    }
    for (let f of a) t.push(f);
  }
  if (!t.length) return 0;
  let i = e.replace(/ /g, "_"), r = i + " " + t.map((l) => l.id), s = qg[r];
  if (s) return s.id;
  let o = qg[r] = xi.define({ id: Kg.length, name: i, props: [sC({ [i]: t })] });
  return Kg.push(o), o.id;
}
gt.RTL, gt.LTR;
const tM = (n) => {
  let { state: e } = n, t = e.doc.lineAt(e.selection.main.from), i = Md(n.state, t.from);
  return i.line ? nM(n) : i.block ? rM(n) : false;
};
function Cd(n, e) {
...
const nM = Cd(lM, 0), iM = Cd(Ov, 0), rM = Cd((n, e) => Ov(n, e, oM(e)), 0);
function Md(n, e) {
  let t = n.languageDataAt("commentTokens", e, 1);
  return t.length ? t[0] : {};
}
const cl = 50;
function sM(n, { open: e, close: t }, i, r) {
...
function Ov(n, e, t = e.selection.ranges) {
  let i = t.map((s) => Md(e, s.from).block);
  if (!i.every((s) => s)) return null;
  let r = t.map((s, o) => sM(e, i[o], s.from, s.to));
...
function lM(n, e, t = e.selection.ranges) {
  ...
  for (let { from: s, to: o } of t) {
    let l = i.length, a = 1e9, f = Md(e, s).line;
    if (f) {
      for (let h = s; h <= o; ) {
...
const vu = Er.define(), aM = Er.define(), cM = be.define(), _v = be.define({ combine(n) {
  ...
  let t = e.state.facet(_v), i = e.annotation(vu);
  if (i) {
    let a = Kn.fromTransaction(e, i.selection), f = i.side, h = f == 0 ? n.undone : n.done;
    return a ? h = Hc(h, h.length, t.minDepth, a) : h = Rv(h, e.startState.selection), new lr(f == 0 ? i.rest : h, f == 0 ? h : i.rest);
  }
  let r = e.annotation(aM);
...
function fM(n = {}) {
  return [Lv, _v.of(n), he.domEventHandlers({ beforeinput(e, t) {
    let i = e.inputType == "historyUndo" ? Ad : e.inputType == "historyRedo" ? Fc : null;
...
function af(n, e) {
  return function({ state: t, dispatch: i }) {
    ...
    let r = t.field(Lv, false);
    if (!r) return false;
    let s = r.pop(n, t, e);
    return s ? (i(s), true) : false;
  };
}
const Ad = af(0, false), Fc = af(1, false), hM = af(0, true), uM = af(1, true);
class Kn {
  constructor(e, t, i, r, s) {
  ...
  static fromTransaction(e, t) {
    let i = gi;
    for (let r of e.startState.facet(cM)) {
      let s = r(e);
...
function Rv(n, e) {
  if (n.length) {
    let t = n[n.length - 1], i = t.selectionsAfter.slice(Math.max(0, t.selectionsAfter.length - gM));
    return i.length && i[i.length - 1].eq(e) ? n : (i.push(e), Hc(n, n.length - 1, 1e9, t.setSelAfter(i)));
...
function yM(n, e, t) {
  let i = Dv(n.selectionsAfter.length ? n.selectionsAfter.map((l) => l.map(e)) : gi, t);
  if (!n.changes) return Kn.selection(i);
  let r = n.changes.map(e), s = e.mapDesc(n.changes, true), o = n.mapped ? n.mapped.composeDesc(s) : s;
  return new Kn(r, _e.mapEffects(n.effects, e), o, n.startSelection.map(s), i);
}
const vM = /^(input\.type|delete)($|\.)/;
class lr {
  ...
  addChanges(e, t, i, r, s) {
    ...
    return l && l.changes && !l.changes.empty && e.changes && (!i || vM.test(i)) && (!l.selectionsAfter.length && t - this.prevTime < r.newGroupDelay && r.joinToEvent(s, dM(l.changes, e.changes)) || i == "input.type.compose") ? o = Hc(o, o.length - 1, r.minDepth, new Kn(e.changes.compose(l.changes), Dv(_e.mapEffects(e.effects, l.changes), l.effects), l.mapped, l.startSelection, gi)) : o = Hc(o, o.length, r.minDepth, e), new lr(o, gi, t, i);
  }
  addSelection(e, t, i, r) {
    let s = this.done.length ? this.done[this.done.length - 1].selectionsAfter : gi;
    return s.length > 0 && t - this.prevTime < r && i == this.prevUserEvent && i && /^select($|\.)/.test(i) && pM(s[s.length - 1], e) ? this : new lr(Rv(this.done, e), this.undone, t, i);
  }
  addMapping(e) {
    return new lr(nh(this.done, e), nh(this.undone, e), this.prevTime, this.prevUserEvent);
  }
  pop(e, t, i) {
    let r = e == 0 ? this.done : this.undone;
    if (r.length == 0) return null;
    let s = r[r.length - 1], o = s.selectionsAfter[0] || t.selection;
    if (i && s.selectionsAfter.length) return t.update({ selection: s.selectionsAfter[s.selectionsAfter.length - 1], annotations: vu.of({ side: e, rest: mM(r), selection: o }), userEvent: e == 0 ? "select.undo" : "select.redo", scrollIntoView: true });
    if (s.changes) {
      let l = r.length == 1 ? gi : r.slice(0, r.length - 1);
      return s.mapped && (l = nh(l, s.mapped)), t.update({ changes: s.changes, selection: s.startSelection, effects: s.effects, annotations: vu.of({ side: e, rest: l, selection: o }), filter: false, userEvent: e == 0 ? "undo" : "redo", scrollIntoView: true });
    } else return null;
  }
}
lr.empty = new lr(gi, gi);
const bM = [{ key: "Mod-z", run: Ad, preventDefault: true }, { key: "Mod-y", mac: "Mod-Shift-z", run: Fc, preventDefault: true }, { linux: "Ctrl-Shift-z", run: Fc, preventDefault: true }, { key: "Mod-u", run: hM, preventDefault: true }, { key: "Alt-u", mac: "Mod-Shift-u", run: uM, preventDefault: true }];
function Ro(n, e) {
...
function Td(n, e) {
  return Hi(n, (t) => t.empty ? n.moveByChar(t, e) : cf(t, e));
}
function bn(n) {
  return n.textDirectionAt(n.state.selection.main.head) == gt.LTR;
}
const Ed = (n) => Td(n, !bn(n)), Pv = (n) => Td(n, bn(n)), wM = (n) => Td(n, false);
function Bv(n, e) {
  return Hi(n, (t) => t.empty ? n.moveByGroup(t, e) : cf(t, e));
}
const xM = (n) => Bv(n, !bn(n)), SM = (n) => Bv(n, bn(n));
function kM(n, e, t) {
...
const CM = (n) => Hi(n, (e) => ff(n.state, e, !bn(n))), MM = (n) => Hi(n, (e) => ff(n.state, e, bn(n)));
function Iv(n, e) {
  return Hi(n, (t) => {
    if (!t.empty) return cf(t, e);
    let i = n.moveVertically(t, e);
    return i.head != t.head ? i : n.moveToLineBoundary(t, e);
  });
}
const Nv = (n) => Iv(n, false), Fv = (n) => Iv(n, true);
function Hv(n) {
...
function Vv(n, e) {
  let t = Hv(n), { state: i } = n, r = Ro(i.selection, (o) => o.empty ? n.moveVertically(o, e, t.height) : cf(o, e));
...
const Ug = (n) => Vv(n, false), bu = (n) => Vv(n, true);
function ls(n, e, t) {
...
const Wv = (n) => Hi(n, (e) => ls(n, e, true)), $v = (n) => Hi(n, (e) => ls(n, e, false)), AM = (n) => Hi(n, (e) => ls(n, e, !bn(n))), TM = (n) => Hi(n, (e) => ls(n, e, bn(n))), EM = (n) => Hi(n, (e) => j.cursor(n.lineBlockAt(e.head).from, 1)), OM = (n) => Hi(n, (e) => j.cursor(n.lineBlockAt(e.head).to, -1));
function _M(n, e, t) {
...
const LM = ({ state: n, dispatch: e }) => _M(n, e);
function Si(n, e) {
...
const Kv = (n) => zv(n, !bn(n)), jv = (n) => zv(n, bn(n));
function qv(n, e) {
  return Si(n, (t) => n.moveByGroup(t, e));
}
const DM = (n) => qv(n, !bn(n)), RM = (n) => qv(n, bn(n)), PM = (n) => Si(n, (e) => ff(n.state, e, !bn(n))), BM = (n) => Si(n, (e) => ff(n.state, e, bn(n)));
function Uv(n, e) {
  return Si(n, (t) => n.moveVertically(t, e));
}
const Gv = (n) => Uv(n, false), Yv = (n) => Uv(n, true);
function Jv(n, e) {
  return Si(n, (t) => n.moveVertically(t, e, Hv(n).height));
}
const Gg = (n) => Jv(n, false), Yg = (n) => Jv(n, true), IM = (n) => Si(n, (e) => ls(n, e, true)), NM = (n) => Si(n, (e) => ls(n, e, false)), FM = (n) => Si(n, (e) => ls(n, e, !bn(n))), HM = (n) => Si(n, (e) => ls(n, e, bn(n))), VM = (n) => Si(n, (e) => j.cursor(n.lineBlockAt(e.head).from)), WM = (n) => Si(n, (e) => j.cursor(n.lineBlockAt(e.head).to)), Jg = ({ state: n, dispatch: e }) => (e(Fi(n, { anchor: 0 })), true), Qg = ({ state: n, dispatch: e }) => (e(Fi(n, { anchor: n.doc.length })), true), Xg = ({ state: n, dispatch: e }) => (e(Fi(n, { anchor: n.selection.main.anchor, head: 0 })), true), Zg = ({ state: n, dispatch: e }) => (e(Fi(n, { anchor: n.selection.main.anchor, head: n.doc.length })), true), $M = ({ state: n, dispatch: e }) => (e(n.update({ selection: { anchor: 0, head: n.doc.length }, userEvent: "select" })), true), zM = ({ state: n, dispatch: e }) => {
  let t = hf(n).map(({ from: i, to: r }) => j.range(i, Math.min(r + 1, n.doc.length)));
...
const jM = (n) => Qv(n, false), qM = (n) => Qv(n, true), UM = ({ state: n, dispatch: e }) => {
...
const Xv = (n, e, t) => la(n, (i) => {
  ...
  if (t && !e && r > o.from && r < o.from + 200 && !/[^ \t]/.test(l = o.text.slice(0, r - o.from))) {
    ...
    let f = Do(l, s.tabSize), h = f % Bc(s) || Bc(s);
  ...
  return a;
}), wu = (n) => Xv(n, false, true), Zv = (n) => Xv(n, true, false), eb = (n, e) => la(n, (t) => {
  ...
  return i;
}), tb = (n) => eb(n, false), GM = (n) => eb(n, true), YM = (n) => la(n, (e) => {
...
const eA = ({ state: n, dispatch: e }) => nb(n, e, false), tA = ({ state: n, dispatch: e }) => nb(n, e, true);
function ib(n, e, t) {
  if (n.readOnly) return false;
  let i = [];
  for (let r of hf(n)) t ? i.push({ from: r.from, insert: n.doc.slice(r.from, r.to) + n.lineBreak }) : i.push({ from: r.to, insert: n.lineBreak + n.doc.slice(r.from, r.to) });
  return e(n.update({ changes: i, scrollIntoView: true, userEvent: "input.copyline" })), true;
}
const nA = ({ state: n, dispatch: e }) => ib(n, e, false), iA = ({ state: n, dispatch: e }) => ib(n, e, true), rA = (n) => {
  if (n.state.readOnly) return false;
  let { state: e } = n, t = e.changes(hf(e).map(({ from: r, to: s }) => (r > 0 ? r-- : s < e.doc.length && s++, { from: r, to: s }))), i = Ro(e.selection, (r) => {
    let s;
    if (n.lineWrapping) {
...
const xu = rb(false), oA = rb(true);
function rb(n) {
  return ({ state: e, dispatch: t }) => {
    if (e.readOnly) return false;
    let i = e.changeByRange((r) => {
      let { from: s, to: o } = r, l = e.doc.lineAt(s), a = !n && s == o && sA(e, s);
      n && (s = o = (o <= l.to ? l : e.doc.lineAt(o)).to);
      let f = new of(e, { simulateBreak: s, simulateDoubleBreak: !!a }), h = Sd(f, s);
...
const sb = ({ state: n, dispatch: e }) => {
  if (n.readOnly) return false;
  let t = /* @__PURE__ */ Object.create(null), i = new of(n, { overrideIndentation: (s) => {
    let o = t[s];
    return o ?? -1;
  } }), r = Od(n, (s, o, l) => {
    let a = Sd(i, s.from);
...
}, ob = ({ state: n, dispatch: e }) => n.readOnly ? false : (e(n.update(Od(n, (t, i) => {
  i.push({ from: t.from, insert: n.facet(Gl) });
}), { userEvent: "input.indent" })), true), lb = ({ state: n, dispatch: e }) => n.readOnly ? false : (e(n.update(Od(n, (t, i) => {
  let r = /^\s*/.exec(t.text)[0];
  if (!r) return;
  let s = Do(r, n.tabSize), o = 0, l = Yl(n, Math.max(0, s - Bc(n)));
  for (; o < r.length && o < l.length && r.charCodeAt(o) == l.charCodeAt(o); ) o++;
  i.push({ from: t.from + o, to: t.from + r.length, insert: l.slice(o) });
}), { userEvent: "delete.dedent" })), true), lA = (n) => (n.setTabFocusMode(), true), aA = [{ key: "Ctrl-b", run: Ed, shift: Kv, preventDefault: true }, { key: "Ctrl-f", run: Pv, shift: jv }, { key: "Ctrl-p", run: Nv, shift: Gv }, { key: "Ctrl-n", run: Fv, shift: Yv }, { key: "Ctrl-a", run: EM, shift: VM }, { key: "Ctrl-e", run: OM, shift: WM }, { key: "Ctrl-d", run: Zv }, { key: "Ctrl-h", run: wu }, { key: "Ctrl-k", run: YM }, { key: "Ctrl-Alt-h", run: tb }, { key: "Ctrl-o", run: XM }, { key: "Ctrl-t", run: ZM }, { key: "Ctrl-v", run: bu }], cA = [{ key: "ArrowLeft", run: Ed, shift: Kv, preventDefault: true }, { key: "Mod-ArrowLeft", mac: "Alt-ArrowLeft", run: xM, shift: DM, preventDefault: true }, { mac: "Cmd-ArrowLeft", run: AM, shift: FM, preventDefault: true }, { key: "ArrowRight", run: Pv, shift: jv, preventDefault: true }, { key: "Mod-ArrowRight", mac: "Alt-ArrowRight", run: SM, shift: RM, preventDefault: true }, { mac: "Cmd-ArrowRight", run: TM, shift: HM, preventDefault: true }, { key: "ArrowUp", run: Nv, shift: Gv, preventDefault: true }, { mac: "Cmd-ArrowUp", run: Jg, shift: Xg }, { mac: "Ctrl-ArrowUp", run: Ug, shift: Gg }, { key: "ArrowDown", run: Fv, shift: Yv, preventDefault: true }, { mac: "Cmd-ArrowDown", run: Qg, shift: Zg }, { mac: "Ctrl-ArrowDown", run: bu, shift: Yg }, { key: "PageUp", run: Ug, shift: Gg }, { key: "PageDown", run: bu, shift: Yg }, { key: "Home", run: $v, shift: NM, preventDefault: true }, { key: "Mod-Home", run: Jg, shift: Xg }, { key: "End", run: Wv, shift: IM, preventDefault: true }, { key: "Mod-End", run: Qg, shift: Zg }, { key: "Enter", run: xu, shift: xu }, { key: "Mod-a", run: $M }, { key: "Backspace", run: wu, shift: wu, preventDefault: true }, { key: "Delete", run: Zv, preventDefault: true }, { key: "Mod-Backspace", mac: "Alt-Backspace", run: tb, preventDefault: true }, { key: "Mod-Delete", mac: "Alt-Delete", run: GM, preventDefault: true }, { mac: "Mod-Backspace", run: JM, preventDefault: true }, { mac: "Mod-Delete", run: QM, preventDefault: true }].concat(aA.map((n) => ({ mac: n.key, run: n.run, shift: n.shift }))), fA = [{ key: "Alt-ArrowLeft", mac: "Ctrl-ArrowLeft", run: CM, shift: PM }, { key: "Alt-ArrowRight", mac: "Ctrl-ArrowRight", run: MM, shift: BM }, { key: "Alt-ArrowUp", run: eA }, { key: "Shift-Alt-ArrowUp", run: nA }, { key: "Alt-ArrowDown", run: tA }, { key: "Shift-Alt-ArrowDown", run: iA }, { key: "Mod-Alt-ArrowUp", run: jM }, { key: "Mod-Alt-ArrowDown", run: qM }, { key: "Escape", run: UM }, { key: "Mod-Enter", run: oA }, { key: "Alt-l", mac: "Ctrl-l", run: zM }, { key: "Mod-i", run: KM, preventDefault: true }, { key: "Mod-[", run: lb }, { key: "Mod-]", run: ob }, { key: "Mod-Alt-\\", run: sb }, { key: "Shift-Mod-k", run: rA }, { key: "Shift-Mod-\\", run: LM }, { key: "Mod-/", run: tM }, { key: "Alt-A", run: iM }, { key: "Ctrl-m", mac: "Shift-Alt-m", run: lA }].concat(cA), em = typeof String.prototype.normalize == "function" ? (n) => n.normalize("NFKD") : (n) => n;
class Co {
  constructor(e, t, i = 0, r = e.length, s, o) {
    this.test = o, this.value = { from: 0, to: 0 }, this.done = false, this.matches = [], this.buffer = "", this.bufferPos = 0, this.iter = e.iterRange(i, r), this.bufferStart = i, this.normalize = s ? (l) => s(em(l)) : em, this.query = this.normalize(t);
  }
  peek() {
  ...
  nextOverlapping() {
    for (; ; ) {
      ...
      let t = rd(e), i = this.bufferStart + this.bufferPos;
      this.bufferPos += sr(e);
...
typeof Symbol < "u" && (Co.prototype[Symbol.iterator] = function() {
  return this;
});
const ab = { from: -1, to: -1, match: /.*/.exec("") }, _d = "gm" + (/x/.unicode == null ? "" : "u");
class Ld {
  constructor(e, t, i, r = 0, s = e.length) {
    if (this.text = e, this.to = s, this.curLine = "", this.done = false, this.value = ab, /\\[sWDnr]|\n|\r|\[\^/.test(t)) return new cb(e, t, i, r, s);
    this.re = new RegExp(t, _d + ((i == null ? void 0 : i.ignoreCase) ? "i" : "")), this.test = i == null ? void 0 : i.test, this.iter = e.iter();
    let o = e.lineAt(r);
    this.curLineStart = o.from, this.matchPos = Vc(e, r), this.getLine(this.curLineStart);
  }
  getLine(e) {
  ...
  next() {
    for (let e = this.matchPos - this.curLineStart; ; ) {
      ...
      if (t) {
        ...
        if (this.matchPos = Vc(this.text, r + (i == r ? 1 : 0)), i == this.curLineStart + this.curLine.length && this.nextLine(), (i < r || i > this.value.to) && (!this.test || this.test(i, r, t))) return this.value = { from: i, to: r, match: t }, this;
...
class po {
  ...
  static get(e, t, i) {
    ...
    if (!r || r.from >= i || r.to <= t) {
      let l = new po(t, e.sliceString(t, i));
      return ih.set(e, l), l;
    }
    if (r.from == t && r.to == i) return r;
    let { text: s, from: o } = r;
    return o > t && (s = e.sliceString(t, o) + s, o = t), r.to < i && (s += e.sliceString(r.to, i)), ih.set(e, new po(o, s)), new po(t, s.slice(t - o, i - o));
  }
}
class cb {
  constructor(e, t, i, r, s) {
    this.text = e, this.to = s, this.done = false, this.value = ab, this.matchPos = Vc(e, r), this.re = new RegExp(t, _d + ((i == null ? void 0 : i.ignoreCase) ? "i" : "")), this.test = i == null ? void 0 : i.test, this.flat = po.get(e, r, this.chunkEnd(r + 5e3));
  }
  chunkEnd(e) {
  ...
  next() {
    for (; ; ) {
      ...
      if (t && !t[0] && t.index == e && (this.re.lastIndex = e + 1, t = this.re.exec(this.flat.text)), t) {
        ...
        if ((this.flat.to >= this.to || t.index + t[0].length <= this.flat.text.length - 10) && (!this.test || this.test(i, r, t))) return this.value = { from: i, to: r, match: t }, this.matchPos = Vc(this.text, r + (i == r ? 1 : 0)), this;
      }
      if (this.flat.to == this.to) return this.done = true, this;
      this.flat = po.get(this.text, this.flat.from, this.chunkEnd(this.flat.from + this.flat.text.length * 2));
    }
  }
}
typeof Symbol < "u" && (Ld.prototype[Symbol.iterator] = cb.prototype[Symbol.iterator] = function() {
  return this;
});
function hA(n) {
  try {
    return new RegExp(n, _d), true;
  } catch {
    return false;
  }
}
...
const Ll = _e.define(), tm = Yt.define({ create() {
  return true;
}, update(n, e) {
  for (let t of e.effects) t.is(Ll) && (n = t.value);
  return n;
}, provide: (n) => Vs.from(n, (e) => e ? Su : null) }), uA = (n) => {
  let e = ql(n, Su);
  if (!e) {
    let t = [Ll.of(true)];
    n.state.field(tm, false) == null && t.push(_e.appendConfig.of([tm, dA])), n.dispatch({ effects: t }), e = ql(n, Su);
  }
  return e && e.dom.querySelector("input").select(), true;
}, dA = he.baseTheme({ ".cm-panel.cm-gotoLine": { padding: "2px 6px 4px", position: "relative", "& label": { fontSize: "80%" }, "& [name=close]": { position: "absolute", top: "0", bottom: "0", right: "4px", backgroundColor: "inherit", border: "none", font: "inherit", padding: "0" } } }), pA = { highlightWordAroundCursor: false, minSelectionLength: 1, maxMatches: 100, wholeWords: false }, gA = be.define({ combine(n) {
  return Or(n, pA, { highlightWordAroundCursor: (e, t) => e || t, minSelectionLength: Math.min, maxMatches: Math.min });
} });
function mA(n) {
  return [xA, wA];
}
const yA = ve.mark({ class: "cm-selectionMatch" }), vA = ve.mark({ class: "cm-selectionMatch cm-selectionMatch-main" });
function nm(n, e, t, i) {
...
const wA = kt.fromClass(class {
  ...
  getDeco(n) {
    let e = n.state.facet(gA), { state: t } = n, i = t.selection;
    ...
    if (r.empty) {
      ...
      if (e.wholeWords) {
        if (s = t.sliceDoc(r.from, r.to), o = t.charCategorizer(r.head), !(nm(o, t, r.from, r.to) && bA(o, t, r.from, r.to))) return ve.none;
      } else if (s = t.sliceDoc(r.from, r.to), !s) return ve.none;
    }
    let l = [];
    for (let a of n.visibleRanges) {
      let f = new Co(t.doc, s, a.from, a.to);
      for (; !f.next().done; ) {
        let { from: h, to: p } = f.value;
        if ((!o || nm(o, t, h, p)) && (r.empty && h <= r.from && p >= r.to ? l.push(vA.range(h, p)) : (h >= r.to || p <= r.from) && l.push(yA.range(h, p)), l.length > e.maxMatches)) return ve.none;
      }
    }
    return ve.set(l);
  }
}, { decorations: (n) => n.decorations }), xA = he.baseTheme({ ".cm-selectionMatch": { backgroundColor: "#99ff7780" }, ".cm-searchMatch .cm-selectionMatch": { backgroundColor: "transparent" } }), SA = ({ state: n, dispatch: e }) => {
...
function kA(n, e) {
  ...
  for (let o = false, l = new Co(n.doc, e, i[i.length - 1].to); ; ) if (l.next(), l.done) {
    if (o) return null;
    l = new Co(n.doc, e, 0, Math.max(0, i[i.length - 1].from - 1)), o = true;
  } else {
...
const CA = ({ state: n, dispatch: e }) => {
  let { ranges: t } = n.selection;
  if (t.some((s) => s.from === s.to)) return SA({ state: n, dispatch: e });
  ...
  return Or(n, { top: false, caseSensitive: false, literal: false, regexp: false, wholeWord: false, createPanel: (e) => new IA(e), scrollToMatch: (e) => he.scrollIntoView(e) });
} });
class Dd {
  constructor(e) {
    this.search = e.search, this.caseSensitive = !!e.caseSensitive, this.literal = !!e.literal, this.regexp = !!e.regexp, this.replace = e.replace || "", this.valid = !!this.search && (!this.regexp || hA(this.search)), this.unquoted = this.unquote(this.search), this.wholeWord = !!e.wholeWord;
  }
  unquote(e) {
...
` : i == "r" ? "\r" : i == "t" ? "	" : "\\");
  ...
  create() {
    return this.regexp ? new EA(this) : new AA(this);
  }
  getCursor(e, t = 0, i) {
    let r = e.doc ? e : $e.create({ doc: e });
    return i == null && (i = r.doc.length), this.regexp ? oo(this, r, t, i) : so(this, r, t, i);
  }
}
class fb {
  constructor(e) {
...
function so(n, e, t, i) {
  return new Co(e.doc, n.unquoted, t, i, n.caseSensitive ? void 0 : (r) => r.toLowerCase(), n.wholeWord ? MA(e.doc, e.charCategorizer(e.selection.main.head)) : void 0);
}
function MA(n, e) {
  return (t, i, r, s) => ((s > t || s + r.length < i) && (s = Math.max(0, t - 2), r = n.sliceString(s, Math.min(n.length, i + 2))), (e(Wc(r, t - s)) != St.Word || e($c(r, t - s)) != St.Word) && (e($c(r, i - s)) != St.Word || e(Wc(r, i - s)) != St.Word));
}
class AA extends fb {
  constructor(e) {
    super(e);
  ...
  nextMatch(e, t, i) {
    let r = so(this.spec, e, i, e.doc.length).nextOverlapping();
    if (r.done) {
      let s = Math.min(e.doc.length, t + this.spec.unquoted.length);
      r = so(this.spec, e, 0, s).nextOverlapping();
    }
    return r.done || r.value.from == t && r.value.to == i ? null : r.value;
  }
  prevMatchInRange(e, t, i) {
    for (let r = i; ; ) {
      let s = Math.max(t, r - 1e4 - this.spec.unquoted.length), o = so(this.spec, e, s, r), l = null;
  ...
  highlight(e, t, i, r) {
    let s = so(this.spec, e, Math.max(0, t - this.spec.unquoted.length), Math.min(i + this.spec.unquoted.length, e.doc.length));
    for (; !s.next().done; ) r(s.value.from, s.value.to);
  }
}
function oo(n, e, t, i) {
  return new Ld(e.doc, n.search, { ignoreCase: !n.caseSensitive, test: n.wholeWord ? TA(e.charCategorizer(e.selection.main.head)) : void 0 }, t, i);
}
function Wc(n, e) {
...
function TA(n) {
  return (e, t, i) => !i[0].length || (n(Wc(i.input, i.index)) != St.Word || n($c(i.input, i.index)) != St.Word) && (n($c(i.input, i.index + i[0].length)) != St.Word || n(Wc(i.input, i.index + i[0].length)) != St.Word);
}
class EA extends fb {
  nextMatch(e, t, i) {
    let r = oo(this.spec, e, i, e.doc.length).next();
    return r.done && (r = oo(this.spec, e, 0, t).next()), r.done ? null : r.value;
  }
  prevMatchInRange(e, t, i) {
    for (let r = 1; ; r++) {
      let s = Math.max(t, i - r * 1e4), o = oo(this.spec, e, s, i), l = null;
  ...
  matchAll(e, t) {
    let i = oo(this.spec, e, 0, e.doc.length), r = [];
    for (; !i.next().done; ) {
      if (r.length >= t) return null;
      r.push(i.value);
    }
  ...
  highlight(e, t, i, r) {
    let s = oo(this.spec, e, Math.max(0, t - 250), Math.min(i + 250, e.doc.length));
    for (; !s.next().done; ) r(s.value.from, s.value.to);
  }
}
const ts = _e.define(), Rd = _e.define(), Gr = Yt.define({ create(n) {
  return new rh(ku(n).create(), null);
}, update(n, e) {
  for (let t of e.effects) t.is(ts) ? n = new rh(t.value.create(), n.panel) : t.is(Rd) && (n = new rh(n.query, t.value ? Pd : null));
  return n;
...
const OA = ve.mark({ class: "cm-searchMatch" }), _A = ve.mark({ class: "cm-searchMatch cm-searchMatch-selected" }), LA = kt.fromClass(class {
  constructor(n) {
...
function aa(n) {
  return (e) => {
    ...
    return t && t.query.spec.valid ? n(e, t) : db(e);
  };
}
const zc = aa((n, { query: e }) => {
  let { to: t } = n.state.selection.main, i = e.nextMatch(n.state, t, t);
  if (!i) return false;
  let r = j.single(i.from, i.to), s = n.state.facet(Po);
  return n.dispatch({ selection: r, effects: [Bd(n, i), s.scrollToMatch(r.main, n)], userEvent: "select.search" }), ub(n), true;
}), Kc = aa((n, { query: e }) => {
  let { state: t } = n, { from: i } = t.selection.main, r = e.prevMatch(t, i, i);
  if (!r) return false;
  let s = j.single(r.from, r.to), o = n.state.facet(Po);
  return n.dispatch({ selection: s, effects: [Bd(n, r), o.scrollToMatch(s.main, n)], userEvent: "select.search" }), ub(n), true;
}), DA = aa((n, { query: e }) => {
  ...
  return o && (a = j.single(o.from, o.to).map(p), h.push(Bd(n, o)), h.push(t.facet(Po).scrollToMatch(a.main, n))), n.dispatch({ changes: p, selection: a, effects: h, userEvent: "input.replace" }), true;
}), PA = aa((n, { query: e }) => {
  if (n.state.readOnly) return false;
...
const db = (n) => {
  ...
  if (e && e.panel) {
    ...
    if (t && t != n.root.activeElement) {
      let i = ku(n.state, e.query.spec);
      i.valid && n.dispatch({ effects: ts.of(i) }), t.focus(), t.select();
    }
  } else n.dispatch({ effects: [Rd.of(true), e ? ts.of(ku(n.state, e.query.spec)) : _e.appendConfig.of(FA)] });
  return true;
}, pb = (n) => {
  let e = n.state.field(Gr, false);
  if (!e || !e.panel) return false;
  let t = ql(n, Pd);
  return t && t.dom.contains(n.root.activeElement) && n.focus(), n.dispatch({ effects: Rd.of(false) }), true;
}, BA = [{ key: "Mod-f", run: db, scope: "editor search-panel" }, { key: "F3", run: zc, shift: Kc, scope: "editor search-panel", preventDefault: true }, { key: "Mod-g", run: zc, shift: Kc, scope: "editor search-panel", preventDefault: true }, { key: "Escape", run: pb, scope: "editor search-panel" }, { key: "Mod-Shift-l", run: RA }, { key: "Mod-Alt-g", run: uA }, { key: "Mod-d", run: CA, preventDefault: true }];
class IA {
  constructor(e) {
    this.view = e;
    ...
    this.dom = ct("div", { onkeydown: (r) => this.keydown(r), class: "cm-search" }, [this.searchField, i("next", () => zc(e), [Zn(e, "next")]), i("prev", () => Kc(e), [Zn(e, "previous")]), i("select", () => DA(e), [Zn(e, "all")]), ct("label", null, [this.caseField, Zn(e, "match case")]), ct("label", null, [this.reField, Zn(e, "regexp")]), ct("label", null, [this.wordField, Zn(e, "by word")]), ...e.state.readOnly ? [] : [ct("br"), this.replaceField, i("replace", () => im(e), [Zn(e, "replace")]), i("replaceAll", () => PA(e), [Zn(e, "replace all")])], ct("button", { name: "close", onclick: () => pb(e), "aria-label": Zn(e, "close"), type: "button" }, ["\xD7"])]);
  }
  commit() {
    let e = new Dd({ search: this.searchField.value, caseSensitive: this.caseField.checked, regexp: this.reField.checked, wholeWord: this.wordField.checked, replace: this.replaceField.value });
    e.eq(this.query) || (this.query = e, this.view.dispatch({ effects: ts.of(e) }));
  }
  keydown(e) {
    vs(this.view, e, "search-panel") ? e.preventDefault() : e.keyCode == 13 && e.target == this.searchField ? (e.preventDefault(), (e.shiftKey ? Kc : zc)(this.view)) : e.keyCode == 13 && e.target == this.replaceField && (e.preventDefault(), im(this.view));
  }
  update(e) {
...
const qa = 30, Ua = /[\s\.,:;?!]/;
function Bd(n, { from: e, to: t }) {
  let i = n.state.doc.lineAt(e), r = n.state.doc.lineAt(t).to, s = Math.max(i.from, e - qa), o = Math.min(r, t + qa), l = n.state.sliceDoc(s, o);
  if (s != i.from) {
    for (let a = 0; a < qa; a++) if (!Ua.test(l[a + 1]) && Ua.test(l[a])) {
      l = l.slice(a);
      break;
    }
  }
  if (o != r) {
    for (let a = l.length - 1; a > l.length - qa; a--) if (!Ua.test(l[a - 1]) && Ua.test(l[a])) {
      l = l.slice(0, a);
      break;
    }
  }
...
const NA = he.baseTheme({ ".cm-panel.cm-search": { padding: "2px 6px 4px", position: "relative", "& [name=close]": { position: "absolute", top: "0", right: "4px", backgroundColor: "inherit", border: "none", font: "inherit", padding: 0, margin: 0 }, "& input, & button, & label": { margin: ".2em .6em .2em 0" }, "& input[type=checkbox]": { marginRight: ".2em" }, "& label": { fontSize: "80%", whiteSpace: "pre" } }, "&light .cm-searchMatch": { backgroundColor: "#ffff0054" }, "&dark .cm-searchMatch": { backgroundColor: "#00ffff8a" }, "&light .cm-searchMatch-selected": { backgroundColor: "#ff6a0054" }, "&dark .cm-searchMatch-selected": { backgroundColor: "#ff00ff8a" } }), FA = [Gr, os.low(LA), NA];
class gb {
  constructor(e, t, i, r) {
  ...
  matchBefore(e) {
    let t = this.state.doc.lineAt(this.pos), i = Math.max(t.from, this.pos - 250), r = t.text.slice(i - t.from, this.pos - t.from), s = r.search(mb(e, false));
...
function VA(n) {
  let e = n.map((r) => typeof r == "string" ? { label: r } : r), [t, i] = e.every((r) => /^\w+$/.test(r.label)) ? [/\w*$/, /\w+$/] : HA(e);
  return (r) => {
...
function $A(n) {
  ...
  let e = om.get(n);
  return e || om.set(n, e = VA(n)), e;
}
const jc = _e.define(), Jl = _e.define();
class zA {
  constructor(e) {
  ...
  match(e) {
    ...
    for (let R = 0, N = Math.min(e.length, 200), B = 0; R < N && p < a; ) {
      ...
      let H, K = W < 255 ? W >= 48 && W <= 57 || W >= 97 && W <= 122 ? 2 : W >= 65 && W <= 90 ? 1 : 0 : (H = rd(W)) != H.toLowerCase() ? 1 : H != H.toUpperCase() ? 2 : 0;
...
const en = be.define({ combine(n) {
  return Or(n, { activateOnTyping: true, activateOnCompletion: () => false, activateOnTypingDelay: 100, selectOnOpen: true, override: null, closeOnBlur: true, maxRenderedOptions: 100, defaultKeymap: true, tooltipClass: () => "", optionClass: () => "", aboveCursor: false, icons: true, addToOptions: [], positionInfo: jA, filterStrict: false, compareCompletions: (e, t) => e.label.localeCompare(t.label), interactionDelay: 75, updateSyncTime: 100 }, { defaultKeymap: (e, t) => e && t, closeOnBlur: (e, t) => e && t, icons: (e, t) => e && t, tooltipClass: (e, t) => (i) => lm(e(i), t(i)), optionClass: (e, t) => (i) => lm(e(i), t(i)), addToOptions: (e, t) => e.concat(t), filterStrict: (e, t) => e || t });
} });
function lm(n, e) {
  return n ? e ? n + " " + e : n : e;
}
...
class UA {
  constructor(e, t, i) {
    ...
    this.optionContent = qA(l), this.optionClass = l.optionClass, this.tooltipClass = l.tooltipClass, this.range = sh(s.length, o, l.maxRenderedOptions), this.dom = document.createElement("div"), this.dom.className = "cm-tooltip-autocomplete", this.updateTooltipClass(e.state), this.dom.addEventListener("mousedown", (a) => {
  ...
  update(e) {
    ...
    if (this.updateTooltipClass(e.state), i != r) {
      ...
      (!r.open || r.open.options != s) && (this.range = sh(s.length, o, e.state.facet(en).maxRenderedOptions), this.showOptions(s, i.id)), this.updateSel(), l != ((t = r.open) === null || t === void 0 ? void 0 : t.disabled) && this.dom.classList.toggle("cm-tooltip-autocomplete-disabled", !!l);
    }
  }
  ...
  updateSel() {
    ...
    if ((t.selected > -1 && t.selected < this.range.from || t.selected >= this.range.to) && (this.range = sh(t.options.length, t.selected, this.view.state.facet(en).maxRenderedOptions), this.showOptions(t.options, e.id)), this.updateSelectedOption(t.selected)) {
      this.destroyInfo();
...
function JA(n, e) {
  ...
  for (let h of n) if (h.hasResult()) {
    ...
    if (h.result.filter === false) for (let m of h.result.options) s(new sm(m, h.source, p ? p(m) : [], 1e9 - t.length));
    else {
      let m = e.sliceDoc(h.from, h.to), b, S = o.filterStrict ? new KA(m) : new zA(m);
      for (let M of h.result.options) if (b = S.match(M.label)) {
        let A = M.displayLabel ? p ? p(M, b.matched) : [] : b.matched, _ = b.score + (M.boost || 0);
        if (s(new sm(M, h.source, A, _)), typeof M.section == "object" && M.section.rank === "dynamic") {
  ...
  for (let h of t.sort((p, m) => m.score - p.score || f(p.completion, m.completion))) {
    let p = h.completion;
    !a || a.label != p.label || a.detail != p.detail || a.type != null && p.type != null && a.type != p.type || a.apply != p.apply || a.boost != p.boost ? l.push(h) : am(h.completion) > am(a) && (l[l.length - 1] = h), a = h.completion;
  }
  return l;
}
class co {
  ...
  setSelected(e, t) {
    return e == this.selected || e >= this.options.length ? this : new co(this.options, cm(t, e), this.tooltip, this.timestamp, e, this.disabled);
  }
  static build(e, t, i, r, s, o) {
    ...
    return new co(l, cm(i, a), { pos: e.reduce((f, h) => h.hasResult() ? Math.min(f, h.from) : f, 1e8), create: nT, above: s.aboveCursor }, r ? r.timestamp : Date.now(), a, false);
  }
  map(e) {
    return new co(this.options, this.attrs, { ...this.tooltip, pos: e.mapPos(this.tooltip.pos) }, this.timestamp, this.selected, this.disabled);
  }
  setDisabled() {
    return new co(this.options, this.attrs, this.tooltip, this.timestamp, this.selected, true);
  }
}
class qc {
  constructor(e, t, i) {
  ...
  static start() {
    return new qc(eT, "cm-ac-" + Math.floor(Math.random() * 2e6).toString(36), null);
  }
  update(e) {
    let { state: t } = e, i = t.facet(en), s = (i.override || t.languageDataAt("autocomplete", _s(t)).map($A)).map((a) => (this.active.find((h) => h.source == a) || new mi(a, this.active.some((h) => h.state != 0) ? 1 : 0)).update(e, i));
    s.length == this.active.length && s.every((a, f) => a == this.active[f]) && (s = this.active);
    let o = this.open, l = e.effects.some((a) => a.is(Id));
    o && e.docChanged && (o = o.map(e.changes)), e.selection || s.some((a) => a.hasResult() && e.changes.touchesRange(a.from, a.to)) || !QA(s, this.active) || l ? o = co.build(s, t, this.id, o, i, l) : o && o.disabled && !s.some((a) => a.isPending) && (o = null), !o && s.every((a) => !a.isPending) && s.some((a) => a.hasResult()) && (s = s.map((a) => a.hasResult() ? new mi(a.source, 0) : a));
    for (let a of e.effects) a.is(bb) && (o = o && o.setSelected(a.value, this.id));
  ...
  get attrs() {
    return this.open ? this.open.attrs : this.active.length ? XA : ZA;
  }
}
function QA(n, e) {
  if (n == e) return true;
...
const XA = { "aria-autocomplete": "list" }, ZA = {};
function cm(n, e) {
...
class mi {
  ...
  update(e, t) {
    ...
    for (let s of e.effects) if (s.is(jc)) r = new mi(r.source, 1, s.value);
    else if (s.is(Jl)) r = new mi(r.source, 0);
    else if (s.is(Id)) for (let o of s.value) o.source == r.source && (r = o);
    return r;
  }
  updateFor(e, t) {
...
class go extends mi {
  ...
  updateFor(e, t) {
    ...
    return tT(r.validFor, e.state, s, o) ? new go(this.source, this.explicit, a, r, s, o) : r.update && (r = r.update(r, s, o, new gb(e.state, l, false))) ? new go(this.source, this.explicit, a, r, r.from, (i = r.to) !== null && i !== void 0 ? i : _s(e.state)) : new mi(this.source, 1, this.explicit);
  }
  map(e) {
    return e.empty ? this : (this.result.map ? this.result.map(this.result, e) : this.result) ? new go(this.source, this.explicit, e.mapPos(this.limit), this.result, e.mapPos(this.from), e.mapPos(this.to, 1)) : new mi(this.source, 0);
  }
  touches(e) {
...
function tT(n, e, t, i) {
  ...
  return typeof n == "function" ? n(r, t, i, e) : mb(n, true).test(r);
}
const Id = _e.define({ map(n, e) {
  return n.map((t) => t.map(e));
} }), bb = _e.define(), zn = Yt.define({ create() {
  return qc.start();
}, update(n, e) {
  return n.update(e);
}, provide: (n) => [rf.from(n, (e) => e.tooltip), he.contentAttributes.from(n, (e) => e.attrs)] });
function Nd(n, e) {
  const t = e.completion.apply || e.completion.label;
  let i = n.state.field(zn).active.find((r) => r.source == e.source);
  return i instanceof go ? (typeof t == "string" ? n.dispatch({ ...WA(n.state, t, i.from, i.to), annotations: yb.of(e.completion) }) : t(n, e.completion, i.from, i.to), true) : false;
}
const nT = GA(zn, Nd);
function Ga(n, e = "option") {
  return (t) => {
    ...
    let r = 1, s;
    e == "page" && (s = sv(t, i.open.tooltip)) && (r = Math.max(2, Math.floor(s.dom.offsetHeight / s.dom.querySelector("li").offsetHeight) - 1));
    let { length: o } = i.open.options, l = i.open.selected > -1 ? i.open.selected + r * (n ? 1 : -1) : n ? 0 : o - 1;
    return l < 0 ? l = e == "page" ? 0 : o - 1 : l >= o && (l = e == "page" ? o - 1 : 0), t.dispatch({ effects: bb.of(l) }), true;
  };
}
const iT = (n) => {
  let e = n.state.field(zn, false);
  return n.state.readOnly || !e || !e.open || e.open.selected < 0 || e.open.disabled || Date.now() - e.open.timestamp < n.state.facet(en).interactionDelay ? false : Nd(n, e.open.options[e.open.selected]);
}, oh = (n) => n.state.field(zn, false) ? (n.dispatch({ effects: jc.of(true) }), true) : false, rT = (n) => {
  let e = n.state.field(zn, false);
...
const oT = 50, lT = 1e3, aT = kt.fromClass(class {
  constructor(n) {
  ...
  update(n) {
    ...
    for (let s = 0; s < this.running.length; s++) {
      ...
      if (i || o.context.abortOnDocChange && n.docChanged || o.updates.length + n.transactions.length > oT && Date.now() - o.time > lT) {
  ...
  startQuery(n) {
    let { state: e } = this.view, t = _s(e), i = new gb(e, t, n.explicit, this.view), r = new sT(n, i);
  ...
  accept() {
    ...
    for (let r = 0; r < this.running.length; r++) {
      ...
      if (this.running.splice(r--, 1), s.done) {
        let l = _s(s.updates.length ? s.updates[0].startState : this.view.state), a = Math.min(l, s.done.from + (s.active.explicit ? 0 : 1)), f = new go(s.active.source, s.active.explicit, a, s.done, s.done.from, (n = s.done.to) !== null && n !== void 0 ? n : l);
...
} } }), cT = typeof navigator == "object" && /Win/.test(navigator.platform), fT = os.highest(he.domEventHandlers({ keydown(n, e) {
  let t = e.state.field(zn, false);
  if (!t || !t.open || t.open.disabled || t.open.selected < 0 || n.key.length > 1 || n.ctrlKey && !(cT && n.altKey) || n.metaKey) return false;
...
const wb = Yt.define({ create() {
  ...
  for (let t of e.effects) t.is(Ts) && (n = n.update({ add: [Fd.range(t.value, t.value + 1)] }));
  return n;
} });
function uT() {
  return [pT, wb];
}
const lh = "()[]{}<>\xAB\xBB\xBB\xAB\uFF3B\uFF3D\uFF5B\uFF5D";
function xb(n) {
  for (let e = 0; e < lh.length; e += 2) if (lh.charCodeAt(e) == n) return lh.charAt(e + 1);
  return rd(n < 128 ? n : n + 1);
}
function Sb(n, e) {
  return n.languageDataAt("closeBrackets", e)[0] || Ql;
}
const dT = typeof navigator == "object" && /Android\b/.test(navigator.userAgent), pT = he.inputHandler.of((n, e, t, i) => {
  if ((dT ? n.composing : n.compositionStarted) || n.state.readOnly) return false;
  let r = n.state.selection.main;
  if (i.length > 2 || i.length == 2 && sr($n(i, 0)) == 1 || e != r.from || t != r.to) return false;
  let s = yT(n.state, i);
  return s ? (n.dispatch(s), true) : false;
}), gT = ({ state: n, dispatch: e }) => {
  if (n.readOnly) return false;
  let i = Sb(n, n.selection.main.head).brackets || Ql.brackets, r = null, s = n.changeByRange((o) => {
    if (o.empty) {
      let l = vT(n.doc, o.head);
      for (let a of i) if (a == l && uf(n.doc, o.head) == xb($n(a, 0))) return { changes: { from: o.head - a.length, to: o.head + a.length }, range: j.cursor(o.head - a.length) };
    }
    return { range: r = o };
  });
  return r || e(n.update(s, { scrollIntoView: true, userEvent: "delete.backward" })), !r;
}, mT = [{ key: "Backspace", run: gT }];
function yT(n, e) {
  let t = Sb(n, n.selection.main.head), i = t.brackets || Ql.brackets;
  for (let r of i) {
    let s = xb($n(r, 0));
    if (e == r) return s == r ? xT(n, r, i.indexOf(r + r + r) > -1, t) : bT(n, r, s, t.before || Ql.before);
    if (e == s && kb(n, n.selection.main.from)) return wT(n, r, s);
  }
  return null;
}
function kb(n, e) {
  let t = false;
  return n.field(wb).between(0, n.doc.length, (i) => {
    i == e && (t = true);
  }), t;
}
function uf(n, e) {
...
function wT(n, e, t) {
  let i = null, r = n.changeByRange((s) => s.empty && uf(n.doc, s.head) == t ? { changes: { from: s.head, to: s.head + t.length, insert: t }, range: j.cursor(s.head + t.length) } : i = { range: s });
...
function xT(n, e, t, i) {
  let r = i.stringPrefixes || Ql.stringPrefixes, s = null, o = n.changeByRange((l) => {
    ...
    let a = l.head, f = uf(n.doc, a), h;
    if (f == e) {
      if (fm(n, a)) return { changes: { insert: e + e, from: a }, effects: Ts.of(a + e.length), range: j.cursor(a + e.length) };
      if (kb(n, a)) {
        let m = t && n.sliceDoc(a, a + e.length * 3) == e + e + e ? e + e + e : e;
        return { changes: { from: a, to: a + m.length, insert: m }, range: j.cursor(a + m.length) };
      }
    } else {
      if (t && n.sliceDoc(a - 2 * e.length, a) == e + e && (h = hm(n, a - 2 * e.length, r)) > -1 && fm(n, h)) return { changes: { insert: e + e + e + e, from: a }, effects: Ts.of(a + e.length), range: j.cursor(a + e.length) };
      if (n.charCategorizer(a)(f) != St.Word && hm(n, a, r) > -1 && !ST(n, a, e, r)) return { changes: { insert: e + e, from: a }, effects: Ts.of(a + e.length), range: j.cursor(a + e.length) };
    }
    return { range: s = l };
  });
...
function Hd(n = {}) {
  return [fT, zn, en.of(n), aT, kT, hT];
}
const Cb = [{ key: "Ctrl-Space", run: oh }, { mac: "Alt-`", run: oh }, { mac: "Alt-i", run: oh }, { key: "Escape", run: rT }, { key: "ArrowDown", run: Ga(true) }, { key: "ArrowUp", run: Ga(false) }, { key: "PageDown", run: Ga(true, "page") }, { key: "PageUp", run: Ga(false, "page") }, { key: "Enter", run: iT }], kT = os.highest(yd.computeN([en], (n) => n.facet(en).defaultKeymap ? [Cb] : []));
class um {
  constructor(e, t, i) {
...
class Cs {
  ...
  static init(e, t, i) {
    ...
    for (let h = 0; ; ) {
      ...
      let S = HT(l);
      if (l.some((M) => M.from == M.to || M.from == M.to - 1 && i.doc.lineAt(M.from).to == M.from)) o.add(m, m, ve.widget({ widget: new BT(S), diagnostics: l.slice() }));
      else {
    ...
    let f = o.finish();
    return new Cs(f, t, Mo(f));
  }
}
function Mo(n, e = null, t = 0) {
  let i = null;
  return n.between(t, 1e9, (r, s, { spec: o }) => {
    if (!(e && o.diagnostics.indexOf(e) < 0)) if (!i) i = new um(r, s, e || o.diagnostics[0]);
    else {
      if (o.diagnostics.indexOf(i.diagnostic) < 0) return false;
      i = new um(i.from, s, i.diagnostic);
    }
  }), i;
}
function CT(n, e) {
  ...
  return !!(n.effects.some((o) => o.is(Vd)) || n.changes.touchesRange(s.from, Math.max(s.to, i)));
}
function Mb(n, e) {
  return n.field(ii, false) ? e : e.concat(_e.appendConfig.of(Ob));
}
function MT(n, e) {
  return { effects: Mb(n, [Vd.of(e)]) };
}
const Vd = _e.define(), Wd = _e.define(), Ab = _e.define(), ii = Yt.define({ create() {
  ...
  if (e.docChanged && n.diagnostics.size) {
    ...
    if (n.selected) {
      ...
      i = Mo(t, n.selected.diagnostic, s) || Mo(t, null, s);
    }
    !t.size && r && e.state.facet(ar).autoPanel && (r = null), n = new Cs(t, r, i);
  }
  for (let t of e.effects) if (t.is(Vd)) {
    let i = e.state.facet(ar).autoPanel ? t.value.length ? Xl.open : null : n.panel;
    n = Cs.init(t.value, i, e.state);
  } else t.is(Wd) ? n = new Cs(n.diagnostics, t.value ? Xl.open : null, n.selected) : t.is(Ab) && (n = new Cs(n.diagnostics, n.panel, t.value));
  return n;
}, provide: (n) => [Vs.from(n, (e) => e.panel), he.decorations.from(n, (e) => e.diagnostics)] }), AT = ve.mark({ class: "cm-lintRange cm-lintRange-active" });
function TT(n, e, t) {
...
function ET(n, e) {
  return ct("ul", { class: "cm-tooltip-lint" }, e.map((t) => Eb(n, t, false)));
}
const OT = (n) => {
  let e = n.state.field(ii, false);
  (!e || !e.panel) && n.dispatch({ effects: Mb(n.state, [Wd.of(true)]) });
  let t = ql(n, Xl.open);
  return t && t.dom.querySelector(".cm-panel-lint ul").focus(), true;
}, dm = (n) => {
  let e = n.state.field(ii, false);
  return !e || !e.panel ? false : (n.dispatch({ effects: Wd.of(false) }), true);
}, _T = (n) => {
  let e = n.state.field(ii, false);
  if (!e) return false;
...
}, LT = [{ key: "Mod-Shift-m", run: OT, preventDefault: true }, { key: "F8", run: _T }], DT = kt.fromClass(class {
  constructor(n) {
  ...
  run() {
    ...
    if (n < this.lintTime - 10) this.timeout = setTimeout(this.run, this.lintTime - n);
      ...
      t.length && RT(t.map((i) => Promise.resolve(i(this.view))), (i) => {
        this.view.state.doc == e.doc && this.view.dispatch(MT(this.view.state, i.reduce((r, s) => r.concat(s))));
      }, (i) => {
...
const ar = be.define({ combine(n) {
  return { sources: n.map((e) => e.source).filter((e) => e != null), ...Or(n.map((e) => e.config), { delay: 750, markerFilter: null, tooltipFilter: null, needsRefresh: null, hideOn: () => null }, { delay: Math.max, markerFilter: pm, tooltipFilter: pm, needsRefresh: (e, t) => e ? t ? (i) => e(i) || t(i) : e : t, hideOn: (e, t) => e ? t ? (i, r, s) => e(i, r, s) || t(i, r, s) : e : t, autoPanel: (e, t) => e || t }) };
} });
function pm(n, e) {
  return n ? e ? (t, i) => e(n(t, i), i) : n : e;
}
function PT(n, e = {}) {
  return [ar.of({ source: n, config: e }), DT, Ob];
}
function Tb(n) {
  let e = [];
...
function Eb(n, e, t) {
  ...
  return ct("li", { class: "cm-diagnostic cm-diagnostic-" + e.severity }, ct("span", { class: "cm-diagnosticText" }, e.renderMessage ? e.renderMessage(n) : e.message), (i = e.actions) === null || i === void 0 ? void 0 : i.map((s, o) => {
    let l = false, a = (b) => {
      ...
      l = true;
      let S = Mo(n.state.field(ii).diagnostics, e);
...
class gm {
  constructor(e, t) {
    this.diagnostic = t, this.id = "item_" + Math.floor(Math.random() * 4294967295).toString(16), this.dom = Eb(e, t, true), this.dom.id = this.id, this.dom.setAttribute("role", "option");
  }
}
class Xl {
  constructor(e) {
    ...
    let t = (r) => {
      if (r.keyCode == 27) dm(this.view), this.view.focus();
        ...
        let { diagnostic: s } = this.items[this.selectedIndex], o = Tb(s.actions);
        for (let l = 0; l < o.length; l++) if (o[l].toUpperCase().charCodeAt(0) == r.keyCode) {
          let a = Mo(this.view.state.field(ii).diagnostics, s);
    ...
    this.list = ct("ul", { tabIndex: 0, role: "listbox", "aria-label": this.view.state.phrase("Diagnostics"), onkeydown: t, onclick: i }), this.dom = ct("div", { class: "cm-panel-lint" }, this.list, ct("button", { type: "button", name: "close", "aria-label": this.view.state.phrase("close"), onclick: () => dm(this.view) }, "\xD7")), this.update();
  }
  get selectedIndex() {
  ...
  update() {
    ...
    for (e.between(0, this.view.state.doc.length, (l, a, { spec: f }) => {
      for (let h of f.diagnostics) {
        ...
        p < 0 ? (m = new gm(this.view, h), this.items.splice(i, 0, m), r = true) : (m = this.items[p], p > i && (this.items.splice(i, p - i), r = true)), t && m.diagnostic == t.diagnostic ? m.dom.hasAttribute("aria-selected") || (m.dom.setAttribute("aria-selected", "true"), s = m) : m.dom.hasAttribute("aria-selected") && m.dom.removeAttribute("aria-selected"), i++;
      }
    }); i < this.items.length && !(this.items.length == 1 && this.items[0].diagnostic.from < 0); ) r = true, this.items.pop();
    this.items.length == 0 && (this.items.push(new gm(this.view, { from: -1, to: -1, severity: "info", message: this.view.state.phrase("No diagnostics") })), r = true), s ? (this.list.setAttribute("aria-activedescendant", s.id), this.view.requestMeasure({ key: this, read: () => ({ sel: s.dom.getBoundingClientRect(), panel: this.list.getBoundingClientRect() }), write: ({ sel: l, panel: a }) => {
...
const Ob = [ii, he.decorations.compute([ii], (n) => {
  let { selected: e, panel: t } = n.field(ii);
  return !e || !t || e.from == e.to ? ve.none : ve.set([AT.range(e.from, e.to)]);
}), rv(TT, { hideOn: CT }), NT], VT = "#e5c07b", mm = "#e06c75", WT = "#56b6c2", $T = "#ffffff", gc = "#abb2bf", Cu = "#7d8799", zT = "#61afef", KT = "#98c379", ym = "#d19a66", jT = "#c678dd", qT = "#21252b", vm = "#2c313a", bm = "#282c34", ah = "#353a42", UT = "#3E4451", wm = "#528bff", GT = he.theme({ "&": { color: gc, backgroundColor: bm }, ".cm-content": { caretColor: wm }, ".cm-cursor, .cm-dropCursor": { borderLeftColor: wm }, "&.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection": { backgroundColor: UT }, ".cm-panels": { backgroundColor: qT, color: gc }, ".cm-panels.cm-panels-top": { borderBottom: "2px solid black" }, ".cm-panels.cm-panels-bottom": { borderTop: "2px solid black" }, ".cm-searchMatch": { backgroundColor: "#72a1ff59", outline: "1px solid #457dff" }, ".cm-searchMatch.cm-searchMatch-selected": { backgroundColor: "#6199ff2f" }, ".cm-activeLine": { backgroundColor: "#6699ff0b" }, ".cm-selectionMatch": { backgroundColor: "#aafe661a" }, "&.cm-focused .cm-matchingBracket, &.cm-focused .cm-nonmatchingBracket": { backgroundColor: "#bad0f847" }, ".cm-gutters": { backgroundColor: bm, color: Cu, border: "none" }, ".cm-activeLineGutter": { backgroundColor: vm }, ".cm-foldPlaceholder": { backgroundColor: "transparent", border: "none", color: "#ddd" }, ".cm-tooltip": { border: "none", backgroundColor: ah }, ".cm-tooltip .cm-tooltip-arrow:before": { borderTopColor: "transparent", borderBottomColor: "transparent" }, ".cm-tooltip .cm-tooltip-arrow:after": { borderTopColor: ah, borderBottomColor: ah }, ".cm-tooltip-autocomplete": { "& > ul > li[aria-selected]": { backgroundColor: vm, color: gc } } }, { dark: true }), YT = oa.define([{ tag: U.keyword, color: jT }, { tag: [U.name, U.deleted, U.character, U.propertyName, U.macroName], color: mm }, { tag: [U.function(U.variableName), U.labelName], color: zT }, { tag: [U.color, U.constant(U.name), U.standard(U.name)], color: ym }, { tag: [U.definition(U.name), U.separator], color: gc }, { tag: [U.typeName, U.className, U.number, U.changed, U.annotation, U.modifier, U.self, U.namespace], color: VT }, { tag: [U.operator, U.operatorKeyword, U.url, U.escape, U.regexp, U.link, U.special(U.string)], color: WT }, { tag: [U.meta, U.comment], color: Cu }, { tag: U.strong, fontWeight: "bold" }, { tag: U.emphasis, fontStyle: "italic" }, { tag: U.strikethrough, textDecoration: "line-through" }, { tag: U.link, color: Cu, textDecoration: "underline" }, { tag: U.heading, fontWeight: "bold", color: mm }, { tag: [U.atom, U.bool, U.special(U.variableName)], color: ym }, { tag: [U.processingInstruction, U.string, U.inserted], color: KT }, { tag: U.invalid, color: $T }]), JT = [GT, Mv(YT)];
function QT(n) {
  var e = n.Pos;
  function t(c, u, d) {
  ...
  var se = function() {
    ...
    function v(T, D, L) {
      ...
      function $(Y) {
        var X = ++u % c, we = y[X];
        we && we.clear(), y[X] = T.setBookmark(Y);
      }
      if (V) {
        var I = V.find();
        I && !tn(I, D) && $(D);
  ...
  var Le, ye = { enterVimMode: a, leaveVimMode: f, buildKeyMap: function() {
    ...
    if (i = i.slice(u - d), c) for (var y = g.length - 1; y >= 0; y--) {
      ...
      if (c !== v.context) if (v.context) this._mapCommand(v);
        ...
        for (var C in k) if (k[C] !== c) {
          ...
          T.context = k[C], this._mapCommand(T);
        }
      }
    }
    ...
    Sa[c] = d, Lt.commandMap_[u] = { name: c, shortName: u, type: "api" };
...
`) == -1 ? this.registers["-"] = new hn(g, y) : (this.shiftNumericRegisters_(), this.registers[1] = new hn(g, y));
  ...
  var Fn = { matchCommand: function(c, u, d, g) {
    ...
    Tn(c).setReversed(!g);
    var v = g ? "/" : "?", k = Tn(c).getQuery(), C = c.getScrollInfo(), T = "";
    function D(ce, Ce, Ee) {
    ...
    function V(ce, Ce, Ee) {
      var Pe = fn(ce), st, yt;
      Pe == "<Up>" || Pe == "<Down>" ? (st = Pe == "<Up>", yt = ce.target ? ce.target.selectionEnd : 0, Ce = te.searchHistoryController.nextMatch(Ce, st) || "", Ee(Ce), yt && ce.target && (ce.target.selectionEnd = ce.target.selectionStart = Math.min(yt, ce.target.value.length))) : Pe && Pe != "<Left>" && Pe != "<Right>" && te.searchHistoryController.reset(), T = Ce, $();
    }
    function $() {
      var ce;
      try {
    ...
    function I(ce, Ce, Ee) {
      var Pe = fn(ce);
      Pe == "<Esc>" || Pe == "<C-c>" || Pe == "<C-[>" || Pe == "<BS>" && Ce == "" ? (te.searchHistoryController.pushInput(Ce), te.searchHistoryController.reset(), mr(c, (k == null ? void 0 : k.source) || ""), Br(c), c.scrollTo(C.left, C.top), n.e_stop(ce), mt(c), Ee(), c.focus()) : Pe == "<Up>" || Pe == "<Down>" ? n.e_stop(ce) : Pe == "<C-u>" && (n.e_stop(ce), Ee(""));
    }
    switch (d.searchArgs.querySrc) {
      ...
      case "wordUnderCursor":
        ...
        we && y ? ce = "\\b" + ce + "\\b" : ce = Ef(ce), te.jumpList.cachedCursor = c.getCursor(), c.setCursor(X.start), D(ce, true, false);
        break;
    }
    ...
    function y(C, T, D) {
      var L = fn(C), F, V;
      (L == "<Esc>" || L == "<C-c>" || L == "<C-[>" || L == "<BS>" && T == "") && (te.exCommandHistoryController.pushInput(T), te.exCommandHistoryController.reset(), n.e_stop(C), mt(c), Br(c), D(), c.focus()), L == "<Up>" || L == "<Down>" ? (n.e_stop(C), F = L == "<Up>", V = C.target ? C.target.selectionEnd : 0, T = te.exCommandHistoryController.nextMatch(T, F) || "", D(T), V && C.target && (C.target.selectionEnd = C.target.selectionStart = Math.min(V, C.target.value.length))) : L == "<C-u>" ? (n.e_stop(C), D("")) : L && L != "<Left>" && L != "<Right>" && te.exCommandHistoryController.reset();
    }
    function v(C, T) {
      var D = new n.StringStream(T), L = {};
      try {
        ...
        var V = ba(L.argString.slice(1), true, true);
        V && Xo(c, V);
      } catch {
      }
    }
    ...
    var d = u.inputState, g = d.motion, y = d.motionArgs || { repeat: 1 }, v = d.operator, k = d.operatorArgs || {}, C = d.registerName, T = u.sel, D = Ze(u.visualMode ? Ct(c, T.head) : c.getCursor("head")), L = Ze(u.visualMode ? Ct(c, T.anchor) : c.getCursor("anchor")), F = Ze(D), V = Ze(L), $, I, Y;
    if (v && this.recordLastEdit(u, d), d.repeatOverride !== void 0 ? Y = d.repeatOverride : Y = d.getRepeat(), Y > 0 && y.explicitRepeat ? y.repeatIsExplicit = true : (y.noRepeat || !y.explicitRepeat && Y === 0) && (Y = 1, y.repeatIsExplicit = false), d.selectedCharacter && (y.selectedCharacter = k.selectedCharacter = d.selectedCharacter), y.repeat = Y, mt(c), g) {
      ...
      X instanceof Array ? (I = X[0], $ = X[1]) : $ = X, $ || ($ = Ze(D)), u.visualMode ? (u.visualBlock && $.ch === 1 / 0 || ($ = Ct(c, $, F)), I && (I = Ct(c, I)), I = I || V, T.anchor = I, T.head = $, qn(c), An(c, u, "<", tt(I, $) ? I : $), An(c, u, ">", tt(I, $) ? $ : I)) : v || ($ = Ct(c, $, F), c.setCursor($.line, $.ch));
    }
    if (v) {
      if (k.lastSel) {
        I = V;
        var Ce = k.lastSel, Ee = Math.abs(Ce.head.line - Ce.anchor.line), Pe = Math.abs(Ce.head.ch - Ce.anchor.ch);
        Ce.visualLine ? $ = new e(V.line + Ee, V.ch) : Ce.visualBlock ? $ = new e(V.line + Ee, V.ch + Pe) : Ce.head.line == Ce.anchor.line ? $ = new e(V.line, V.ch + Pe) : $ = new e(V.line + Ee, V.ch), u.visualMode = true, u.visualLine = Ce.visualLine, u.visualBlock = Ce.visualBlock, T = u.sel = { anchor: I, head: $ }, qn(c);
      } else u.visualMode && (k.lastSel = { anchor: Ze(T.anchor), head: Ze(T.head), visualBlock: u.visualBlock, visualLine: u.visualLine });
      var st, yt, Be, Se, je;
      if (u.visualMode) {
        st = Mt(T.head, T.anchor), yt = jn(T.head, T.anchor), Be = u.visualLine || k.linewise, Se = u.visualBlock ? "block" : Be ? "line" : "char";
        var En = t(c, st, yt);
        if (je = Wi(c, { anchor: En.start, head: En.end }, Se), Be) {
          var Dt = je.ranges;
        ...
        Be = y.linewise || k.linewise, Be ? ga(c, st, yt) : y.forward && Dr(c, st, yt), Se = "char";
        var Ma = !y.inclusive || Be, En = t(c, st, yt);
        je = Wi(c, { anchor: En.start, head: En.end }, Se, Ma);
      }
    ...
    var v = Tn(c), k = v.getQuery();
    if (k) {
      var C = !d.forward;
      C = v.isReversed() ? !C : C;
      var T = Rf(c, C, k, d.repeat, g);
      if (T) {
        if (y.operator) return T;
        var D = T[0], L = new e(T[1].line, T[1].ch - 1);
        if (g.visualMode) {
    ...
    for (var y = u, v = 0; v < d.repeat; v++) {
      ...
      for (var C in g.marks) if (N(C)) {
        var T = g.marks[C].find(), D = d.forward ? tt(T, k) : tt(k, T);
        if (!D && !(d.linewise && T.line == k.line)) {
          var L = tn(k, y), F = d.forward ? Mn(k, T, y) : Mn(y, T, k);
          (L || F) && (y = T);
        }
      }
    }
    ...
    var k = d.repeat + (d.repeatOffset || 0), C = d.forward ? y.line + k : y.line - k, T = c.firstLine(), D = c.lastLine(), L = c.findPosV(y, d.forward ? k : -k, "line", g.lastHSPos), F = d.forward ? L.line > C : L.line < C;
    return F && (C = L.line, v = L.ch), C < T && y.line == T ? this.moveToStartOfLine(c, u, d, g) : C > D && y.line == D ? _t(c, u, d, g, true) : (d.toFirstChar && (v = Un(c.getLine(C)), g.lastHPos = v), g.lastHSPos = c.charCoords(new e(C, v), "div").left, new e(C, v));
    ...
    if (k.hitSide) if (d.forward) {
      var C = c.charCoords(k, "div"), T = { top: C.top + 8, left: g.lastHSPos };
      k = c.coordsChar(T, "div");
    } else {
    ...
    var T = c.charCoords(v, "local");
    return c.scrollTo(null, y.top + T.top - C.top), v;
    ...
    return ma(v, d), y ? (y.ch += v, y) : null;
  }, moveToCharacter: function(c, u, d) {
    var g = d.repeat;
    return ma(0, d), Rr(c, g, d.forward, d.selectedCharacter, u) || u;
    ...
    if (y < v.length) {
      var T = k === "<" || k === ">" ? /[(){}[\]<>]/ : /[(){}[\]]/, D = c.findMatchingBracket(new e(g, y), { bracketRegex: T });
      return D.to;
    } else return d;
    ...
    k == "b" ? k = "(" : k == "B" && (k = "{");
    var C = !d.textObjectInner, T, D;
    if (y[k]) {
      if (D = true, T = Ys(c, u, k, C), !T) {
        var L = c.getSearchCursor(new RegExp("\\" + k, "g"), u);
        L.find() && (T = Ys(c, L.from(), k, C));
      }
    } else if (v[k]) D = true, T = jo(c, u, k, C);
    else if (k === "W" || k === "w") for (var F = d.repeat || 1; F-- > 0; ) {
      var V = zo(c, { inclusive: C, innerWord: !C, bigWord: k === "W", noSymbol: k === "W", multiline: true }, T && T.end);
      V && (T || (T = V), T.end = V.end);
    }
    else if (k === "p") if (T = Gs(c, u, d.repeat, 0, C), d.linewise = true, g.visualMode) g.visualLine || (g.visualLine = true);
    else {
      var $ = g.inputState.operatorArgs;
      $ && ($.linewise = true), T.end.line--;
    }
    else if (k === "t") T = Lf(c, u, C);
    else if (k === "s") {
      var I = c.getLine(u.line);
      u.ch > 0 && ee(I[u.ch]) && (u.ch -= 1);
      var Y = fs(c, u, d.repeat, 1, C), X = fs(c, u, d.repeat, -1, C);
      K(c.getLine(X.line)[X.ch]) && K(c.getLine(Y.line)[Y.ch - 1]) && (X = { line: X.line, ch: X.ch + 1 }), T = { start: X, end: Y };
    }
    return T ? c.state.vim.visualMode ? li(c, T.start, T.end, D) : [T.start, T.end] : null;
  ...
  var de = { change: function(c, u, d) {
    ...
    if (v.visualMode) if (u.fullLine) C.ch = Number.MAX_VALUE, C.line--, c.setSelection(k, C), y = c.getSelection(), c.replaceSelection(""), g = k;
      ...
      y = c.getRange(k, C);
      var T = v.lastEditInputState;
      if ((T == null ? void 0 : T.motion) == "moveByWords" && !K(y)) {
        var D = /\s+$/.exec(y);
        D && T.motionArgs && T.motionArgs.forward && (C = it(C, 0, -D[0].length), y = y.slice(0, -D[0].length));
      }
    ...
    if (v.visualBlock) {
      y = c.getSelection();
      var T = Re("", d.length);
      c.replaceSelections(T), g = Mt(d[0].head, d[0].anchor);
    } else {
    ...
    if (g.visualBlock) {
      for (var v = c.getOption("tabSize"), k = c.getOption("indentWithTabs") ? "	" : " ".repeat(v), C, T = d.length - 1; T >= 0; T--) if (C = Mt(d[T].anchor, d[T].head), u.indentRight) c.replaceRange(k.repeat(y), C, C);
      else {
      ...
      u.linewise && Y--;
      for (var T = I; T <= Y; T++) for (var F = 0; F < y; F++) c.indentLine(T, u.indentRight);
    }
    ...
    for (var v = c.getSelections(), k = [], C = u.toLower, T = 0; T < v.length; T++) {
      var D = v[T], L = "";
  ...
  var dt = { jumpListWalk: function(c, u, d) {
    ...
    if (!d.visualMode) {
      var g = u.repeat || 1, y = c.defaultTextHeight(), v = c.getScrollInfo().top, k = y * g, C = u.forward ? v + k : v - k, T = Ze(c.getCursor()), D = c.charCoords(T, "local");
      if (u.forward) C > D.top ? (T.line += (C - D.top) / y, T.line = Math.ceil(T.line), c.setCursor(T), D = c.charCoords(T, "local"), c.scrollTo(null, D.top)) : c.scrollTo(null, C);
      else {
        var L = C + c.getScrollInfo().clientHeight;
        L < D.bottom ? (T.line -= (D.bottom - L) / y, T.line = Math.floor(T.line), c.setCursor(T), D = c.charCoords(T, "local"), c.scrollTo(null, D.bottom - c.getScrollInfo().clientHeight)) : c.scrollTo(null, C);
      }
    }
    ...
    switch (u.position) {
      case "center":
        ...
        break;
      case "bottom":
        var k = new e(d, c.getLine(d).length - 1), C = c.charCoords(k, "local"), T = C.bottom - v;
        v = v - y + T;
        break;
    }
    c.scrollTo(null, v);
    ...
    if (!c.getOption("readOnly")) {
      ...
      c.setOption("disableInput", false), u && u.replace ? (c.toggleOverwrite(true), c.setOption("keyMap", "vim-replace"), n.signal(c, "vim-mode-change", { mode: "replace" })) : (c.toggleOverwrite(false), c.setOption("keyMap", "vim-insert"), n.signal(c, "vim-mode-change", { mode: "insert" })), te.macroModeState.isPlaying || (c.on("change", vr), d.insertEnd && d.insertEnd.clear(), d.insertEnd = c.setBookmark(v, { insertLeft: true }), n.on(c.getInputField(), "keydown", rt)), d.visualMode && nn(c), pa(c, v, k);
    }
    ...
    for (var C = 0, T = g.line; T < y.line; T++) {
      C = Bt(c, g.line);
      var D = "", L = 0;
      if (!u.keepSpaces) {
    ...
    if (g) {
      if (u.matchIndent) {
        var k = c.getOption("tabSize"), C = function(Dt) {
          ...
          return dn * k + Ai * 1;
        }, T = c.getLine(c.getCursor().line), D = C(T.match(/^\s*/)[0]), L = g.replace(/\n$/, ""), F = g !== L, V = C(g.match(/^\s*/)[0]), g = L.replace(/^\s*/gm, function(Dt) {
          var dn = D + (C(Dt) - V);
          if (dn < 0) return "";
...
` + g.slice(0, g.length - 1), v.ch = Bt(c, v.line)) : v.ch = 0 : v.ch += u.after ? 1 : 0;
      ...
      if (d.visualMode) {
        d.lastPastedText = g;
        var ce, Ce = gr(c), Ee = Ce[0], Pe = Ce[1], st = c.getSelection(), yt = c.listSelections(), Be = new Array(yt.length).join("1").split("1");
        d.lastSelection && (ce = d.lastSelection.headMark.find()), te.registerController.unnamedRegister.setText(st), I ? (c.replaceSelections(Be), Pe = new e(Ee.line + g.length - 1, Ee.ch), c.setCursor(Ee), da(c, Pe), c.replaceSelections(g), we = Ee) : d.visualBlock ? (c.replaceSelections(Be), c.setCursor(Ee), c.replaceRange(g, Ee, Ee), we = Ee) : (c.replaceRange(g, Ee, Pe), we = c.posFromIndex(c.indexFromPos(Ee) + g.length - 1)), ce && (d.lastSelection.headMark = c.setBookmark(ce)), $ && (we.ch = 0);
      } else if (I && Y) {
        c.setCursor(v);
...
`, new e(Se, 0));
          var je = Bt(c, Se);
          je < v.ch && Of(c, Se, v.ch);
        }
        c.setCursor(v), da(c, new e(v.line + Y.length - 1, v.ch)), c.replaceSelections(Y), we = v;
    ...
    if (d.visualMode) y = c.getCursor("start"), k = c.getCursor("end");
      ...
      var T = c.getLine(y.line);
      v = y.ch + u.repeat, v > T.length && (v = T.length), k = new e(y.line, v);
    }
    var D = t(c, y, k);
...
`);
    ...
    for (var d = c.getCursor(), g = c.getLine(d.line), y = /(-?)(?:(0x)([\da-f]+)|(0b|0|)(\d+))/gi, v, k, C, T; (v = y.exec(g)) !== null && (k = v.index, C = k + v[0].length, !(d.ch < C)); ) ;
    if (!(!u.backtrack && C <= d.ch)) {
      if (v) {
        ...
        T = $.toString(V);
        var I = D ? new Array(L.length - T.length + 1 + v[1].length).join("0") : "";
        T.charAt(0) === "-" ? T = "-" + D + I + T.substr(1) : T = D + I + T;
        var Y = new e(d.line, k), X = new e(d.line, C);
        c.replaceRange(T, Y, X);
      } else return;
      c.setCursor(new e(d.line, k + T.length - 1));
    }
  ...
  function Ct(c, u, d) {
    var g = c.state.vim, y = g.insertMode || g.visualMode, v = Math.min(Math.max(c.firstLine(), u.line), c.lastLine()), k = c.getLine(v), C = k.length - 1 + +!!y, T = Math.min(Math.max(0, u.ch), C), D = k.charCodeAt(T);
    if (56320 <= D && D <= 57343) {
      var L = 1;
      d && d.line == v && d.ch > T && (L = -1), T += L, T > C && (T -= 2);
    }
    return new e(v, T);
  }
  function kn(c) {
  ...
  function Cn(c, u, d, g) {
    ...
    for (var y, v = [], k = [], C = Ke ? u.length - s : 0, T = C; T < u.length; T++) {
      var D = u[T];
...
`;
  ...
  function da(c, u) {
    var d = [], g = c.listSelections(), y = Ze(c.clipPos(u)), v = !tn(u, y), k = c.getCursor("head"), C = _f(g, k), T = tn(g[C].head, g[C].anchor), D = g.length - 1, L = D - C > C ? D : 0, F = g[L].anchor, V = Math.min(F.line, y.line), $ = Math.max(F.line, y.line), I = F.ch, Y = y.ch, X = g[L].head.ch - I, we = Y - I;
    X > 0 && we <= 0 ? (I++, v || Y--) : X < 0 && we >= 0 ? (I--, T || Y++) : X < 0 && we == -1 && (I--, Y++);
    for (var ce = V; ce <= $; ce++) {
  ...
  function Wi(c, u, d, g) {
    ...
    if (d == "char") {
      ...
      if (tt(u.head, u.anchor)) y.ch = 0, v.ch = Bt(c, v.line);
        ...
        v.ch = 0;
        var T = c.lastLine();
        y.line > T && (y.line = T), y.ch = Bt(c, y.line);
      }
...
`);
  ...
  function zo(c, { inclusive: u, innerWord: d, bigWord: g, noSymbol: y, multiline: v }, k) {
    var C = k || Wn(c), T = c.getLine(C.line), D = T, L = C.line, F = L, V = C.ch, $, I = y ? m[0] : b[0];
    if (d && /\s/.test(T.charAt(V))) I = function(Ee) {
      return /\s/.test(Ee);
    };
    else {
      for (; !I(T.charAt(V)); ) if (V++, V >= T.length) {
        if (!v) return null;
        V--, $ = It(c, C, true, g, true);
        break;
      }
      g ? I = b[0] : (I = m[0], I(T.charAt(V)) || (I = m[1]));
    }
    for (var Y = V, X = V; I(T.charAt(X)) && X >= 0; ) X--;
    if (X++, $) Y = $.to, F = $.line, D = c.getLine(F), !D && Y == 0 && Y++;
    else for (; I(T.charAt(Y)) && Y < T.length; ) Y++;
    if (u) {
      var we = Y, ce = C.ch <= X && /\s/.test(T.charAt(C.ch));
      if (!ce) for (; /\s/.test(D.charAt(Y)) && Y < D.length; ) Y++;
      if (we == Y || ce) {
        for (var Ce = X; /\s/.test(T.charAt(X - 1)) && X > 0; ) X--;
        !X && !ce && (X = Ce);
      }
    }
  ...
  function zi(c, u, d, g) {
    var y = Ze(c.getCursor()), v = d ? 1 : -1, k = d ? c.lineCount() : -1, C = y.ch, T = y.line, D = c.getLine(T), L = { lineText: D, nextCh: D.charAt(C), lastCh: null, index: C, symb: g, reverseSymb: (d ? { ")": "(", "}": "{" } : { "(": ")", "{": "}" })[g], forward: d, depth: 0, curMoveThrough: false }, F = cs[g];
    if (!F) return y;
    var V = Ko[F].init, $ = Ko[F].isComplete;
    for (V && V(L); T !== k && u; ) {
      if (L.index += v, L.nextCh = L.lineText.charAt(L.index), !L.nextCh) {
        if (T += v, L.lineText = c.getLine(T) || "", v > 0) L.index = 0;
        else {
      ...
      $(L) && (y.line = T, y.ch = L.index, u--);
    }
    return L.nextCh || L.curMoveThrough ? new e(T, L.index) : y;
  }
  function It(c, u, d, g, y) {
    var v = u.line, k = u.ch, C = c.getLine(v), T = d ? 1 : -1, D = g ? b : m;
    if (y && C == "") {
      if (v += T, C = c.getLine(v), !R(c, v)) return null;
      k = d ? 0 : C.length;
    }
    for (; ; ) {
      if (y && C == "") return { from: 0, to: 0, line: v };
      for (var L = T > 0 ? C.length : -1, F = L, V = L; k != L; ) {
        for (var $ = false, I = 0; I < D.length && !$; ++I) if (D[I](C.charAt(k))) {
          for (F = k; k != L && D[I](C.charAt(k)); ) k += T;
          if (V = k, $ = F != V, F == u.ch && v == u.line && V == F + T) continue;
          return { from: Math.min(F, V + 1), to: Math.max(F, V), line: v };
        }
        $ || (k += T);
      }
      if (v += T, !R(c, v)) return null;
      C = c.getLine(v), k = T > 0 ? 0 : C.length;
    }
  }
  function Nt(c, u, d, g, y, v) {
    var k = Ze(u), C = [];
    (g && !y || !g && y) && d++;
    for (var T = !(g && y), D = 0; D < d; D++) {
      var L = It(c, u, g, v, T);
      if (!L) {
  ...
  function Rr(c, u, d, g, y) {
    if (g) {
      for (var v = y || c.getCursor(), k = v.ch, C, T = 0; T < u; T++) {
        var D = c.getLine(v.line);
        if (C = ya(k, D, g, d), C == -1) return;
        k = C;
      }
  ...
  function Gs(c, u, d, g, y) {
    ...
    return T = new e(L, 0), { start: T, end: D };
  }
  function fs(c, u, d, g, y) {
    ...
    for (var T = { ln: u.line, pos: u.ch }; d > 0; ) g < 0 ? T = C(c, T.ln, T.pos, g) : T = k(c, T.ln, T.pos, g), d--;
    return new e(T.ln, T.pos);
  }
  function Pr(c, u, d, g) {
    function y(T, D) {
      if (D.line !== null) if (D.pos + D.dir < 0 || D.pos + D.dir >= D.line.length) {
        if (D.ln += D.dir, !R(T, D.ln)) {
          D.line = null;
          return;
        }
        D.line = T.getLine(D.ln), D.pos = D.dir > 0 ? 0 : D.line.length - 1;
      } else D.pos += D.dir;
    }
    function v(T, D, L, F) {
      var X = T.getLine(D), V = X === "", $ = { line: X, ln: D, pos: L, dir: F }, I = { ln: $.ln, pos: $.pos }, Y = $.line === "";
      for (y(T, $); $.line !== null; ) {
        if (I.ln = $.ln, I.pos = $.pos, $.line === "" && !Y) return { ln: $.ln, pos: $.pos };
        if (V && $.line !== "" && !K($.line[$.pos])) return { ln: $.ln, pos: $.pos };
        ee($.line[$.pos]) && !V && ($.pos === $.line.length - 1 || K($.line[$.pos + 1])) && (V = true), y(T, $);
      }
      var X = T.getLine(I.ln);
      I.pos = 0;
    ...
    function k(T, D, L, F) {
      var X = T.getLine(D), V = { line: X, ln: D, pos: L, dir: F }, $ = V.ln, I = null, Y = V.line === "";
      for (y(T, V); V.line !== null; ) {
        if (V.line === "" && !Y) return I !== null ? { ln: $, pos: I } : { ln: V.ln, pos: V.pos };
        if (ee(V.line[V.pos]) && I !== null && !(V.ln === $ && V.pos + 1 === I)) return { ln: $, pos: I };
        V.line !== "" && !K(V.line[V.pos]) && (Y = false, $ = V.ln, I = V.pos), y(T, V);
      }
      var X = T.getLine($);
      I = 0;
  ...
  function Ys(c, u, d, g) {
    var y = u, v = { "(": /[()]/, ")": /[()]/, "[": /[[\]]/, "]": /[[\]]/, "{": /[{}]/, "}": /[{}]/, "<": /[<>]/, ">": /[<>]/ }[d], k = { "(": "(", ")": "(", "[": "[", "]": "[", "{": "{", "}": "{", "<": "<", ">": "<" }[d], C = c.getLine(y.line).charAt(y.ch), T = C === k ? 1 : 0, D = c.scanForBracket(new e(y.line, y.ch + T), -1, void 0, { bracketRegex: v }), L = c.scanForBracket(new e(y.line, y.ch + T), 1, void 0, { bracketRegex: v });
    if (!D || !L) return null;
    var F = D.pos, V = L.pos;
  ...
  function jo(c, u, d, g) {
    var y = Ze(u), v = c.getLine(y.line), k = v.split(""), C, T, D, L, F = k.indexOf(d);
    if (y.ch < F) y.ch = F;
    else if (F < y.ch && k[y.ch] == d) {
      var V = /string/.test(c.getTokenTypeAt(it(u, 0, 1))), $ = /string/.test(c.getTokenTypeAt(u)), I = V && !$;
      I || (T = y.ch, --y.ch);
    }
    if (k[y.ch] == d && !T) C = y.ch + 1;
    else for (D = y.ch; D > -1 && !C; D--) k[D] == d && (C = D + 1);
    if (C && !T) for (D = C, L = k.length; D < L && !T; D++) k[D] == d && (T = D);
    return !C || !T ? { start: y, end: y } : (g && (--C, ++T), { start: new e(y.line, C), end: new e(y.line, T) });
  }
  q("pcre", true, "boolean");
  class qo {
    constructor() {
...
`, "\\r": "\r", "\\t": "	", "\\&": "&" };
  ...
  function ba(c, u, d) {
    ...
    if (!v) return null;
    J("pcre") || (v = va(v)), d && (u = /^[^A-Z]*$/.test(v));
    var T = new RegExp(v, u || k ? "im" : "m");
    return T;
  }
  function Yn(c) {
  ...
  function mr(c, u, d, g) {
    if (u) {
      var y = Tn(c), v = ba(u, !!d, !!g);
      if (v) return Xo(c, v), xa(v, y.getQuery()) || y.setQuery(v), v;
    }
  }
  function Xs(c) {
    ...
    return c.operation(function() {
      ...
      for (var y = c.getCursor(), v = c.getSearchCursor(d, y), k = 0; k < g; k++) {
        ...
        if (k == 0 && C && tn(v.from(), y)) {
          var T = u ? v.from() : v.to();
          C = v.find(u), C && !C[0] && tn(v.from(), T) && c.getLine(T.line).length == T.ch && (C = v.find(u));
        }
  ...
  function Rf(c, u, d, g, y) {
    return c.operation(function() {
      g === void 0 && (g = 1);
      var v = c.getCursor(), k = c.getSearchCursor(d, v), C = k.find(!u);
      !y.visualMode && C && tn(k.from(), v) && k.find(!u);
      for (var T = 0; T < g; T++) if (C = k.find(u), !C && (k = c.getSearchCursor(d, u ? new e(c.lastLine()) : new e(c.firstLine(), 0)), !k.find(u))) return;
      var D = k.from(), L = k.to();
      return D && L && [D, L];
    });
  }
  function Br(c) {
    var u = Tn(c);
    u.highlightTimeout && (clearTimeout(u.highlightTimeout), u.highlightTimeout = void 0), c.removeOverlay(Tn(c).getOverlay()), u.setOverlay(null), u.getScrollbarAnnotate() && (u.getScrollbarAnnotate().clear(), u.setScrollbarAnnotate(null));
  }
  function Pf(c, u, d) {
  ...
  class hs {
    ...
    _processCommand(u, d, g) {
      ...
      T.input = d;
      try {
        this.parseInput_(u, C, T);
      } catch (F) {
        throw Ve(u, F + ""), F;
      }
      y.visualMode && nn(u);
      var D, L;
      if (!T.commandName) T.line !== void 0 && (L = "move");
      else if (D = this.matchCommand_(T.commandName), D) {
        if (L = D.name, D.excludeFromCommandHistory && v.setText(k), this.parseCommandArgs_(C, T, D), D.type == "exToKey") {
          Ne(u, D.toKeys || "", D);
          return;
      ...
      try {
        Sa[L](u, T), (!D || !D.possiblyAsync) && T.callback && T.callback();
      } catch (F) {
        throw Ve(u, F + ""), F;
      }
    }
  ...
  var Sa = { colorscheme: function(c, u) {
    ...
    var y = d[0].split("="), v = y.shift() || "", k = y.length > 0 ? y.join("=") : void 0, C = false, T = false;
    if (v.charAt(v.length - 1) == "?") {
      if (k) throw Error("Trailing characters: " + u.argString);
      v = v.substring(0, v.length - 1), C = true;
    } else v.charAt(v.length - 1) == "!" && (v = v.substring(0, v.length - 1), T = true);
    k === void 0 && v.substring(0, 2) == "no" && (v = v.substring(2), k = false);
    var D = re[v] && re[v].type == "boolean";
    if (D && (T ? k = !J(v, c, g) : k == null && (k = true)), !D && k === void 0 || C) {
      var L = J(v, c, g);
...
`;
    if (d) for (var C = d.join(""), T = 0; T < C.length; T++) {
      var v = C.charAt(T);
...
`;
    if (d) for (var C = d.join(""), T = 0; T < C.length; T++) {
      var v = C.charAt(T), k = g[v] && g[v].find();
      k && (y += v + "	" + k.line + "	" + k.ch + `
`);
    }
    else for (var v in g) {
    ...
    function C() {
      if (u.argString) {
        ...
        if (Se[1]) {
          ...
          var je = Se[1].indexOf("d") != -1 || Se[1].indexOf("n") != -1, En = Se[1].indexOf("x") != -1, Dt = Se[1].indexOf("o") != -1;
          if (Number(je) + Number(En) + Number(Dt) > 1) return "Invalid arguments";
          v = je && "decimal" || En && "hex" || Dt && "octal";
        }
...
`), I = v == "decimal" ? /(-?)([\d]+)/ : v == "hex" ? /(-?)(?:0x)?([0-9a-f]+)/i : v == "octal" ? /([0-7]+)/ : null, Y = v == "decimal" ? 10 : v == "hex" ? 16 : v == "octal" ? 8 : void 0, X = [], we = [];
    ...
    function Ee(Be, Se) {
      ...
      var En = I && I.exec(Be), Dt = I && I.exec(Se);
      if (!En || !Dt) return Be < Se ? -1 : 1;
      var dn = parseInt((En[1] + En[2]).toLowerCase(), Y), Ai = parseInt((Dt[1] + Dt[2]).toLowerCase(), Y);
      return dn - Ai;
    }
    function Pe(Be, Se) {
      if (d) {
    ...
    if (X.sort(k ? Pe : Ee), k) for (var ce = 0; ce < X.length; ce++) X[ce] = X[ce].input;
    else v || we.sort(Ee);
...
`), F, V);
    ...
    var y = u.line !== void 0 ? u.line : c.firstLine(), v = u.lineEnd || u.line || c.lastLine(), k = Uo(d), C = d, T = "";
    if (k && k.length && (C = k[0], T = k.slice(1, k.length).join("/")), C) try {
      mr(c, C, true, true);
    } catch {
      Ve(c, "Invalid regex: " + C);
      return;
    }
    for (var D = Tn(c).getQuery(), L = [], F = y; F <= v; F++) {
      var V = c.getLine(F), $ = D.test(V);
      $ !== g && L.push(T ? c.getLineHandle(F) : V);
    }
    if (!T) {
      Ve(c, L.join(`
`));
    ...
    var d = u.argString, g = d ? Js(d, d[0]) : [], y = "", v = "", k, C, T, D = false, L = false;
    if (g && g.length) y = g[0], J("pcre") && y !== "" && (y = new RegExp(y).source), v = g[1], v !== void 0 && (J("pcre") ? v = Df(v.replace(/([^\\])&/g, "$1$$&")) : v = Jo(v), te.lastSubstituteReplacePart = v), k = g[2] ? g[2].split(" ") : [];
    else if (d && d.length) {
      Ve(c, "Substitutions should be of the form :s/pattern/replace/");
      return;
    }
    if (k && (C = k[0], T = parseInt(k[1]), C && (C.indexOf("c") != -1 && (D = true), C.indexOf("g") != -1 && (L = true), J("pcre") ? y = y + "/" + C : y = y.replace(/\//g, "\\/") + "/" + C)), y) try {
      mr(c, y, true, true);
    } catch {
    ...
    var F = Tn(c), V = F.getQuery(), $ = u.line !== void 0 ? u.line : c.getCursor().line, I = u.lineEnd || $;
    $ == c.firstLine() && I == c.lastLine() && (I = 1 / 0), T && ($ = I, I = $ + T - 1);
    var Y = Ct(c, new e($, 0)), X = c.getSearchCursor(V, Y);
    Bf(c, D, L, $, I, X, V, v, u.callback);
    ...
    for (var d = c.state.vim, g = new n.StringStream(Us(u.argString)); !g.eol(); ) {
      ...
      if (g.match("-", true)) {
        ...
        var k = v, C = g.next();
        if (k && C && N(k) == N(C)) {
          var T = k.charCodeAt(0), D = C.charCodeAt(0);
          if (T >= D) {
            Ve(c, "Invalid argument: " + u.argString.substring(y));
            return;
          }
          for (var L = 0; L <= D - T; L++) {
            var F = String.fromCharCode(T + L);
            delete d.marks[F];
          }
        } else {
  ...
  function Bf(c, u, d, g, y, v, k, C, T) {
    ...
    function Y() {
      var Ee = "", Pe = v.match || v.pos && v.pos.match;
      if (Pe) Ee = C.replace(/\$(\d{1,3}|[$&])/g, function(Be, Se) {
        if (Se == "$") return "$";
        if (Se == "&") return Pe[0];
      ...
      var yt = v.to().line;
      v.replace(Ee), V = v.to().line, y += V - yt, $ = V < yt;
    }
    function X() {
      var Ee = F && Ze(v.to()), Pe = v.findNext();
      return Pe && !Pe[0] && Ee && tn(v.from(), Ee) && (Pe = v.findNext()), Pe && L++, Pe;
    }
    function we() {
      for (; X() && Pf(v.from(), g, y); ) if (!(!d && v.from().line == V && !$)) {
    ...
    function ce(Ee) {
      ...
      T ? T() : D && Ve(c, (L ? "Found " + L + " matches" : "No matches found") + " for pattern: " + k + (J("pcre") ? " (set nopcre to use Vim regexps)" : ""));
    }
    function Ce(Ee, Pe, st) {
      n.e_stop(Ee);
      var yt = fn(Ee);
      switch (yt) {
        case "y":
  ...
  function Nr(c, u, d, g) {
    ...
    for (var C = 0; C < v.length; C++) for (var T = v[C], D, L, F = /<(?:[CSMA]-)*\w+>|./gi; D = F.exec(T); ) if (L = D[0], ye.handleKey(c, L, "macro"), u.insertMode) {
...
`);
        if (g.maybeReset && (g.changes = [], g.maybeReset = false), k) if (c.state.overwrite && !/\n/.test(k)) g.changes.push([k]);
          ...
          if (k.length > 1) {
            var C = y && y.insertEnd && y.insertEnd.find(), T = c.getCursor();
            if (C && C.line == T.line) {
              var D = C.ch - T.ch;
  ...
  function at(c, u, d, g) {
    ...
    if (u.inputState = u.lastEditInputState, v && v.interlaceInsertRepeat) for (var D = 0; D < d; D++) C(), T(1);
    else g || C(), T(d);
  ...
  function Ft(c, u, d) {
    ...
    y && (pa(c, g, y + 1), d = c.listSelections().length, c.setCursor(g));
    for (var v = 0; v < d; v++) {
      ...
      for (var k = 0; k < u.length; k++) {
        ...
        if (C instanceof Me) Mi(c, C.keyName);
          ...
          var T = c.getCursor(), D = it(T, 0, C[0].length - (C[1] || 0));
          c.replaceRange(C[0], T, C[1] ? T : D), c.setCursor(D);
        }
      }
    }
  ...
  function Tt(c) {
    ...
    return Object.keys(c).forEach(function(d) {
      if (d != "insertEnd") {
        var g = c[d];
        Array.isArray(g) ? g = g.slice() : g && typeof g == "object" && g.constructor != Object && (g = Tt(g)), u[d] = g;
      }
  ...
  function Ht(c, u, d) {
    ...
    var T = g.isInMultiSelectMode();
    if (v.wasInVisualBlock && !T ? v.wasInVisualBlock = false : T && v.visualBlock && (v.wasInVisualBlock = true), u == "<Esc>" && !v.insertMode && !v.visualMode && T && v.status == "<Esc>") mt(g);
    else if (k || !T || g.inVirtualSelectionMode) y = ye.handleKey(g, u, d);
    else {
      var D = Tt(v), L = v.inputState.changeQueueList || [];
      g.operation(function() {
        ...
        g.forEachSelection(function() {
          ...
          V = it(V, 0, I), $ = it($, 0, Y), g.state.vim.sel.head = V, g.state.vim.sel.anchor = $, y = ye.handleKey(g, u, d), g.virtualSelection && (L[F] = g.state.vim.inputState.changeQueue, g.state.vim = Tt(D)), F++;
...
let Mu;
try {
  Mu = new RegExp("[\\w\\p{Alphabetic}\\p{Number}_]", "u");
} catch {
  Mu = /[\w]/;
}
function wl(n, e) {
...
function Sm(n, e) {
  var t;
  n.curOp && (n.curOp.$changeStart = void 0), (e ? Ad : Fc)(n.cm6);
  let i = (t = n.curOp) === null || t === void 0 ? void 0 : t.$changeStart;
  i != null && n.cm6.dispatch({ selection: { anchor: i } });
}
var XT = { Left: (n) => vs(n.cm6, { key: "Left" }, "editor"), Right: (n) => vs(n.cm6, { key: "Right" }, "editor"), Up: (n) => vs(n.cm6, { key: "Up" }, "editor"), Down: (n) => vs(n.cm6, { key: "Down" }, "editor"), Backspace: (n) => vs(n.cm6, { key: "Backspace" }, "editor"), Delete: (n) => vs(n.cm6, { key: "Delete" }, "editor") };
class Ie {
  openDialog(e, t, i) {
    return eE(this, e, t, i);
  }
  ...
  foldCode(e) {
    ...
    t.state.selection.ranges = o, bv(t), t.state.selection.ranges = i;
  }
  firstLine() {
    return 0;
  }
...
`);
  ...
  execCommand(e) {
    ...
    else if (e == "goLineLeft") $v(this.cm6);
...
` && wM(this.cm6);
  ...
  setBookmark(e, t) {
    var i = (t == null ? void 0 : t.insertLeft) ? 1 : -1, r = this.indexFromPos(e), s = new oE(this, r, i);
    return s;
  }
  addOverlay({ query: e }) {
    let t = new Dd({ regexp: true, search: e.source, caseSensitive: !/i/.test(e.flags) });
    if (t.valid) {
  ...
  getSearchCursor(e, t) {
    ...
    function f(b, S = 0, M = b.length) {
      return new Ld(b, a, { ignoreCase: e.ignoreCase }, S, M);
    }
    function h(b) {
  ...
  onBeforeEndOperation() {
    ...
    e && (e.change && xm(e.changeHandlers, this, e.change), e && e.cursorActivity && (xm(e.cursorActivityHandlers, this, null), e.isVimOp && (t = true)), this.curOp = null), t && this.scrollIntoView();
  }
  moveH(e, t) {
    if (t == "char") {
  ...
  getTokenTypeAt(e) {
    var t, i = this.indexFromPos(e), r = dv(this.cm6.state, i), s = r == null ? void 0 : r.resolve(i), o = ((t = s == null ? void 0 : s.type) === null || t === void 0 ? void 0 : t.name) || "";
...
Ie.commands = { cursorCharLeft: function(n) {
  ...
  xu({ state: n.cm6.state, dispatch: (e) => wl(n, e) });
...
Ie.off = Lb;
Ie.signal = Db;
Ie.findMatchingTag = rE;
Ie.findEnclosingTag = sE;
Ie.keyName = void 0;
function Rb(n, e, t) {
...
function ZT(n, e, t) {
  Pb(n, l);
  var i = Rb(n, e, t && t.bottom), r = false, s, o = t && typeof t.duration < "u" ? t.duration : 5e3;
  function l() {
    r || (r = true, clearTimeout(s), i.remove(), Ib(n, i));
  }
  return i.onclick = function(a) {
    a.preventDefault(), l();
  }, Bb(n, i), o && (s = setTimeout(l, o)), l;
}
function Bb(n, e) {
...
function eE(n, e, t, i) {
  i || (i = {}), Pb(n, void 0);
  var r = Rb(n, e, i.bottom), s = false;
  Bb(n, r);
  function o(a) {
    if (typeof a == "string") l.value = a;
    else {
      if (s) return;
      s = true, Ib(n, r), n.state.dialog || n.focus(), i.onClose && i.onClose(r);
    }
  }
...
function iE(n, e, t, i, r) {
  for (var s = r && r.maxScanLineLength || 1e4, o = r && r.maxScanLines || 1e3, l = [], a = nE(r), f = t > 0 ? Math.min(e.line + o, n.lastLine() + 1) : Math.max(n.firstLine() - 1, e.line - o), h = e.line; h != f; h += t) {
    var p = n.getLine(h);
    if (p) {
...
function sE(n, e) {
  ...
  for (var l = dv(r, s), a = (l == null ? void 0 : l.resolve(s)) || null; a; ) {
    if (((t = a.firstChild) === null || t === void 0 ? void 0 : t.type.name) == "OpenTag" && ((i = a.lastChild) === null || i === void 0 ? void 0 : i.type.name) == "CloseTag") return { open: km(r.doc, a.firstChild), close: km(r.doc, a.lastChild) };
    a = a.parent;
  }
}
function km(n, e) {
...
class cE {
  ...
  setBlinkRate() {
    let t = Au(this.cm.cm6.state).cursorBlinkRate;
    this.cursorLayer.style.animationDuration = t + "ms";
  }
  update(e) {
    (e.selectionSet || e.geometryChanged || e.viewportChanged) && (this.view.requestMeasure(this.measureReq), this.cursorLayer.style.animationName = this.cursorLayer.style.animationName == "cm-blink" ? "cm-blink2" : "cm-blink"), fE(e) && this.setBlinkRate();
  }
  scheduleRedraw() {
...
function fE(n) {
  return Au(n.startState) != Au(n.state);
}
const hE = { ".cm-vimMode .cm-line": { "& ::selection": { backgroundColor: "transparent !important" }, "&::selection": { backgroundColor: "transparent !important" }, caretColor: "transparent !important" }, ".cm-fat-cursor": { position: "absolute", background: "#ff9696", border: "none", whiteSpace: "pre" }, "&:not(.cm-focused) .cm-fat-cursor": { background: "none", outline: "solid 1px #ff9696", color: "transparent !important" } }, uE = os.highest(he.theme(hE));
function dE(n) {
  let e = n.scrollDOM.getBoundingClientRect();
...
` && a--, n.state.overwrite ? h = 0.2 : p.status && (h = 0.5);
  ...
  if (f) {
    ...
    if (!S) return null;
    let M = dE(e), A = e.domAtPos(a), _ = A ? A.node : e.contentDOM;
...
` || b == "\r") b = "\xA0";
    ...
    return new aE((N - M.left) / e.scaleX, (S.top - M.top + W * (1 - h)) / e.scaleY, W * h / e.scaleY, R.fontFamily, R.fontSize, R.fontWeight, R.color, i ? "cm-fat-cursor cm-cursor-primary" : "cm-fat-cursor cm-cursor-secondary", b, h != 1);
  } else return null;
}
var gE = typeof navigator < "u" && /linux/i.test(navigator.platform) && / Gecko\/\d+/.exec(navigator.userAgent);
const gs = QT(Ie), mE = 250, yE = he.baseTheme({ ".cm-vimMode .cm-cursorLayer:not(.cm-vimCursorLayer)": { display: "none" }, ".cm-vim-panel": { padding: "0px 10px", fontFamily: "monospace", minHeight: "1.3em", display: "flex" }, ".cm-vim-panel input": { border: "none", outline: "none", backgroundColor: "inherit" }, "&light .cm-searchMatch": { backgroundColor: "#ffff0054" }, "&dark .cm-searchMatch": { backgroundColor: "#00ffff8a" } }), vE = kt.fromClass(class {
  constructor(n) {
    ...
    gs.enterVimMode(this.cm), this.view.cm = this.cm, this.cm.state.vimPlugin = this, this.blockCursor = new cE(n, e), this.updateClass(), this.cm.on("vim-command-done", () => {
      ...
      this.cm.state.statusbar ? this.updateStatus() : n.dispatch({ effects: Nb.of(!!this.cm.state.dialog) });
  ...
  highlight(n) {
    ...
    for (let i = 0, r = e.visibleRanges, s = r.length; i < s; i++) {
      let { from: o, to: l } = r[i];
      for (; i < s - 1 && l > r[i + 1].from - 2 * mE; ) l = r[++i].to;
...
const wE = ve.mark({ class: "cm-searchMatch" }), Nb = _e.define(), xE = Yt.define({ create: () => false, update(n, e) {
  for (let t of e.effects) t.is(Nb) && (n = t.value);
  return n;
}, provide: (n) => Vs.from(n, (e) => e ? SE : null) });
function SE(n) {
  let e = document.createElement("div");
...
function CE(n = {}) {
  return [yE, vE, uE, n.status ? Vs.of(kE) : xE];
}
function ME(n) {
  return n.cm || null;
}
...
function Bo(n, e, t) {
  if (t === void 0) {
    ...
    return mc().subarray(a, a + l.length).set(l), ns = l.length, a;
  }
  ...
  if (o !== i) {
    ...
    const l = mc().subarray(r + o, r + i), a = Pl.encodeInto(n, l);
...
let yc = new TextDecoder("utf-8", { ignoreBOM: true, fatal: true });
yc.decode();
const _E = 2146435072;
let fh = 0;
function LE(n, e) {
  return fh += e, fh >= _E && (yc = new TextDecoder("utf-8", { ignoreBOM: true, fatal: true }), yc.decode(), fh = e), yc.decode(mc().subarray(n, n + e));
}
...
async function PE(n) {
  ...
  n !== void 0 && (Object.getPrototypeOf(n) === Object.prototype ? { module_or_path: n } = n : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), n === void 0 && (n = new URL("/assets/mpl_lang_bg-DEU8OSLm.wasm", import.meta.url));
  const e = EE();
  (typeof n == "string" || typeof Request == "function" && n instanceof Request || typeof URL == "function" && n instanceof URL) && (n = fetch(n));
  const { instance: t, module: i } = await RE(await n, e);
  return DE(t);
}
const Tu = /\b(filter|where|map|group|by|using|align|to|over|from|bucket|join|compute|set|replace|as|and|or|not|is|param|rate|increase|histogram|interpolate_delta_histogram|interpolate_cumulative_histogram|count|avg|sum|min|max)\b/g, BE = /\/\/[^\n]*/g, IE = /"(?:[^"\\]|\\.)*"/g, NE = /#s?\/(?:[^/\\]|\\.)*(?:\/(?:[^/\\]|\\.)*)?\//g, FE = /\b\d+(\.\d*)?([eE][+-]?\d+)?[smhdwMy]?\b/g, HE = /\b(true|false)\b/g, VE = /\b(string|int|float|bool|dataset|metric|duration|regex)\b/g, br = { keyword: ve.mark({ class: "mpl-keyword" }), variable: ve.mark({ class: "mpl-variable" }), string: ve.mark({ class: "mpl-string" }), number: ve.mark({ class: "mpl-number" }), bool: ve.mark({ class: "mpl-bool" }), regexp: ve.mark({ class: "mpl-regexp" }), operator: ve.mark({ class: "mpl-operator" }), punctuation: ve.mark({ class: "mpl-punctuation" }), type: ve.mark({ class: "mpl-type" }), comment: ve.mark({ class: "mpl-comment" }) };
...
function Cm(n) {
  ...
  if (i && i.length > 0) {
    ...
    WE(e, r, t);
  } else ms(IE, e, br.string, 10, t), ms(NE, e, br.regexp, 10, t), ms(HE, e, br.bool, 10, t), ms(FE, e, br.number, 5, t), ms(VE, e, br.type, 10, t), ms(Tu, e, br.keyword, 10, t);
  return $E(t);
}
function WE(n, e, t) {
  Tu.lastIndex = 0;
  let i;
  for (; (i = Tu.exec(n)) !== null; ) {
...
const zE = kt.fromClass(class {
  constructor(n) {
    __publicField(this, "decorations");
    this.decorations = Cm(n);
  }
  update(n) {
    (n.docChanged || n.viewportChanged) && (this.decorations = Cm(n.view));
  }
}, { decorations: (n) => n.decorations });
function mo(n) {
  ...
  if (typeof n == "object") {
    ...
    if ("OneOf" in n) return `one_of(${n.OneOf.map(mo).join(", ")})`;
    if ("Optional" in n) return `[${mo(n.Optional)}]`;
  }
  return "unknown";
}
function Wb(n) {
  if (n.length !== 0) return `(${n.map((e) => `${e.name}: ${mo(e.type)}`).join(", ")})`;
}
const hh = /* @__PURE__ */ new Map();
function $b(n) {
  if (hh.has(n)) return hh.get(n);
  let e = null;
  try {
    e = AE(n);
  } catch {
...
const zb = $e.languageData.of(() => [{ wordChars: "`$" }]);
function jE(n) {
...
function qE(n) {
  ...
  return async (r) => {
    ...
    return o.options.length === 0 ? null : o.kind === "keywords" ? { from: o.from, to: o.to, options: o.options.map((l) => ({ label: l.label, ...l.apply ? { apply: l.apply } : {}, type: "keyword", info: l.info })), filter: false } : { from: o.from, to: o.to, options: o.options.map((l) => ({ label: l.label, type: "function", detail: Wb(l.args), info: l.info })), filter: false };
  };
}
function UE(n) {
  return [zb, Hd({ override: [qE(n)] })];
}
const GE = /^[A-Za-z][A-Za-z0-9_]*$/;
function YE(n) {
  return !GE.test(n);
}
function dh(n, e) {
...
${i.help}` : i.message, actions: JE(i.actions) }));
}
const XE = PT(QE);
function ZE(n, e) {
  let t = 0, i = -1, r = e - 1;
...
function eO(n, e) {
  ...
  if (r.className = "mpl-signature-fn", r.textContent = n.label, i.appendChild(r), i.appendChild(document.createTextNode("(")), n.args.forEach((s, o) => {
    ...
    l.className = o === e ? "mpl-signature-param active" : "mpl-signature-param", l.textContent = `${s.name}: ${mo(s.type)}`, i.appendChild(l);
...
function sO(n) {
  ...
  if (i.className = "mpl-hover-fn", i.textContent = n.label, t.appendChild(i), n.args.length > 0 && (t.appendChild(document.createTextNode("(")), n.args.forEach((r, s) => {
    ...
    o.className = "mpl-hover-param", o.textContent = `${r.name}: ${mo(r.type)}`, t.appendChild(o);
...
function lO(n, e, t) {
  const i = n.state.doc.toString(), r = rO(i, e);
  if (!r) return null;
  const s = $b(r.text);
  ...
  return o ? { pos: r.from, end: r.to, above: true, create() {
    return { dom: oO(r.text, o) };
  } } : null;
}
const aO = rv(lO, { hideOnChange: true });
var Eu = false, Ou = false, Ls = [], _u = -1;
function cO(n) {
  fO(n);
}
function fO(n) {
  Ls.includes(n) || Ls.push(n), uO();
}
function hO(n) {
  let e = Ls.indexOf(n);
  e !== -1 && e > _u && Ls.splice(e, 1);
}
function uO() {
  !Ou && !Eu && (Eu = true, queueMicrotask(dO));
}
function dO() {
  Eu = false, Ou = true;
  for (let n = 0; n < Ls.length; n++) Ls[n](), _u = n;
  Ls.length = 0, _u = -1, Ou = false;
}
var Io, Ks, No, Kb, Lu = true;
function pO(n) {
  Lu = false, n(), Lu = true;
}
function gO(n) {
...
function $d(n, e) {
  typeof e == "function" ? (n._x_cleanups || (n._x_cleanups = []), n._x_cleanups.push(e)) : (e = n, Ub.push(e));
}
function Yb(n) {
  qb.push(n);
}
...
function vO(n) {
  var _a2, _b2;
  for ((_a2 = n._x_effects) == null ? void 0 : _a2.forEach(hO); (_b2 = n._x_cleanups) == null ? void 0 : _b2.length; ) n._x_cleanups.pop()();
}
var zd = new MutationObserver(Ud), Kd = false;
function jd() {
  zd.observe(document, { subtree: true, childList: true, attributes: true, attributeOldValue: true }), Kd = true;
}
function Xb() {
  bO(), zd.disconnect(), Kd = false;
}
var fl = [];
function bO() {
  let n = zd.takeRecords();
  fl.push(() => n.length > 0 && Ud(n));
  let e = fl.length;
  queueMicrotask(() => {
...
function Ud(n) {
  ...
  for (let s of t) e.has(s) || Ub.forEach((o) => o(s));
  e.forEach((s) => {
    s._x_ignoreSelf = true, s._x_ignore = true;
  });
  for (let s of e) t.has(s) || s.isConnected && (delete s._x_ignoreSelf, delete s._x_ignore, Gb.forEach((o) => o(s)), s._x_ignore = true, s._x_ignoreSelf = true);
  e.forEach((s) => {
...
function ca(n, e, t) {
  return n._x_dataStack = [e, ...Ao(t || n)], () => {
    n._x_dataStack = n._x_dataStack.filter((i) => i !== e);
  };
}
function Ao(n) {
  return n._x_dataStack ? n._x_dataStack : typeof ShadowRoot == "function" && n instanceof ShadowRoot ? Ao(n.host) : n.parentNode ? Ao(n.parentNode) : [];
}
function fa(n) {
  return new Proxy({ objects: n }, SO);
}
var SO = { ownKeys({ objects: n }) {
  ...
  return e == "toJSON" ? kO : Reflect.get(n.find((i) => Reflect.has(i, e)) || {}, e, t);
}, set({ objects: n }, e, t, i) {
...
function t1(n, e = () => {
  ...
  let t = { initialValue: void 0, _x_interceptor: true, initialize(i, r, s) {
    return n(this.initialValue, () => CO(i, r), (o) => Du(i, r, o), r, s);
  } };
  return e(t), (i) => {
...
function Du(n, e, t) {
  if (typeof e == "string" && (e = e.split(".")), e.length === 1) n[e[0]] = t;
    ...
    return n[e[0]] || (n[e[0]] = {}), Du(n[e[0]], e.slice(1), t);
  }
}
var n1 = {};
function Vi(n, e) {
...
function Ru(n, e) {
  let t = MO(e);
  return Object.entries(n1).forEach(([i, r]) => {
...
function MO(n) {
  let [e, t] = a1(n), i = { interceptor: t1, ...e };
  return $d(n, t), i;
}
function AO(n, e, t, ...i) {
  try {
...
function s1(n, e) {
  let t = {};
  Ru(t, n);
  let i = [t, ...Ao(n)], r = typeof e == "function" ? EO(i, e) : _O(i, e, n);
  return AO.bind(null, n, e, r);
}
function EO(n, e) {
  return (t = () => {
  }, { scope: i = {}, params: r = [] } = {}) => {
...
function _O(n, e, t) {
  ...
  return (r = () => {
    ...
    if (typeof i == "function") {
      ...
      i.finished ? (Gc(r, i.result, l, o, t), i.result = void 0) : a.then((f) => {
        Gc(r, f, l, o, t);
...
function Gc(n, e, t, i, r) {
  if (vc && typeof e == "function") {
    let s = e.apply(t, i);
    s instanceof Promise ? s.then((o) => Gc(n, o, t, i)).catch((o) => Zl(o, r, e)) : n(s);
...
function DO(n) {
  return Object.keys(Yc).includes(n);
}
function Yd(n, e, t) {
  if (e = Array.from(e), n._x_virtualDirectives) {
    let s = Object.entries(n._x_virtualDirectives).map(([l, a]) => ({ name: l, value: a })), o = o1(s);
    s = s.map((l) => o.find((a) => a.name === l.name) ? { name: `x-bind:${l.name}`, value: `"${l.value}"` } : l), e = e.concat(s);
  }
  let i = {};
  return e.map(h1((s, o) => i[s] = o)).filter(d1).map(BO(i, t)).sort(IO).map((s) => PO(n, s));
}
function o1(n) {
  return Array.from(n).map(h1()).filter((e) => !d1(e));
}
var Pu = false, Sl = /* @__PURE__ */ new Map(), l1 = Symbol();
function RO(n) {
  Pu = true;
  let e = Symbol();
  l1 = e, Sl.set(e, []);
...
function a1(n) {
  let e = [], t = (l) => e.push(l), [i, r] = mO(n);
  return e.push(r), [{ Alpine: ua, effect: i, cleanup: t, evaluateLater: Nn.bind(Nn, n), evaluate: Ds.bind(Ds, n) }, () => e.forEach((l) => l())];
}
function PO(n, e) {
  let t = () => {
  }, i = Yc[e.type] || t, [r, s] = a1(n);
  Jb(n, e.original, s);
  let o = () => {
    n._x_ignore || n._x_ignoreSelf || (i.inline && i.inline(n, e, r), i = i.bind(i, n, e, r), Pu ? Sl.get(l1).push(i) : i());
  };
  return o.runCleanups = s, o;
}
var c1 = (n, e) => ({ name: t, value: i }) => (t.startsWith(n) && (t = t.replace(n, e)), { name: t, value: i }), f1 = (n) => n;
function h1(n = () => {
}) {
  return ({ name: e, value: t }) => {
    let { name: i, value: r } = u1.reduce((s, o) => o(s), { name: e, value: t });
...
var p1 = () => new RegExp(`^${Gd}([^:^.]+)\\b`);
function BO(n, e) {
  return ({ name: t, value: i }) => {
    let r = t.match(p1()), s = t.match(/:([a-zA-Z0-9\-_:]+)/), o = t.match(/\.[^.\]]+(?=[^\]]*$)/g) || [], l = e || n[t] || t;
    return { type: r ? r[1] : null, value: s ? s[1] : null, modifiers: o.map((a) => a.replace(".", "")), expression: i, original: l };
  };
}
var Bu = "DEFAULT", Es = ["ignore", "ref", "data", "id", "anchor", "bind", "init", "for", "model", "modelable", "transition", "show", "if", Bu, "teleport"];
function IO(n, e) {
  let t = Es.indexOf(n.type) === -1 ? Bu : n.type, i = Es.indexOf(e.type) === -1 ? Bu : e.type;
...
var Am = false;
function NO() {
  Am && yi("Alpine has already been initialized on this page. Calling Alpine.start() more than once can cause problems."), Am = true, document.body || yi("Unable to initialize. Trying to load Alpine before `<body>` is available. Did you forget to add `defer` in Alpine's `<script>` tag?"), Bl(document, "alpine:init"), Bl(document, "alpine:initializing"), jd(), yO((e) => Tr(e, $s)), $d((e) => Ho(e)), Yb((e, t) => {
    Yd(e, t).forEach((i) => i());
  });
  let n = (e) => !df(e.parentElement, true);
  Array.from(document.querySelectorAll(y1().join(","))).filter(n).forEach((e) => {
    Tr(e);
...
function df(n, e = false) {
  return ha(n, (t) => {
    if ((e ? y1() : m1()).some((r) => t.matches(r))) return true;
  });
}
function ha(n, e) {
  if (n) {
...
function Tr(n, e = $s, t = () => {
  ...
  RO(() => {
    e(n, (i, r) => {
      t(i, r), w1.forEach((s) => s(i, r)), Yd(i, i.attributes).forEach((s) => s()), i._x_ignore && r();
    });
  });
}
function Ho(n, e = $s) {
...
function Nu() {
  for (Xd = false; Iu.length; ) Iu.shift()();
}
function WO() {
  Xd = true;
}
function ep(n, e) {
  return Array.isArray(e) ? Tm(n, e.join(" ")) : typeof e == "object" && e !== null ? $O(n, e) : typeof e == "function" ? ep(n, e()) : Tm(n, e);
}
function Tm(n, e) {
...
function pf(n, e) {
  return typeof e == "object" && e !== null ? zO(n, e) : KO(n, e);
}
function zO(n, e) {
  let t = {};
  return Object.entries(e).forEach(([i, r]) => {
    t[i] = n.style[i], i.startsWith("--") || (i = jO(i)), n.style.setProperty(i, r);
  }), setTimeout(() => {
...
zt("transition", (n, { value: e, modifiers: t, expression: i }, { evaluate: r }) => {
  typeof i == "function" && (i = r(i)), i !== false && (!i || typeof i == "boolean" ? UO(n, t, e) : qO(n, i, e));
});
function qO(n, e, t) {
  x1(n, ep, ""), { enter: (r) => {
...
function x1(n, e, t = {}) {
  n._x_transition || (n._x_transition = { enter: { during: t, start: t, end: t }, leave: { during: t, start: t, end: t }, in(i = () => {
    ...
    Hu(n, e, { during: this.enter.during, start: this.enter.start, end: this.enter.end }, i, r);
  }, out(i = () => {
  }, r = () => {
  }) {
    Hu(n, e, { during: this.leave.during, start: this.leave.start, end: this.leave.end }, i, r);
  } });
}
...
function S1(n) {
  let e = n.parentNode;
  if (e) return e._x_hidePromise ? e : S1(e);
}
function Hu(n, e, { during: t, start: i, end: r } = {}, s = () => {
}, o = () => {
}) {
...
function GO(n, e) {
  let t, i, r, s = Fu(() => {
    At(() => {
      t = true, i || e.before(), r || (e.end(), Nu()), e.after(), n.isConnected && e.cleanup(), delete n._x_transitioning;
    });
  });
  n._x_transitioning = { beforeCancels: [], beforeCancel(o) {
    ...
    o === 0 && (o = Number(getComputedStyle(n).animationDuration.replace("s", "")) * 1e3), At(() => {
      ...
      t || (At(() => {
        e.end();
      }), Nu(), setTimeout(n._x_transitioning.finish, o + l), r = true);
    });
  });
}
function hl(n, e, t) {
...
var Vu = false;
function QO(n, e) {
  e._x_dataStack || (e._x_dataStack = n._x_dataStack), is = true, Vu = true, C1(() => {
    XO(e);
  }), is = false, Vu = false;
}
function XO(n) {
...
function M1(n, e, t, i = []) {
  switch (n._x_bindings || (n._x_bindings = Io({})), n._x_bindings[e] = t, e = i.includes("camel") ? o_(e) : e, e) {
    case "value":
      ZO(n, t);
      break;
    case "style":
...
function ZO(n, e) {
  if (O1(n)) n.attributes.value === void 0 && (n.value = e), window.fromModel && (typeof e == "boolean" ? n.checked = bc(n.value) === e : n.checked = Em(n.value, e));
  else if (tp(n)) Number.isInteger(e) ? n.value = e : !Array.isArray(e) && typeof e != "boolean" && ![null, void 0].includes(e) ? n.value = String(e) : Array.isArray(e) ? n.checked = e.some((t) => Em(t, n.value)) : n.checked = !!e;
  else if (n.tagName === "SELECT") s_(n, e);
  else {
    if (n.value === e) return;
    n.value = e === void 0 ? "" : e;
  }
...
function e_(n, e) {
  n._x_undoAddedClasses && n._x_undoAddedClasses(), n._x_undoAddedClasses = ep(n, e);
}
function t_(n, e) {
  n._x_undoAddedStyles && n._x_undoAddedStyles(), n._x_undoAddedStyles = pf(n, e);
}
function n_(n, e, t) {
  A1(n, e, t), r_(n, e, t);
}
function A1(n, e, t) {
  [null, void 0, false].includes(t) && a_(e) ? n.removeAttribute(e) : (T1(e) && (t = e), i_(n, e, t));
}
function i_(n, e, t) {
...
var l_ = /* @__PURE__ */ new Set(["allowfullscreen", "async", "autofocus", "autoplay", "checked", "controls", "default", "defer", "disabled", "formnovalidate", "inert", "ismap", "itemscope", "loop", "multiple", "muted", "nomodule", "novalidate", "open", "playsinline", "readonly", "required", "reversed", "selected", "shadowrootclonable", "shadowrootdelegatesfocus", "shadowrootserializable"]);
function T1(n) {
  return l_.has(n);
}
function a_(n) {
...
function c_(n, e, t) {
  return n._x_bindings && n._x_bindings[e] !== void 0 ? n._x_bindings[e] : E1(n, e, t);
}
function f_(n, e, t, i = true) {
  ...
  if (n._x_inlineBindings && n._x_inlineBindings[e] !== void 0) {
    ...
    return r.extract = i, i1(() => Ds(n, r.expression));
  }
  return E1(n, e, t);
}
function E1(n, e, t) {
  let i = n.getAttribute(e);
  return i === null ? typeof t == "function" ? t() : t : i === "" ? true : T1(e) ? !![e, "true"].includes(i) : i;
}
function tp(n) {
...
function D1({ get: n, set: e }, { get: t, set: i }) {
  let r = true, s, o = Ks(() => {
    let l = n(), a = t();
    if (r) i(gh(l)), r = false;
    else {
      let f = JSON.stringify(l), h = JSON.stringify(a);
      f !== s ? i(gh(l)) : f !== h && e(gh(a));
    }
...
var ws = {}, Om = false;
function u_(n, e) {
  if (Om || (ws = Io(ws), Om = true), e === void 0) return ws[n];
  ws[n] = e, e1(ws[n]), typeof e == "object" && e !== null && e.hasOwnProperty("init") && typeof e.init == "function" && ws[n].init();
}
function d_() {
  return ws;
}
...
function p_(n, e) {
  ...
  return n instanceof Element ? P1(n, t()) : (R1[n] = t, () => {
  });
}
function g_(n) {
  return Object.entries(R1).forEach(([e, t]) => {
...
function P1(n, e, t) {
  let i = [];
  for (; i.length; ) i.pop()();
  let r = Object.entries(e).map(([o, l]) => ({ name: o, value: l })), s = o1(r);
  return r = r.map((o) => s.find((l) => l.name === o.name) ? { name: `x-bind:${o.name}`, value: `"${o.value}"` } : o), Yd(n, r, t).map((o) => {
...
function y_(n, e) {
  return Object.entries(B1).forEach(([t, i]) => {
...
var v_ = { get reactive() {
  ...
  return Kb;
}, version: "3.14.3", flushAndStopDeferringMutations: xO, dontAutoEvaluateFunctions: i1, disableEffectScheduling: pO, startObservingMutations: jd, stopObservingMutations: Xb, setReactivityEngine: gO, onAttributeRemoved: Jb, onAttributesAdded: Yb, closestDataStack: Ao, skipDuringClone: as, onlyDuringClone: YO, addRootSelector: v1, addInitSelector: b1, interceptClone: gf, addScopeToNode: ca, deferMutations: wO, mapAttributes: Jd, evaluateLater: Nn, interceptInit: HO, setEvaluator: TO, mergeProxies: fa, extractProp: f_, findClosest: ha, onElRemoved: $d, closestRoot: df, destroyTree: Ho, interceptor: t1, transition: Hu, setStyles: pf, mutateDom: At, directive: zt, entangle: D1, throttle: L1, debounce: _1, evaluate: Ds, initTree: Tr, nextTick: Zd, prefixed: Fo, prefix: LO, plugin: h_, magic: Vi, store: u_, start: NO, clone: QO, cloneNode: JO, bound: c_, $data: Zb, watch: jb, walk: $s, data: m_, bind: p_ }, ua = v_;
function b_(n, e) {
  const t = /* @__PURE__ */ Object.create(null), i = n.split(",");
  for (let r = 0; r < i.length; r++) t[i[r]] = true;
  return (r) => !!t[r];
}
var w_ = Object.freeze({}), x_ = Object.prototype.hasOwnProperty, mf = (n, e) => x_.call(n, e), Rs = Array.isArray, Il = (n) => I1(n) === "[object Map]", S_ = (n) => typeof n == "string", np = (n) => typeof n == "symbol", yf = (n) => n !== null && typeof n == "object", k_ = Object.prototype.toString, I1 = (n) => k_.call(n), N1 = (n) => I1(n).slice(8, -1), ip = (n) => S_(n) && n !== "NaN" && n[0] !== "-" && "" + parseInt(n, 10) === n, C_ = (n) => {
  const e = /* @__PURE__ */ Object.create(null);
  return (t) => e[t] || (e[t] = n(t));
}, M_ = C_((n) => n.charAt(0).toUpperCase() + n.slice(1)), F1 = (n, e) => n !== e && (n === n || e === e), Wu = /* @__PURE__ */ new WeakMap(), ul = [], tr, Ps = Symbol("iterate"), $u = Symbol("Map key iterate");
function A_(n) {
...
function E_(n) {
  n.active && (H1(n), n.options.onStop && n.options.onStop(), n.active = false);
}
var O_ = 0;
function __(n, e) {
  const t = function() {
    ...
    if (!ul.includes(t)) {
      H1(t);
      try {
        return D_(), ul.push(t), tr = t, n();
      } finally {
        ul.pop(), V1(), tr = ul[ul.length - 1];
      }
    }
  };
  return t.id = O_++, t.allowRecurse = !!e.allowRecurse, t._isEffect = true, t.active = true, t.raw = n, t.deps = [], t.options = e, t;
}
function H1(n) {
  const { deps: e } = n;
  if (e.length) {
...
function Ii(n, e, t) {
  if (!To || tr === void 0) return;
  let i = Wu.get(n);
  i || Wu.set(n, i = /* @__PURE__ */ new Map());
  let r = i.get(t);
...
function rs(n, e, t, i, r, s) {
  ...
  if (e === "clear") o.forEach(a);
    ...
    case "add":
      Rs(n) ? ip(t) && a(o.get("length")) : (a(o.get(Ps)), Il(n) && a(o.get($u)));
      break;
    case "delete":
      Rs(n) || (a(o.get(Ps)), Il(n) && a(o.get($u)));
      break;
    case "set":
      Il(n) && a(o.get(Ps));
      break;
...
var R_ = b_("__proto__,__v_isRef,__isVue"), W1 = new Set(Object.getOwnPropertyNames(Symbol).map((n) => Symbol[n]).filter(np)), P_ = $1(), B_ = $1(true), _m = I_();
function I_() {
  const n = {};
...
function $1(n = false, e = false) {
  return function(i, r, s) {
    if (r === "__v_isReactive") return !n;
    if (r === "__v_isReadonly") return n;
    if (r === "__v_raw" && s === (n ? e ? J_ : q1 : e ? Y_ : j1).get(i)) return i;
    const o = Rs(i);
    if (!n && o && mf(_m, r)) return Reflect.get(_m, r, s);
    const l = Reflect.get(i, r, s);
    return (np(r) ? W1.has(r) : R_(r)) || (n || Ii(i, "get", r), e) ? l : zu(l) ? !o || !ip(r) ? l.value : l : yf(l) ? n ? U1(l) : ap(l) : l;
  };
}
var N_ = F_();
function F_(n = false) {
  return function(t, i, r, s) {
    let o = t[i];
    if (!n && (r = xt(r), o = xt(o), !Rs(t) && zu(o) && !zu(r))) return o.value = r, true;
    const l = Rs(t) && ip(i) ? Number(i) < t.length : mf(t, i), a = Reflect.set(t, i, r, s);
    return t === xt(s) && (l ? F1(r, o) && rs(t, "set", i, r, o) : rs(t, "add", i, r)), a;
  };
}
function H_(n, e) {
  const t = mf(n, e), i = n[e], r = Reflect.deleteProperty(n, e);
  return r && t && rs(n, "delete", e, void 0, i), r;
}
function V_(n, e) {
  const t = Reflect.has(n, e);
  return (!np(e) || !W1.has(e)) && Ii(n, "has", e), t;
}
function W_(n) {
  return Ii(n, "iterate", Rs(n) ? "length" : Ps), Reflect.ownKeys(n);
}
var $_ = { get: P_, set: N_, deleteProperty: H_, has: V_, ownKeys: W_ }, z_ = { get: B_, set(n, e) {
...
} }, sp = (n) => yf(n) ? ap(n) : n, op = (n) => yf(n) ? U1(n) : n, lp = (n) => n, vf = (n) => Reflect.getPrototypeOf(n);
function Ja(n, e, t = false, i = false) {
  n = n.__v_raw;
  const r = xt(n), s = xt(e);
  e !== s && !t && Ii(r, "get", e), !t && Ii(r, "get", s);
  const { has: o } = vf(r), l = i ? lp : t ? op : sp;
...
function Xa(n, e = false) {
  return n = n.__v_raw, !e && Ii(xt(n), "iterate", Ps), Reflect.get(n, "size", n);
}
function Lm(n) {
  n = xt(n);
  const e = xt(this);
  return vf(e).has.call(e, n) || (e.add(n), rs(e, "add", n, n)), this;
}
function Dm(n, e) {
  e = xt(e);
  const t = xt(this), { has: i, get: r } = vf(t);
  let s = i.call(t, n);
  s ? K1(t, i, n) : (n = xt(n), s = i.call(t, n));
  const o = r.call(t, n);
  return t.set(n, e), s ? F1(e, o) && rs(t, "set", n, e, o) : rs(t, "add", n, e), this;
}
function Rm(n) {
  const e = xt(this), { has: t, get: i } = vf(e);
  let r = t.call(e, n);
  r ? K1(e, t, n) : (n = xt(n), r = t.call(e, n));
...
function Za(n, e) {
  return function(i, r) {
    const s = this, o = s.__v_raw, l = xt(o), a = e ? lp : n ? op : sp;
    return !n && Ii(l, "iterate", Ps), o.forEach((f, h) => i.call(r, a(f), a(h), s));
  };
}
function ec(n, e, t) {
  return function(...i) {
    const r = this.__v_raw, s = xt(r), o = Il(s), l = n === "entries" || n === Symbol.iterator && o, a = n === "keys" && o, f = r[n](...i), h = t ? lp : e ? op : sp;
    return !e && Ii(s, "iterate", a ? $u : Ps), { next() {
  ...
  return function(...e) {
    {
      ...
      console.warn(`${M_(n)} operation ${t}failed: target is readonly.`, xt(this));
    }
...
function K_() {
  const n = { get(s) {
    ...
    return Xa(this);
  }, has: Qa, add: Lm, set: Dm, delete: Rm, clear: Pm, forEach: Za(false, false) }, e = { get(s) {
    return Ja(this, s, false, true);
  }, get size() {
    return Xa(this);
  }, has: Qa, add: Lm, set: Dm, delete: Rm, clear: Pm, forEach: Za(false, true) }, t = { get(s) {
    return Ja(this, s, true);
  }, get size() {
    return Xa(this, true);
  }, has(s) {
    return Qa.call(this, s, true);
  }, add: Hr("add"), set: Hr("set"), delete: Hr("delete"), clear: Hr("clear"), forEach: Za(true, false) }, i = { get(s) {
    return Ja(this, s, true, true);
  }, get size() {
    return Xa(this, true);
  }, has(s) {
    return Qa.call(this, s, true);
  }, add: Hr("add"), set: Hr("set"), delete: Hr("delete"), clear: Hr("clear"), forEach: Za(true, true) };
  return ["keys", "values", "entries", Symbol.iterator].forEach((s) => {
    n[s] = ec(s, false, false), t[s] = ec(s, true, false), e[s] = ec(s, false, true), i[s] = ec(s, true, true);
  }), [n, t, e, i];
}
var [j_, q_] = K_();
function z1(n, e) {
  const t = n ? q_ : j_;
  return (i, r, s) => r === "__v_isReactive" ? !n : r === "__v_isReadonly" ? n : r === "__v_raw" ? i : Reflect.get(mf(t, r) && r in i ? t : i, r, s);
}
var U_ = { get: z1(false) }, G_ = { get: z1(true) };
function K1(n, e, t) {
  const i = xt(t);
  if (i !== t && e.call(n, i)) {
    const r = N1(n);
...
var j1 = /* @__PURE__ */ new WeakMap(), Y_ = /* @__PURE__ */ new WeakMap(), q1 = /* @__PURE__ */ new WeakMap(), J_ = /* @__PURE__ */ new WeakMap();
function Q_(n) {
  switch (n) {
    case "Object":
    case "Array":
...
function X_(n) {
  return n.__v_skip || !Object.isExtensible(n) ? 0 : Q_(N1(n));
}
function ap(n) {
  return n && n.__v_isReadonly ? n : G1(n, false, $_, U_, j1);
}
function U1(n) {
  return G1(n, true, z_, G_, q1);
}
function G1(n, e, t, i, r) {
  if (!yf(n)) return console.warn(`value cannot be made reactive: ${String(n)}`), n;
...
Vi("data", (n) => Zb(n));
Vi("root", (n) => df(n));
Vi("refs", (n) => (n._x_refs_proxy || (n._x_refs_proxy = fa(Z_(n))), n._x_refs_proxy));
function Z_(n) {
  let e = [];
  return ha(n, (t) => {
...
function t2(n, e) {
  n._x_ids || (n._x_ids = {}), n._x_ids[e] || (n._x_ids[e] = Y1(e));
}
Vi("id", (n, { cleanup: e }) => (t, i = null) => {
  let r = `${t}${i ? `-${i}` : ""}`;
  return n2(n, r, e, () => {
    let s = e2(n, t), o = s ? s._x_ids[t] : Y1(t);
    return i ? `${t}-${o}-${i}` : `${t}-${o}`;
  });
});
gf((n, e) => {
...
Vi("el", (n) => n);
J1("Focus", "focus", "focus");
J1("Persist", "persist", "persist");
function J1(n, e, t) {
...
zt("modelable", (n, { expression: e }, { effect: t, evaluateLater: i, cleanup: r }) => {
  ...
  a(f), queueMicrotask(() => {
    ...
    let h = n._x_model.get, p = n._x_model.set, m = D1({ get() {
      return h();
    }, set(b) {
      p(b);
    } }, { get() {
...
zt("teleport", (n, { modifiers: e, expression: t }, { cleanup: i }) => {
  ...
  let r = Bm(t), s = n.content.cloneNode(true).firstElementChild;
...
function Bm(n) {
  let e = as(() => document.querySelector(n), () => i2)();
  return e || yi(`Cannot find x-teleport element for selector: "${n}"`), e;
}
var Q1 = () => {
};
Q1.inline = (n, { modifiers: e }, { cleanup: t }) => {
...
function Ku(n, e, t, i) {
  ...
  if (t.includes("dot") && (e = r2(e)), t.includes("camel") && (e = s2(e)), t.includes("passive") && (o.passive = true), t.includes("capture") && (o.capture = true), t.includes("window") && (r = window), t.includes("document") && (r = document), t.includes("debounce")) {
    let a = t[t.indexOf("debounce") + 1] || "invalid-wait", f = Jc(a.split("ms")[0]) ? Number(a.split("ms")[0]) : 250;
    s = _1(s, f);
  }
  if (t.includes("throttle")) {
    let a = t[t.indexOf("throttle") + 1] || "invalid-wait", f = Jc(a.split("ms")[0]) ? Number(a.split("ms")[0]) : 250;
    s = L1(s, f);
  }
...
function a2(n, e) {
  ...
  if (t.includes("debounce")) {
    ...
    t.splice(s, Jc((t[s + 1] || "invalid-wait").split("ms")[0]) ? 2 : 1);
  }
  if (t.includes("throttle")) {
    let s = t.indexOf("throttle");
    t.splice(s, Jc((t[s + 1] || "invalid-wait").split("ms")[0]) ? 2 : 1);
  }
  if (t.length === 0 || t.length === 1 && Im(n.key).includes(t[0])) return false;
  const r = ["ctrl", "shift", "alt", "meta", "cmd", "super"].filter((s) => t.includes(s));
  return t = t.filter((s) => !r.includes(s)), !(r.length > 0 && r.filter((o) => ((o === "cmd" || o === "super") && (o = "meta"), n[`${o}Key`])).length === r.length && (X1(n.type) || Im(n.key).includes(t[0])));
}
function Im(n) {
  if (!n) return [];
  n = o2(n);
...
zt("model", (n, { modifiers: e, expression: t }, { effect: i, cleanup: r }) => {
  ...
  let a = () => {
    let m;
    return o((b) => m = b), Nm(m) ? m.get() : m;
  }, f = (m) => {
    let b;
    o((S) => b = S), Nm(b) ? b.set(m) : l(() => {
  ...
  if (e.includes("fill") && ([void 0, null, ""].includes(a()) || tp(n) && Array.isArray(a()) || n.tagName.toLowerCase() === "select" && n.multiple) && f(yh(n, e, { target: n }, a())), n._x_removeModelListeners || (n._x_removeModelListeners = {}), n._x_removeModelListeners.default = p, r(() => n._x_removeModelListeners.default()), n.form) {
    let m = Ku(n.form, "reset", [], (b) => {
      Zd(() => n._x_model && n._x_model.set(yh(n, e, { target: n }, a())));
    });
    r(() => m());
  }
  n._x_model = { get() {
    ...
    m === void 0 && typeof t == "string" && t.match(/\./) && (m = ""), window.fromModel = true, At(() => M1(n, "value", m)), delete window.fromModel;
  }, i(() => {
    let m = a();
...
function yh(n, e, t, i) {
  return At(() => {
    ...
    if (tp(n)) if (Array.isArray(i)) {
      let r = null;
      return e.includes("number") ? r = vh(t.target.value) : e.includes("boolean") ? r = bc(t.target.value) : r = t.target.value, t.target.checked ? i.includes(r) ? i : i.concat([r]) : i.filter((s) => !c2(s, r));
      ...
      {
        let r;
        return O1(n) ? t.target.checked ? r = t.target.value : r = i : r = t.target.value, e.includes("number") ? vh(r) : e.includes("boolean") ? bc(r) : e.includes("trim") ? r.trim() : r;
      }
    }
  });
}
...
zt("html", (n, { expression: e }, { effect: t, evaluateLater: i }) => {
  ...
  t(() => {
    r((s) => {
      At(() => {
        n.innerHTML = s, n._x_ignoreSelf = true, Tr(n), delete n._x_ignoreSelf;
      });
    });
  });
});
Jd(c1(":", f1(Fo("bind:"))));
var Z1 = (n, { value: e, modifiers: t, expression: i, original: r }, { effect: s, cleanup: o }) => {
  if (!e) {
    let a = {};
    g_(a), Nn(n, i)((h) => {
      P1(n, h, r);
...
function u2(n) {
  return is ? Vu ? true : n.hasAttribute("data-has-alpine-state") : false;
}
...
zt("for", (n, { expression: e }, { effect: t, cleanup: i }) => {
  let r = p2(e), s = Nn(n, r.items), o = Nn(n, n._x_keyExpression || "index");
  n._x_prevKeys = [], n._x_lookup = {}, t(() => d2(n, r, s, o)), i(() => {
...
function d2(n, e, t, i) {
  ...
  t((o) => {
    g2(o) && o >= 0 && (o = Array.from(Array(o).keys(), (A) => A + 1)), o === void 0 && (o = []);
    ...
    for (let A = 0; A < p.length; A++) {
      ...
      ca(H, K, s), H._x_refreshXForScope = (ee) => {
...
ew.inline = (n, { expression: e }, { cleanup: t }) => {
  let i = df(n);
...
bf("Collapse", "collapse", "collapse");
bf("Intersect", "intersect", "intersect");
bf("Focus", "trap", "focus");
bf("Mask", "mask", "mask");
function bf(n, e, t) {
...
ua.setEvaluator(s1);
ua.setReactivityEngine({ reactive: ap, effect: T_, release: E_, raw: xt });
var m2 = ua, tw = m2;
function hr(n) {
  return (n == null ? void 0 : n.Concrete) != null ? n.Concrete : n;
}
function Sr(n) {
  return (n == null ? void 0 : n.Builtin) != null ? String(n.Builtin).toLowerCase() : typeof n == "string" ? n.toLowerCase() : "?";
}
function Hm(n) {
  const e = { Millisecond: "ms", Second: "s", Minute: "m", Hour: "h", Day: "d", Week: "w" };
  return `${n.value}${e[n.unit] ?? n.unit}`;
}
function y2(n) {
  const e = { Millisecond: 1e-3, Second: 1, Minute: 60, Hour: 3600, Day: 86400, Week: 604800 };
  return (n.value ?? 1) * (e[n.unit] ?? 60);
}
function io(n) {
  return n == null ? "" : typeof n == "string" || typeof n == "number" ? String(n) : n.String != null ? n.String : n.Int != null ? String(n.Int) : n.Float != null ? String(n.Float) : n.Bool != null ? String(n.Bool) : String(n);
}
function nw(n) {
...
function v2(n) {
  return n == null ? "?" : typeof n == "string" ? `"${n}"` : typeof n == "number" || typeof n == "boolean" ? String(n) : n.String != null ? `"${n.String}"` : n.Int != null ? String(n.Int) : n.Float != null ? String(n.Float) : n.Bool != null ? String(n.Bool) : String(n);
}
function b2(n, e) {
  const t = { Eq: "==", Ne: "!=", Gt: ">", Ge: ">=", Lt: "<", Le: "<=" };
  for (const [i, r] of Object.entries(t)) if (e[i] != null) return `${n} ${r} ${v2(hr(e[i]))}`;
  if (e.RegEx != null) {
    const i = hr(e.RegEx), r = i instanceof RegExp ? i.source : String(i);
    return `${n} == #/${r}/`;
  }
  if (e.RegExNot != null) {
    const i = hr(e.RegExNot), r = i instanceof RegExp ? i.source : String(i);
    return `${n} != #/${r}/`;
  }
  return e.Is != null ? `${n} is ${e.Is}` : `${n} ?`;
}
function wc(n) {
  return n.Cmp ? b2(n.Cmp.field, n.Cmp.rhs) : n.And ? n.And.map(wc).join(" and ") : n.Or ? n.Or.map(wc).join(" or ") : n.Not ? `not ${wc(n.Not)}` : "?";
}
function w2(n) {
  return `| where ${wc(n)}`;
}
function iw(n) {
  ...
  if (n.Align != null) {
    ...
    return `| align to ${Hm(hr(n.Align.time))} using ${e}`;
  }
  if (n.GroupBy != null) {
  ...
  if (n.Bucket != null) {
    const e = Sr(n.Bucket.function), t = Hm(hr(n.Bucket.time)), i = n.Bucket.tags ?? [];
    return i.length ? `| bucket by [${i.join(", ")}] every ${t} using ${e}` : `| bucket every ${t} using ${e}`;
  }
  return n.As != null ? `| as ${n.As.name ?? "?"}` : n.Join != null ? "| join" : "| ?";
}
...
async function bh() {
  if (tc) return tc;
  try {
    const n = await fetch("/datasets/index.json");
    return n.ok ? (tc = await n.json(), tc) : {};
  } catch {
    return {};
  }
}
...
async function S2(n, e) {
  const t = x2(n, e), i = Vm.get(t);
  if (i) return i.map($m);
  try {
    const r = await fetch(`/datasets/${t}.json`);
    if (!r.ok) return Wm();
    const s = await r.json(), o = s.series.map((l) => ({ tags: l.tags, name: nw(l.tags), timestamps: [...s.timestamps], values: [...l.values] }));
    return Vm.set(t, o), o.map($m);
  } catch {
    return Wm();
  }
}
function Wm() {
  const n = Array.from({ length: 60 }, (e, t) => 17e8 + t * 60);
  return [{ tags: { series: "a" }, name: "series=a", timestamps: [...n], values: n.map((e, t) => 50 + t) }, { tags: { series: "b" }, name: "series=b", timestamps: [...n], values: n.map((e, t) => 80 - t * 0.5) }, { tags: { series: "c" }, name: "series=c", timestamps: [...n], values: n.map((e, t) => 30 + Math.sin(t / 5) * 20) }];
}
function $m(n) {
  return { ...n, timestamps: [...n.timestamps], values: [...n.values] };
}
function xc(n, e) {
  if (e.Cmp) {
    const t = e.Cmp.field, i = n.tags[t];
    if (i == null) return false;
    const r = e.Cmp.rhs;
    for (const [s, o] of [["Eq", (l, a) => l === String(io(a))], ["Ne", (l, a) => l !== String(io(a))], ["Gt", (l, a) => Number(l) > Number(io(a))], ["Ge", (l, a) => Number(l) >= Number(io(a))], ["Lt", (l, a) => Number(l) < Number(io(a))], ["Le", (l, a) => Number(l) <= Number(io(a))]]) if (r[s] != null) return o(i, hr(r[s]));
    if (r.RegEx != null) try {
      const s = hr(r.RegEx);
      return (s instanceof RegExp ? s : new RegExp(String(s))).test(i);
    } catch {
      return true;
    }
    if (r.RegExNot != null) try {
      const s = hr(r.RegExNot);
      return !(s instanceof RegExp ? s : new RegExp(String(s))).test(i);
    } catch {
      return true;
    }
  ...
  return e.And ? e.And.every((t) => xc(n, t)) : e.Or ? e.Or.some((t) => xc(n, t)) : e.Not ? !xc(n, e.Not) : true;
}
function k2(n, e) {
  return n.filter((t) => e.every((i) => xc(t, i)));
}
function zm(n, e) {
  ...
  for (let r = 0; r < t; r++) {
    ...
    switch (e) {
      case "sum":
        i.push(s.reduce((o, l) => o + l, 0));
        break;
      case "avg":
        i.push(s.reduce((o, l) => o + l, 0) / s.length);
        break;
      case "min":
        i.push(Math.min(...s));
        break;
...
function Km(n, e) {
  ...
  if (i.length === 0) {
    const s = zm(n.map((l) => l.values), t), o = ((_a2 = n[0]) == null ? void 0 : _a2.timestamps) ?? [];
  ...
  return Object.values(r).map((s) => {
    const o = zm(s.map((f) => f.values), t), l = s[0].timestamps, a = {};
    for (const f of i) a[f] = s[0].tags[f] ?? "";
    return { tags: a, name: nw(a), timestamps: [...l], values: o };
  });
}
function rw(n, e) {
  ...
  return n.map((r) => {
    let s;
    if (t.startsWith("is") || t === "islt" || t === "isgt" || t === "iseq" || t === "isne" || t === "isge" || t === "isle") {
      const o = t.replace("is::", "").replace("is", "");
      s = r.values.map((l) => {
        if (i == null) return l;
        switch (o) {
          case "lt":
    ...
    } else if (t.startsWith("filter") || t === "filterlt" || t === "filtergt") {
      const o = t.replace("filter::", "").replace("filter", "");
      s = r.values.map((l) => {
        if (i == null) return l;
        switch (o) {
          case "lt":
    ...
    else if (t === "fillconst" || t === "fill::const") s = r.values.map((o) => isNaN(o) ? i ?? 0 : o);
    else if (t === "fillprev" || t === "fill::prev") {
      let o = 0;
...
function ju(n, e) {
  const t = Sr(e.function), i = hr(e.time), r = i != null ? y2(i) : 300;
  return n.map((s) => {
    ...
    for (let h = o; h <= l; h += r) {
      ...
      switch (t) {
        case "sum":
          f.push(m.reduce((b, S) => b + S, 0));
          break;
        case "avg":
          f.push(m.reduce((b, S) => b + S, 0) / m.length);
          break;
        case "min":
          f.push(Math.min(...m));
          break;
        ...
        case "count":
          ...
          break;
        case "rate": {
          m.length < 2 ? f.push(0) : f.push((m[m.length - 1] - m[0]) / r);
          break;
        }
        case "last":
          f.push(m[m.length - 1]);
...
function Nl(n, e) {
  return { mplLine: n, series: M2(e) };
}
async function A2(n) {
  const e = [], t = hr(n.source.metric_id.dataset) ?? "?", i = n.source.metric_id.metric ?? "?";
  let r = await S2(t, i);
  e.push(Nl(`${t}:${i}`, r));
  for (const s of n.filters ?? []) r = k2(r, [s]), e.push(Nl(w2(s), r));
  for (const s of n.aggregates ?? []) {
    const o = iw(s);
    s.Map != null ? r = rw(r, s.Map) : s.Align != null ? r = ju(r, s.Align) : s.GroupBy != null ? r = Km(r, s.GroupBy) : s.Bucket != null ? (r = Km(r, { function: s.Bucket.function, tags: s.Bucket.tags }), r = ju(r, { function: s.Bucket.function, time: s.Bucket.time })) : s.As != null && (r = r.map((l) => ({ ...l, name: s.As.name ?? "?" }))), e.push(Nl(o, r));
  }
  return e;
}
async function T2(n) {
  var _a2, _b2;
  const e = await qu(n.left), t = await qu(n.right), i = [...e, ...t], r = Sr(n.op), s = n.name ?? "?", o = ((_a2 = e[e.length - 1]) == null ? void 0 : _a2.series) ?? [], l = ((_b2 = t[t.length - 1]) == null ? void 0 : _b2.series) ?? [];
  let a = C2(o, l, n.op, s);
  const f = r === "div" ? "/" : r === "mul" ? "*" : r === "add" ? "+" : r === "sub" ? "-" : r;
  i.push(Nl(`| compute ${s} using ${f}`, a));
  for (const h of n.aggregates ?? []) {
    const p = iw(h);
    h.Map != null ? a = rw(a, h.Map) : h.Align != null ? a = ju(a, h.Align) : h.As != null && (a = a.map((m) => ({ ...m, name: h.As.name ?? "?" }))), i.push(Nl(p, a));
  }
  return i;
}
async function qu(n) {
  return n.Simple ? A2(n.Simple) : n.Compute ? T2(n.Compute) : [];
}
async function E2(n) {
  return qu(n);
}
const O2 = true, Jt = "u-", _2 = "uplot", L2 = Jt + "hz", D2 = Jt + "vt", R2 = Jt + "title", P2 = Jt + "wrap", B2 = Jt + "under", I2 = Jt + "over", N2 = Jt + "axis", Ms = Jt + "off", F2 = Jt + "select", H2 = Jt + "cursor-x", V2 = Jt + "cursor-y", W2 = Jt + "cursor-pt", $2 = Jt + "legend", z2 = Jt + "live", K2 = Jt + "inline", j2 = Jt + "series", q2 = Jt + "marker", jm = Jt + "label", U2 = Jt + "value", kl = "width", Cl = "height", dl = "top", qm = "bottom", ro = "left", wh = "right", cp = "#000", Um = cp + "0", xh = "mousemove", Gm = "mousedown", Sh = "mouseup", Ym = "mouseenter", Jm = "mouseleave", Qm = "dblclick", G2 = "resize", Y2 = "scroll", Xm = "change", Qc = "dppxchange", fp = "--", Vo = typeof window < "u", Uu = Vo ? document : null, yo = Vo ? window : null, J2 = Vo ? navigator : null;
let Je, nc;
function Gu() {
  let n = devicePixelRatio;
  Je != n && (Je = n, nc && Ju(Xm, nc, Gu), nc = matchMedia(`(min-resolution: ${Je - 1e-3}dppx) and (max-resolution: ${Je + 1e-3}dppx)`), Bs(Xm, nc, Gu), yo.dispatchEvent(new CustomEvent(Qc)));
}
function ti(n, e) {
  if (e != null) {
    let t = n.classList;
...
function Xi(n, e, t, i, r) {
  let s = "translate(" + e + "px," + t + "px)", o = Zm.get(n);
  s != o && (n.style.transform = s, Zm.set(n, s), e < 0 || t < 0 || e > i || t > r ? ti(n, Ms) : Yu(n, Ms));
}
const e0 = /* @__PURE__ */ new WeakMap();
function t0(n, e, t) {
  let i = e + t, r = e0.get(n);
  i != r && (e0.set(n, i), n.style.background = e, n.style.borderColor = t);
}
const n0 = /* @__PURE__ */ new WeakMap();
function i0(n, e, t, i) {
  let r = e + "" + t, s = n0.get(n);
  r != s && (n0.set(n, r), n.style.height = t + "px", n.style.width = e + "px", n.style.marginLeft = i ? -e / 2 + "px" : 0, n.style.marginTop = i ? -t / 2 + "px" : 0);
}
const hp = { passive: true }, Q2 = { ...hp, capture: true };
function Bs(n, e, t, i) {
  e.addEventListener(n, t, i ? Q2 : hp);
}
function Ju(n, e, t, i) {
  e.removeEventListener(n, t, hp);
}
Vo && Gu();
function _i(n, e, t, i) {
  let r;
...
const ow = (n) => n != null, lw = (n) => n != null && n > 0, wf = sw(ow), X2 = sw(lw);
function Z2(n, e, t, i = 0, r = false) {
  let s = r ? X2 : wf, o = r ? lw : ow;
  [e, t] = s(n, e, t);
  let l = n[e], a = n[e];
...
function xf(n, e, t, i) {
  ...
  let o = t == 10 ? Cr : aw, l = r == 1 ? ri : ui, a = s == 1 ? ui : ri, f = l(o(qt(n))), h = a(o(qt(e))), p = Eo(t, f), m = Eo(t, h);
  return t == 10 && (f < 0 && (p = ut(p, -f)), h < 0 && (m = ut(m, -h))), i || t == 2 ? (n = p * r, e = m * s) : (n = uw(n, p), e = Sf(e, m)), [n, e];
}
function up(n, e, t, i) {
  let r = xf(n, e, t, i);
  return n == 0 && (r[0] = 0), e == 0 && (r[1] = 0), r;
}
const dp = 0.1, r0 = { mode: 3, pad: dp }, Fl = { pad: 0, soft: null, mode: 0 }, eL = { min: Fl, max: Fl };
function Xc(n, e, t, i) {
  return kf(t) ? s0(n, e, t) : (Fl.pad = t, Fl.soft = i ? 0 : null, Fl.mode = i ? 3 : 0, s0(n, e, eL));
}
function Ue(n, e) {
  return n ?? e;
}
...
function s0(n, e, t) {
  ...
  let R = b || M || 1e3, N = Cr(R), B = Eo(10, ri(N)), W = R * (b == 0 ? n == 0 ? 0.1 : 1 : s), H = ut(uw(n - W, B / 10), 24), K = n >= f && (p == 1 || p == 3 && H <= f || p == 2 && H >= f) ? f : ht, ee = Pn(l, H < K && n >= K ? K : Li(K, H)), oe = R * (b == 0 ? e == 0 ? 0.1 : 1 : o), re = ut(Sf(e + oe, B / 10), 24), q = e <= h && (m == 1 || m == 3 && re >= h || m == 2 && re <= h) ? h : -ht, Z = Li(a, re > q && e <= q ? q : Pn(q, re));
  return ee == Z && ee == 0 && (Z = 100), [ee, Z];
}
const nL = new Intl.NumberFormat(Vo ? J2.language : "en-US"), pp = (n) => nL.format(n), si = Math, Sc = si.PI, qt = si.abs, ri = si.floor, jt = si.round, ui = si.ceil, Li = si.min, Pn = si.max, Eo = si.pow, o0 = si.sign, Cr = si.log10, aw = si.log2, iL = (n, e = 1) => si.sinh(n) * e, kh = (n, e = 1) => si.asinh(n / e), ht = 1 / 0;
function l0(n) {
...
const rL = () => {
}, fw = (n) => n, hw = (n, e) => e, sL = (n) => null, a0 = (n) => true, c0 = (n, e) => n == e, oL = /\.\d*?(?=9{6,}|0{6,})/gm, zs = (n) => {
  if (pw(n) || ss.has(n)) return n;
  const e = `${n}`, t = e.match(oL);
  if (t == null) return n;
  let i = t[0].length - 1;
  if (e.indexOf("e-") != -1) {
    let [r, s] = e.split("e");
...
const Hl = {}, gp = [], Oo = [null, null], $r = Array.isArray, pw = Number.isInteger, lL = (n) => n === void 0;
function f0(n) {
...
const cL = Object.getPrototypeOf(Uint8Array), gw = "__proto__";
function _o(n, e = kf) {
  let t;
  if ($r(n)) {
  ...
  } else if (n instanceof cL) t = n.slice();
  else if (e(n)) {
    t = {};
    for (let i in n) i != gw && (t[i] = _o(n[i], e));
  } else t = n;
  return t;
}
function $t(n) {
  ...
  for (let t = 1; t < e.length; t++) {
    let i = e[t];
    for (let r in i) r != gw && (kf(n[r]) ? $t(n[r], _o(i[r])) : n[r] = _o(i[r]));
  }
  return n;
}
const fL = 0, hL = 1, uL = 2;
function dL(n, e, t) {
  ...
  for (let o = 0; o < n.length; o++) {
    ...
    for (let f = 1; f < l.length; f++) {
      ...
      for (let S = 0; S < h.length; S++) {
        ...
        M === null ? m != fL && (p[A] = M, m == uL && b.push(A)) : p[A] = M;
      }
      dL(p, b, r), i.push(p);
    }
  }
...
const gL = typeof queueMicrotask > "u" ? (n) => Promise.resolve().then(n) : queueMicrotask;
function mL(n) {
...
const mw = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], yw = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
function vw(n) {
  return n.slice(0, 3);
}
const bL = yw.map(vw), wL = mw.map(vw), xL = { MMMM: mw, MMM: wL, WWWW: yw, WWW: bL };
function pl(n) {
  return (n < 10 ? "0" : "") + n;
}
function SL(n) {
...
const kL = { YYYY: (n) => n.getFullYear(), YY: (n) => (n.getFullYear() + "").slice(2), MMMM: (n, e) => e.MMMM[n.getMonth()], MMM: (n, e) => e.MMM[n.getMonth()], MM: (n) => pl(n.getMonth() + 1), M: (n) => n.getMonth() + 1, DD: (n) => pl(n.getDate()), D: (n) => n.getDate(), WWWW: (n, e) => e.WWWW[n.getDay()], WWW: (n, e) => e.WWW[n.getDay()], HH: (n) => pl(n.getHours()), H: (n) => n.getHours(), h: (n) => {
  let e = n.getHours();
  return e == 0 ? 12 : e > 12 ? e - 12 : e;
}, AA: (n) => n.getHours() >= 12 ? "PM" : "AM", aa: (n) => n.getHours() >= 12 ? "pm" : "am", a: (n) => n.getHours() >= 12 ? "p" : "a", mm: (n) => pl(n.getMinutes()), m: (n) => n.getMinutes(), ss: (n) => pl(n.getSeconds()), s: (n) => n.getSeconds(), fff: (n) => SL(n.getMilliseconds()) };
function mp(n, e) {
  e = e || xL;
  let t = [], i = /\{([a-z]+)\}|[^{]+/gi, r;
...
const CL = new Intl.DateTimeFormat().resolvedOptions().timeZone;
function ML(n, e) {
  let t;
  return e == "UTC" || e == "Etc/UTC" ? t = new Date(+n + n.getTimezoneOffset() * 6e4) : e == CL ? t = n : (t = new Date(n.toLocaleString("en-US", { timeZone: e })), t.setMilliseconds(n.getMilliseconds())), t;
}
const bw = (n) => n % 1 == 0, Zc = [1, 2, 2.5, 5], AL = ea(10, -32, 0, Zc), ww = ea(10, 0, 32, Zc), TL = ww.filter(bw), Ss = AL.concat(ww), yp = `
`, xw = "{YYYY}", h0 = yp + xw, Sw = "{M}/{D}", Ml = yp + Sw, ic = Ml + "/{YY}", kw = "{aa}", EL = "{h}:{mm}", lo = EL + kw, u0 = yp + lo, d0 = ":{ss}", et = null;
function Cw(n) {
  let e = n * 1e3, t = e * 60, i = t * 60, r = i * 24, s = r * 30, o = r * 365, a = (n == 1 ? ea(10, 0, 3, Zc).filter(bw) : ea(10, -3, 0, Zc)).concat([e, e * 5, e * 10, e * 15, e * 30, t, t * 5, t * 10, t * 15, t * 30, i, i * 2, i * 3, i * 4, i * 6, i * 8, i * 12, r, r * 2, r * 3, r * 4, r * 5, r * 6, r * 7, r * 8, r * 9, r * 10, r * 15, s, s * 2, s * 3, s * 4, s * 6, o, o * 2, o * 5, o * 10, o * 25, o * 50, o * 100]);
  const f = [[o, xw, et, et, et, et, et, et, 1], [r * 28, "{MMM}", h0, et, et, et, et, et, 1], [r, Sw, h0, et, et, et, et, et, 1], [i, "{h}" + kw, ic, et, Ml, et, et, et, 1], [t, lo, ic, et, Ml, et, et, et, 1], [e, d0, ic + " " + lo, et, Ml + " " + lo, et, u0, et, 1], [n, d0 + ".{fff}", ic + " " + lo, et, Ml + " " + lo, et, u0, et, 1]];
  function h(p) {
    return (m, b, S, M, A, _) => {
      let R = [], N = A >= o, B = A >= s && A < o, W = p(S), H = ut(W * n, 3), K = Ch(W.getFullYear(), N ? 0 : W.getMonth(), B || N ? 1 : W.getDate()), ee = ut(K * n, 3);
      if (B || N) {
        let oe = B ? A / s : 0, re = N ? A / o : 0, q = H == ee ? H : ut(Ch(K.getFullYear() + re, K.getMonth() + oe, 1) * n, 3), Z = new Date(jt(q / n)), J = Z.getFullYear(), se = Z.getMonth();
        for (let ie = 0; q <= M; ie++) {
          let ke = Ch(J + re * ie, se + oe * ie, 1), ae = ke - p(ut(ke * n, 3));
          q = ut((+ke + ae) * n, 3), q <= M && R.push(q);
        }
      } else {
        let oe = A >= r ? r : A, re = ri(S) - ri(H), q = ee + re + Sf(H - ee, oe);
        R.push(q);
...
const [OL, _L, LL] = Cw(1), [DL, RL, PL] = Cw(1e-3);
ea(2, -53, 53, [1]);
function p0(n, e) {
...
const IL = "{YYYY}-{MM}-{DD} {h}:{mm}{aa}";
function y0(n, e) {
  return (t, i, r, s) => s == null ? fp : e(n(i));
}
function NL(n, e) {
  let t = n.series[e];
...
const HL = { show: true, live: true, isolate: false, mount: rL, markers: { show: true, width: 2, stroke: NL, fill: FL, dash: "solid" }, idx: null, idxs: null, values: [] };
function VL(n, e) {
...
const Mh = [0, 0];
function KL(n, e, t) {
  return Mh[0] = e, Mh[1] = t, Mh;
}
function rc(n, e, t, i = true) {
  return (r) => {
    r.button == 0 && (!i || r.target == e) && t(r);
  };
}
function Ah(n, e, t, i = true) {
  return (r) => {
    (!i || r.target == e) && t(r);
  };
}
const jL = { show: true, x: true, y: true, lock: false, move: KL, points: { one: false, show: VL, size: zL, width: 0, stroke: $L, fill: WL }, bind: { mousedown: rc, mouseup: rc, click: rc, dblclick: rc, mousemove: Ah, mouseleave: Ah, mouseenter: Ah }, drag: { setScale: true, x: true, y: false, dist: 0, uni: null, click: (n, e) => {
  e.stopPropagation(), e.stopImmediatePropagation();
}, _x: false, _y: false }, focus: { dist: (n, e, t, i, r) => i - r, prox: -1, bias: 0 }, hover: { skip: [void 0], prox: null, bias: 0 }, left: -10, top: -10, idx: null, dataIdx: null, idxs: null, event: null }, Mw = { show: true, stroke: "rgba(0,0,0,0.07)", width: 2 }, vp = $t({}, Mw, { filter: hw }), Aw = $t({}, vp, { size: 10 }), Tw = $t({}, Mw, { show: false }), bp = '12px system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"', Ew = "bold " + bp, Ow = 1.5, v0 = { show: true, scale: "x", stroke: cp, space: 50, gap: 5, alignTo: 1, size: 50, labelGap: 0, labelSize: 30, labelFont: Ew, side: 2, grid: vp, ticks: Aw, border: Tw, font: bp, lineGap: Ow, rotate: 0 }, qL = "Value", UL = "Time", b0 = { show: true, scale: "x", auto: false, sorted: 1, min: ht, max: -ht, idxs: [] };
function GL(n, e, t, i, r) {
  return e.map((s) => s == null ? "" : pp(s));
}
function YL(n, e, t, i, r, s, o) {
  let l = [], a = ss.get(r) || 0;
  t = o ? t : ut(Sf(t, r), a);
  for (let f = t; f <= i; f = ut(f + r, a)) l.push(Object.is(f, -0) ? 0 : f);
  return l;
}
function Xu(n, e, t, i, r, s, o) {
  const l = [], a = n.scales[n.axes[e].scale].log, f = a == 10 ? Cr : aw, h = ri(f(t));
  r = Eo(a, h), a == 10 && (r = Ss[_i(r, Ss)]);
  let p = t, m = r * a;
  a == 10 && (m = Ss[_i(m, Ss)]);
  do
...
function JL(n, e, t, i, r, s, o) {
  let a = n.scales[n.axes[e].scale].asinh, f = i > a ? Xu(n, e, Pn(a, t), i, r) : [a], h = i >= 0 && t <= 0 ? [0] : [];
  return (t < -a ? Xu(n, e, Pn(a, -i), -t, r) : [a]).reverse().map((m) => -m).concat(h, f);
}
const _w = /./, QL = /[12357]/, XL = /[125]/, w0 = /1/, Zu = (n, e, t, i) => n.map((r, s) => e == 4 && r == 0 || s % i == 0 && t.test(r.toExponential()[r < 0 ? 1 : 0]) ? r : null);
function ZL(n, e, t, i, r) {
  let s = n.axes[t], o = s.scale, l = n.scales[o], a = n.valToPos, f = s._space, h = a(10, o), p = a(9, o) - h >= f ? _w : a(7, o) - h >= f ? QL : a(5, o) - h >= f ? XL : w0;
  if (p == w0) {
    let m = qt(a(1, o) - h);
    if (m < f) return Zu(e.slice().reverse(), l.distr, p, ui(f / m)).reverse();
  }
  return Zu(e, l.distr, p, 1);
}
function eD(n, e, t, i, r) {
  let s = n.axes[t], o = s.scale, l = s._space, a = n.valToPos, f = qt(a(1, o) - a(2, o));
  return f < l ? Zu(e.slice().reverse(), 3, _w, ui(l / f)).reverse() : e;
}
function tD(n, e, t, i) {
  return i == null ? fp : e == null ? "" : pp(e);
}
const x0 = { show: true, scale: "y", stroke: cp, space: 30, gap: 5, alignTo: 1, size: 50, labelGap: 0, labelSize: 30, labelFont: Ew, side: 3, grid: vp, ticks: Aw, border: Tw, font: bp, lineGap: Ow, rotate: 0 };
function nD(n, e) {
  let t = 3 + (n || 1) * 2;
  return ut(t * e, 3);
}
...
const S0 = { scale: null, auto: true, sorted: 0, min: ht, max: -ht }, Lw = (n, e, t, i, r) => r, k0 = { show: true, auto: true, sorted: 0, gaps: Lw, alpha: 1, facets: [$t({}, S0, { scale: "x" }), $t({}, S0, { scale: "y" })] }, C0 = { scale: "y", auto: true, sorted: 0, show: true, spanGaps: false, gaps: Lw, alpha: 1, points: { show: iD, filter: null }, values: null, min: ht, max: -ht, idxs: [], path: null, clip: null };
function rD(n, e, t, i, r) {
  return t / 10;
}
const Dw = { time: O2, auto: true, distr: 1, log: 10, asinh: 1, min: null, max: null, dir: 1, ori: 0 }, sD = $t({}, Dw, { time: false, ori: 1 }), M0 = {};
function Rw(n, e) {
  let t = M0[n];
...
function js(n, e, t) {
  ...
  return h.ori == 0 ? t(r, a, f, h, p, A, _, m, b, S, M, Mf, Wo, Tf, Bw, Nw) : t(r, a, f, h, p, _, A, b, m, M, S, Af, $o, Sp, Iw, Fw);
}
function wp(n, e) {
  let t = 0, i = 0, r = Ue(n.bands, gp);
  for (let s = 0; s < r.length; s++) {
    let o = r[s];
...
function A0(n) {
  return n == 0 ? fw : n == 1 ? jt : (e) => xs(e, n);
}
function Pw(n) {
  let e = n == 0 ? Mf : Af, t = n == 0 ? (r, s, o, l, a, f) => {
    r.arcTo(s, o, l, a, f);
  } : (r, s, o, l, a, f) => {
    r.arcTo(o, s, a, l, f);
  }, i = n == 0 ? (r, s, o, l, a) => {
...
const Mf = (n, e, t) => {
  ...
  n.lineTo(t, e);
}, Tf = Pw(0), Sp = Pw(1), Bw = (n, e, t, i, r, s) => {
  n.arc(e, t, i, r, s);
}, Iw = (n, e, t, i, r, s) => {
  n.arc(t, e, i, r, s);
}, Nw = (n, e, t, i, r, s, o) => {
...
function Hw(n) {
  return (e, t, i, r, s) => js(e, t, (o, l, a, f, h, p, m, b, S, M, A) => {
    ...
    Tf(oe, re - K, q - K, Z + K * 2, J + K * 2);
    const se = (ie) => {
      if (a[ie] != null) {
        let ke = _(p(l[ie], f, M, b)), ae = _(m(a[ie], h, A, S));
        N(ee, ke + H, ae), B(ee, ke, ae, H, 0, Sc * 2);
      }
    };
    if (s) s.forEach(se);
    else for (let ie = i; ie <= r; ie++) se(ie);
    return { stroke: W > 0 ? ee : null, fill: ee, clip: oe, flags: Lo | ed };
  });
}
function Vw(n) {
  return (e, t, i, r, s, o) => {
...
function Ww(n) {
  ...
  return (t, i, r, s) => js(t, i, (o, l, a, f, h, p, m, b, S, M, A) => {
    ...
    if (!o.spanGaps) {
      let J = [];
      oe && J.push(...xp(l, a, r, s, H, R, e)), K.gaps = J = o.gaps(t, i, r, s, J), K.clip = Cf(J, f.ori, b, S, M, A);
    }
...
function hD(n) {
  ...
  return (b, S, M, A) => js(b, S, (_, R, N, B, W, H, K, ee, oe, re, q) => {
    ...
    let Me = B.ori == 0 ? Tf : Sp, Le = B.ori == 0 ? h : (de, nt, dt, Lr, Ct, kn, it) => {
      h(de, nt, dt, Ct, Lr, it, kn);
    }, ye = Ue(b.bands, gp).find((de) => de.series[0] == S), fe = ye != null ? ye.dir : 0, Ke = _.fillTo(b, S, _.min, _.max, fe), De = Z(K(Ke, W, q, oe)), Ge, Ne, wn, xn = re, Xe = Z(_.width * Je), fn = false, oi = null, Sn = null, ki = null, mt = null;
    ...
    if (_r != null && hn != null) {
      ...
      hn.unit == 2 ? Ne = de[0] * re : Ne = H(de[0], B, re, ee) - H(0, B, re, ee), xn = T0(R, N, H, B, re, ee, xn), wn = xn - Ne + se;
    } else xn = T0(R, N, H, B, re, ee, xn), wn = xn * o + se, Ne = xn - wn;
    wn < 1 && (wn = 0), Xe >= Ne / 2 && (Xe = 0), wn < 5 && (Z = fw);
    let qs = wn > 0, dr = xn - wn - (qs ? Xe : 0);
    Ne = Z(Qu(dr, ke, ie)), Ge = (J == 0 ? Ne / 2 : J == Te ? 0 : Ne) - J * Te * ((J == 0 ? se / 2 : 0) + (qs ? Xe / 2 : 0));
...
function uD(n, e) {
  ...
  return (i, r, s, o) => js(i, r, (l, a, f, h, p, m, b, S, M, A, _) => {
    ...
    h.ori == 0 ? (W = Mf, K = Wo, H = Nw) : (W = Af, K = $o, H = Fw);
    ...
    if (!l.spanGaps) {
      let ae = [];
      ae.push(...xp(a, f, s, o, ee, N, t)), J.gaps = ae = l.gaps(i, r, s, o, ae), J.clip = Cf(ae, h.ori, S, M, A, _);
    }
...
function E0() {
  for (let n of td) n.syncRect(true);
}
Vo && (Bs(G2, yo, E0), Bs(Y2, yo, E0, true), Bs(Qc, yo, () => {
  yn.pxRatio = Je;
}));
const gD = Ww(), mD = Hw();
function O0(n, e, t, i) {
  return (i ? [n[0], n[1]].concat(n.slice(2)) : [n[0]].concat(n.slice(1))).map((s, o) => nd(s, o, e, t));
}
function yD(n, e) {
...
const vD = $w;
function bD(n, e, t) {
  return e == null ? Oo : Xc(e, t, dp, true);
}
function zw(n, e, t, i) {
  return e == null ? Oo : xf(e, t, n.scales[i].log, false);
}
const wD = zw;
function Kw(n, e, t, i) {
  return e == null ? Oo : up(e, t, n.scales[i].log, false);
}
const xD = Kw;
function SD(n, e, t, i, r) {
  let s = Pn(l0(n), l0(e)), o = e - n, l = _i(r / i * o, t);
  do {
    let a = t[l], f = i * a / o;
...
function yn(n, e, t) {
  ...
  function s(w, x, E, O) {
    let P = x.valToPct(w);
    return O + E * (x.dir == -1 ? 1 - P : P);
  }
  function o(w, x, E, O) {
    let P = x.valToPct(w);
    return O + E * (x.dir == -1 ? P : 1 - P);
  }
  function l(w, x, E, O) {
    return x.ori == 0 ? s(w, x, E, O) : o(w, x, E, O);
  }
  i.valToPosH = s, i.valToPosV = o;
  let a = false;
  i.status = 0;
  const f = i.root = fi(_2);
  if (n.id != null && (f.id = n.id), ti(f, n.class), n.title) {
    let w = fi(R2, f);
    w.textContent = n.title;
  }
  const h = Oi("canvas"), p = i.ctx = h.getContext("2d"), m = fi(P2, f);
  Bs("click", m, (w) => {
    w.target === S && (rt != Fr || at != vr) && Ft.click(i, w);
  }, true);
  const b = i.under = fi(B2, m);
  m.appendChild(h);
  const S = i.over = fi(I2, m);
  n = _o(n);
  const M = +Ue(n.pxAlign, 1), A = A0(M);
  (n.plugins || []).forEach((w) => {
    w.opts && (n = w.opts(i, n) || n);
  });
  const _ = n.ms || 1e-3, R = i.series = r == 1 ? O0(n.series || [], b0, C0, false) : yD(n.series || [null], k0), N = i.axes = O0(n.axes || [], v0, x0, true), B = i.scales = {}, W = i.bands = n.bands || [];
  W.forEach((w) => {
    w.fill = He(w.fill || null), w.dir = Ue(w.dir, -1);
  });
  const H = r == 2 ? R[1].facets[0].scale : R[0].scale, K = { axes: Pf, series: Yn }, ee = (n.drawOrder || ["axes", "series"]).map((w) => K[w]);
  function oe(w) {
    const x = w.distr == 3 ? (E) => Cr(E > 0 ? E : w.clamp(i, E, w.min, w.max, w.key)) : w.distr == 4 ? (E) => kh(E, w.asinh) : w.distr == 100 ? (E) => w.fwd(E) : (E) => E;
    return (E) => {
      let O = x(E), { _min: P, _max: z } = w, G = z - P;
      return (O - P) / G;
    };
  }
  function re(w) {
    let x = B[w];
    if (x == null) {
      let E = (n.scales || Hl)[w] || Hl;
      if (E.from != null) {
        re(E.from);
        let O = $t({}, B[E.from], E, { key: w });
        O.valToPct = oe(O), B[w] = O;
      } else {
        x = B[w] = $t({}, w == H ? Dw : sD, E), x.key = w;
        let O = x.time, P = x.range, z = $r(P);
        if ((w != H || r == 2 && !O) && (z && (P[0] == null || P[1] == null) && (P = { min: P[0] == null ? r0 : { mode: 1, hard: P[0], soft: P[0] }, max: P[1] == null ? r0 : { mode: 1, hard: P[1], soft: P[1] } }, z = false), !z && kf(P))) {
          let G = P;
          P = (Q, ne, pe) => ne == null ? Oo : Xc(ne, pe, G);
        }
        x.range = He(P || (O ? vD : w == H ? x.distr == 3 ? wD : x.distr == 4 ? xD : $w : x.distr == 3 ? zw : x.distr == 4 ? Kw : bD)), x.auto = He(z ? false : x.auto), x.clamp = He(x.clamp || rD), x._min = x._max = null, x.valToPct = oe(x);
      }
    }
  }
  ...
  let J, se;
  q.ori == 0 ? (ti(f, L2), J = s, se = o) : (ti(f, D2), J = o, se = s);
  const ie = {};
  for (let w in B) {
    let x = B[w];
    (x.min != null || x.max != null) && (ie[w] = { min: x.min, max: x.max }, x.min = x.max = null);
  }
  const ke = n.tzDate || ((w) => new Date(jt(w / _))), ae = n.fmtDate || mp, te = _ == 1 ? LL(ke) : PL(ke), Te = g0(ke, p0(_ == 1 ? _L : RL, ae)), Me = y0(ke, m0(IL, ae)), Le = [], ye = i.legend = $t({}, HL, n.legend), fe = i.cursor = $t({}, jL, { drag: { y: r == 2 } }, n.cursor), Ke = ye.show, De = fe.show, Ge = ye.markers;
  ...
  if (ye.live) {
    ...
    for (let x in oi) ki[x] = fp;
  }
  if (Ke) if (Ne = Oi("table", $2, f), xn = Oi("tbody", null, Ne), ye.mount(i, Ne), Sn) {
    wn = Oi("thead", null, Ne, xn);
    let w = Oi("tr", null, wn);
    Oi("th", null, w);
    for (var mt in oi) Oi("th", jm, w).textContent = mt;
  } else ti(Ne, K2), ye.live && ti(Ne, z2);
  const _r = { show: true }, hn = { show: false };
  function qs(w, x) {
    if (x == 0 && (Sn || !ye.live || r == 2)) return Oo;
    let E = [], O = Oi("tr", j2, xn, xn.childNodes[x]);
    ...
    for (var G in oi) {
      let Q = Oi("td", U2, O);
      Q.textContent = "--", E.push(Q);
    }
    return [O, E];
  }
  const dr = /* @__PURE__ */ new Map();
  function Qt(w, x, E, O = true) {
    const P = dr.get(x) || {}, z = fe.bind[w](i, x, E, O);
    z && (Bs(w, x, P[w] = z), dr.set(x, P));
  }
  function Fn(w, x, E) {
    const O = dr.get(x) || {};
    for (let P in O) (w == null || P == w) && (Ju(P, x, O[P]), delete O[P]);
    w == null && dr.delete(x);
  }
  ...
  function Bt(w, x, E) {
    (E || w != i.width || x != i.height) && Us(w, x), ji(false), tt = true, tn = true, Lt();
  }
  function Us(w, x) {
    i.width = Pt = Re = w, i.height = pr = de = x, nt = dt = 0, pa(), _f();
    let E = i.bbox;
    Cn = E.left = xs(nt * Je, 0.5), Hn = E.top = xs(dt * Je, 0.5), un = E.width = xs(Re * Je, 0.5), Vn = E.height = xs(de * Je, 0.5);
  }
  const Ef = 3;
  function Of() {
    let w = false, x = 0;
    for (; !w; ) {
      x++;
      let E = Rf(x), O = Br(x);
      w = x == Ef || E && O, w || (Us(i.width, i.height), tn = true);
    }
  }
  function da({ width: w, height: x }) {
    Bt(w, x);
  }
  i.setSize = da;
  function pa() {
    let w = false, x = false, E = false, O = false;
    N.forEach((P, z) => {
      if (P.show && P._show) {
        let { side: G, _size: Q } = P, ne = G % 2, pe = P.label != null ? P.labelSize : 0, ge = Q + pe;
        ge > 0 && (ne ? (Re -= ge, G == 3 ? (nt += ge, O = true) : E = true) : (de -= ge, G == 0 ? (dt += ge, w = true) : x = true));
      }
    }), $i[0] = w, $i[1] = E, $i[2] = x, $i[3] = O, Re -= zi[1] + zi[3], nt += zi[3], de -= zi[2] + zi[0], dt += zi[0];
  }
  function _f() {
    let w = nt + Re, x = dt + de, E = nt, O = dt;
    function P(z, G) {
      switch (z) {
        case 1:
          return w += G, w - G;
  ...
  if (fe.dataIdx == null) {
    ...
    x.add(void 0);
    let E = w.prox = He(w.prox), O = w.bias ?? (w.bias = 0);
    fe.dataIdx = (P, z, G, Q) => {
      if (z == 0) return G;
      let ne = G, pe = E(P, z, G, Q) ?? ht, ge = pe >= 0 && pe < ht, me = q.ori == 0 ? Re : de, Oe = fe.left, Ye = e[0], qe = e[z];
      if (x.has(qe[G])) {
        ne = null;
        ...
        if (Fe != null || Ae != null) if (ge) {
          let vt = Fe == null ? -1 / 0 : J(Ye[Fe], q, me, 0), Et = Ae == null ? 1 / 0 : J(Ye[Ae], q, me, 0), Zt = Oe - vt, ot = Et - Oe;
          Zt <= ot ? Zt <= pe && (ne = Fe) : ot <= pe && (ne = Ae);
        } else ne = Ae == null ? Fe : Fe == null ? Ae : G - Fe <= Ae - G ? Fe : Ae;
      } else ge && qt(Oe - J(Ye[G], q, me, 0)) > pe && (ne = null);
      return ne;
    };
  }
  const gr = (w) => {
  ...
  function ga(w, x) {
    let E = Kt.show(i, x);
    if (E instanceof HTMLElement) return ti(E, W2), ti(E, w.class), Xi(E, -10, -10, Re, de), S.insertBefore(E, Wn[x]), E;
  }
  function Un(w, x) {
    if (r == 1 || x > 0) {
      let E = r == 1 && B[w.scale].time, O = w.value;
      w.value = E ? f0(O) ? y0(ke, m0(O, ae)) : O || Me : O || tD, w.label = w.label || (E ? UL : qL);
    }
    if (Wi || x > 0) {
      w.width = w.width == null ? 1 : w.width, w.paths = w.paths || gD || sL, w.fillTo = He(w.fillTo || oD), w.pxAlign = +Ue(w.pxAlign, M), w.pxRound = A0(w.pxAlign), w.stroke = He(w.stroke || null), w.fill = He(w.fill || null), w._stroke = w._fill = w._paths = w._focus = null;
      let E = nD(Pn(1, w.width), 1), O = w.points = $t({}, { size: E, width: Pn(1, E * 0.2), stroke: w.stroke, space: E * 2, paths: mD, _stroke: null, _fill: null }, w.points);
      O.show = He(O.show), O.filter = He(O.filter), O.fill = He(O.fill), O.stroke = He(O.stroke), O.paths = He(O.paths), O.pxAlign = w.pxAlign;
    }
    if (Ke) {
      let E = qs(w, x);
      Xe.splice(x, 0, E[0]), fn.splice(x, 0, E[1]), ye.values.push(null);
    }
    if (De) {
      Le.splice(x, 0, null);
      let E = null;
      Wi ? x == 0 && (E = ga(w, x)) : x > 0 && (E = ga(w, x)), Wn.splice(x, 0, E), nn.splice(x, 0, 0), Dr.splice(x, 0, 0);
    }
    Xt("addSeries", x);
  }
  function zo(w, x) {
    x = x ?? R.length, w = r == 1 ? nd(w, x, b0, C0) : nd(w, x, {}, k0), R.splice(x, 0, w), Un(R[x], x);
  }
  i.addSeries = zo;
  function Lf(w) {
    if (R.splice(w, 1), Ke) {
  ...
  function ma(w, x) {
    if (w._show = w.show, w.show) {
      let E = w.side % 2, O = B[w.scale];
      O == null && (w.scale = E ? R[1].scale : H, O = B[w.scale]);
      let P = O.time;
      w.size = He(w.size), w.space = He(w.space), w.rotate = He(w.rotate), $r(w.incrs) && w.incrs.forEach((G) => {
        !ss.has(G) && ss.set(G, dw(G));
      }), w.incrs = He(w.incrs || (O.distr == 2 ? TL : P ? _ == 1 ? OL : DL : Ss)), w.splits = He(w.splits || (P && O.distr == 1 ? te : O.distr == 3 ? Xu : O.distr == 4 ? JL : YL)), w.stroke = He(w.stroke), w.grid.stroke = He(w.grid.stroke), w.ticks.stroke = He(w.ticks.stroke), w.border.stroke = He(w.border.stroke);
      let z = w.values;
      w.values = $r(z) && !$r(z[0]) ? He(z) : P ? $r(z) ? g0(ke, p0(z, ae)) : f0(z) ? BL(ke, z) : z || Te : z || GL, w.filter = He(w.filter || (O.distr >= 3 && O.log == 10 ? ZL : O.distr == 3 && O.log == 2 ? eD : hw)), w.font = _0(w.font), w.labelFont = _0(w.labelFont), w._size = w.size(i, null, x, 0), w._space = w._rotate = w._incrs = w._found = w._splits = w._values = null, w._size > 0 && ($i[x] = true, w._el = fi(N2, m));
    }
  }
  function cs(w, x, E, O) {
    let [P, z, G, Q] = E, ne = x % 2, pe = 0;
    return ne == 0 && (Q || z) && (pe = x == 0 && !P || x == 2 && !G ? jt(v0.size / 3) : 0), ne == 1 && (P || G) && (pe = x == 1 && !z || x == 3 && !Q ? jt(x0.size / 2) : 0), pe;
  }
  ...
  function ya(w, x) {
    if (e = w ?? [], i.data = i._data = e, r == 2) {
      It = 0;
      for (let E = 1; E < R.length; E++) It += e[E][0].length;
    } else {
    ...
    if (ji(true), Xt("setData"), Z == 2 && (tt = true), x !== false) {
      let E = q;
      E.auto(i, An) ? Gs() : y(H, E.min, E.max), Mt = Mt || fe.left >= 0, Mn = true, Lt();
    }
  }
  i.setData = ya;
  function Gs() {
    An = true;
    let w, x;
    r == 1 && (It > 0 ? (Nt = Rr[0] = 0, _t = Rr[1] = It - 1, w = e[0][Nt], x = e[0][_t], Z == 2 ? (w = Nt, x = _t) : w == x && (Z == 3 ? [w, x] = xf(w, w, q.log, false) : Z == 4 ? [w, x] = up(w, w, q.log, false) : q.time ? x = w + jt(86400 / _) : [w, x] = Xc(w, x, dp, true))) : (Nt = Rr[0] = w = null, _t = Rr[1] = x = null)), y(H, w, x);
  }
  let fs, Pr, Ys, jo, qo, Tn, Uo, Go, Js, rn;
  function va(w, x, E, O, P, z) {
    w ?? (w = Um), E ?? (E = gp), O ?? (O = "butt"), P ?? (P = Um), z ?? (z = "round"), w != fs && (p.strokeStyle = fs = w), P != Pr && (p.fillStyle = Pr = P), x != Ys && (p.lineWidth = Ys = x), z != qo && (p.lineJoin = qo = z), O != Tn && (p.lineCap = Tn = O), E != jo && p.setLineDash(jo = E);
  }
  function Yo(w, x, E, O) {
    x != Pr && (p.fillStyle = Pr = x), w != Uo && (p.font = Uo = w), E != Go && (p.textAlign = Go = E), O != Js && (p.textBaseline = Js = O);
  }
  function Jo(w, x, E, O, P = 0) {
    if (O.length > 0 && w.auto(i, An) && (x == null || x.min == null)) {
      let z = Ue(Nt, 0), G = Ue(_t, O.length - 1), Q = E.min == null ? Z2(O, z, G, P, w.distr == 3) : [E.min, E.max];
      w.min = Li(w.min, E.min = Q[0]), w.max = Pn(w.max, E.max = Q[1]);
    }
  }
  ...
  function Df() {
    ...
    if (It > 0) {
      R.forEach((O, P) => {
        if (r == 1) {
          ...
          let [z, G] = O.facets, Q = z.scale, ne = G.scale, [pe, ge] = e[P], me = w[Q], Oe = w[ne];
          me != null && Jo(me, ie[Q], z, pe, z.sorted), Oe != null && Jo(Oe, ie[ne], G, ge, G.sorted), O.min = G.min, O.max = G.max;
        }
      });
      for (let O in w) {
        let P = w[O], z = ie[O];
    ...
    for (let O in w) {
      ...
      if (z.min != P.min || z.max != P.max) {
        ...
        let G = z.distr;
        z._min = G == 3 ? Cr(z.min) : G == 4 ? kh(z.min, z.asinh) : G == 100 ? z.fwd(z.min) : z.min, z._max = G == 3 ? Cr(z.max) : G == 4 ? kh(z.max, z.asinh) : G == 100 ? z.fwd(z.max) : z.max, x[O] = E = true;
      }
    }
    if (E) {
      R.forEach((O, P) => {
  ...
  function ba(w) {
    let x = Qu(Nt - 1, 0, It - 1), E = Qu(_t + 1, 0, It - 1);
    for (; w[x] == null && x > 0; ) x--;
    for (; w[E] == null && E < It - 1; ) E++;
    return [x, E];
  }
  function Yn() {
    if (It > 0) {
      let w = R.some((x) => x._focus) && rn != li.alpha;
      w && (p.globalAlpha = rn = li.alpha), R.forEach((x, E) => {
        if (E > 0 && x.show && (Ve(E, false), Ve(E, true), x._paths == null)) {
          let O = rn;
          rn != x.alpha && (p.globalAlpha = rn = x.alpha);
          let P = r == 2 ? [0, e[E][0].length - 1] : ba(e[E]);
          x._paths = x.paths(i, E, P[0], P[1]), rn != O && (p.globalAlpha = rn = O);
        }
      }), R.forEach((x, E) => {
        if (E > 0 && x.show) {
          let O = rn;
          rn != x.alpha && (p.globalAlpha = rn = x.alpha), x._paths != null && wa(E, false);
          {
            let P = x._paths != null ? x._paths.gaps : null, z = x.points.show(i, E, Nt, _t, P), G = x.points.filter(i, E, z, P);
            (z || G) && (x.points._paths = x.points.paths(i, E, Nt, _t, G), wa(E, true));
          }
          rn != O && (p.globalAlpha = rn = O), Xt("drawSeries", E);
        }
      }), w && (p.globalAlpha = rn = 1);
    }
  }
  function Ve(w, x) {
    let E = x ? R[w].points : R[w];
    E._stroke = E.stroke(i, w), E._fill = E.fill(i, w);
  }
  function wa(w, x) {
    let E = x ? R[w].points : R[w], { stroke: O, fill: P, clip: z, flags: G, _stroke: Q = E._stroke, _fill: ne = E._fill, _width: pe = E.width } = E._paths;
    pe = ut(pe * Je, 3);
    let ge = null, me = pe % 2 / 2;
    x && ne == null && (ne = pe > 0 ? "#fff" : Q);
    let Oe = E.pxAlign == 1 && me > 0;
    if (Oe && p.translate(me, me), !x) {
      let Ye = Cn - pe / 2, qe = Hn - pe / 2, Fe = un + pe, Ae = Vn + pe;
      ge = new Path2D(), ge.rect(Ye, qe, Fe, Ae);
    }
    x ? mr(Q, pe, E.dash, E.cap, ne, O, P, G, z) : Qs(w, Q, pe, E.dash, E.cap, ne, O, P, G, ge, z), Oe && p.translate(-me, -me);
  }
  function Qs(w, x, E, O, P, z, G, Q, ne, pe, ge) {
    let me = false;
    ne != 0 && W.forEach((Oe, Ye) => {
      if (Oe.series[0] == w) {
        let qe = R[Oe.series[1]], Fe = e[Oe.series[1]], Ae = (qe._paths || Hl).band;
        $r(Ae) && (Ae = Oe.dir == 1 ? Ae[0] : Ae[1]);
        let xe, vt = null;
        qe.show && Ae && tL(Fe, Nt, _t) ? (vt = Oe.fill(i, Ye) || z, xe = qe._paths.clip) : Ae = null, mr(x, E, O, P, vt, G, Q, ne, pe, ge, xe, Ae), me = true;
      }
    }), me || mr(x, E, O, P, z, G, Q, ne, pe, ge);
  }
  const xa = Lo | ed;
  function mr(w, x, E, O, P, z, G, Q, ne, pe, ge, me) {
    va(w, x, E, O, P), (ne || pe || me) && (p.save(), ne && p.clip(ne), pe && p.clip(pe)), me ? (Q & xa) == xa ? (p.clip(me), ge && p.clip(ge), Ki(P, G), Xs(w, z, x)) : Q & ed ? (Ki(P, G), p.clip(me), Xs(w, z, x)) : Q & Lo && (p.save(), p.clip(me), ge && p.clip(ge), Ki(P, G), p.restore(), Xs(w, z, x)) : (Ki(P, G), Xs(w, z, x)), (ne || pe || me) && p.restore();
  }
  function Xs(w, x, E) {
    E > 0 && (x instanceof Map ? x.forEach((O, P) => {
      p.strokeStyle = fs = P, p.stroke(O);
    }) : x != null && w && p.stroke(x));
  }
  function Ki(w, x) {
    x instanceof Map ? x.forEach((E, O) => {
      p.fillStyle = Pr = O, p.fill(E);
    }) : x != null && w && p.fill(x);
  }
  function Xo(w, x, E, O) {
    let P = N[w], z;
    if (O <= 0) z = [0, 0];
      ...
      let G = P._space = P.space(i, w, x, E, O), Q = P._incrs = P.incrs(i, w, x, E, O, G);
      z = SD(x, E, Q, O, G);
    }
    return P._found = z;
  }
  function Zs(w, x, E, O, P, z, G, Q, ne, pe) {
    let ge = G % 2 / 2;
    M == 1 && p.translate(ge, ge), va(Q, G, ne, pe, Q), p.beginPath();
    let me, Oe, Ye, qe, Fe = P + (O == 0 || O == 3 ? -z : z);
    E == 0 ? (Oe = P, qe = Fe) : (me = P, Ye = Fe);
    for (let Ae = 0; Ae < w.length; Ae++) x[Ae] != null && (E == 0 ? me = Ye = w[Ae] : Oe = qe = w[Ae], p.moveTo(me, Oe), p.lineTo(Ye, qe));
  ...
  function Rf(w) {
    ...
    return N.forEach((E, O) => {
      ...
      let P = B[E.scale];
      if (P.min == null) {
        E._show && (x = false, E._show = false, ji(false));
        return;
      } else E._show || (x = false, E._show = true, ji(false));
      let z = E.side, G = z % 2, { min: Q, max: ne } = P, [pe, ge] = Xo(O, Q, ne, G == 0 ? Re : de);
      if (ge == 0) return;
      let me = P.distr == 2, Oe = E._splits = E.splits(i, O, Q, ne, pe, ge, me), Ye = P.distr == 2 ? Oe.map((xe) => Gn[xe]) : Oe, qe = P.distr == 2 ? Gn[Oe[1]] - Gn[Oe[0]] : pe, Fe = E._values = E.values(i, E.filter(i, Ye, O, ge, qe), O, ge, qe);
      E._rotate = z == 2 ? E.rotate(i, Fe, O, ge) : 0;
      let Ae = E._size;
      E._size = ui(E.size(i, Fe, O, w)), Ae != null && E._size != Ae && (x = false);
    }), x;
  }
  function Br(w) {
    let x = true;
    return Ko.forEach((E, O) => {
      let P = E(i, O, $i, w);
  ...
  function Pf() {
    for (let w = 0; w < N.length; w++) {
      ...
      let E = x.side, O = E % 2, P, z, G = x.stroke(i, w), Q = E == 0 || E == 3 ? -1 : 1, [ne, pe] = x._found;
      if (x.label != null) {
        let _n = x.labelGap * Q, Xn = jt((x._lpos + _n) * Je);
        Yo(x.labelFont[0], G, "center", E == 2 ? dl : qm), p.save(), O == 1 ? (P = z = 0, p.translate(Xn, jt(Hn + Vn / 2)), p.rotate((E == 3 ? -Sc : Sc) / 2)) : (P = jt(Cn + un / 2), z = Xn);
        let ds = cw(x.label) ? x.label(i, w, ne, pe) : x.label;
        p.fillText(ds, P, z), p.restore();
      }
      if (pe == 0) continue;
      let ge = B[x.scale], me = O == 0 ? un : Vn, Oe = O == 0 ? Cn : Hn, Ye = x._splits, qe = ge.distr == 2 ? Ye.map((_n) => Gn[_n]) : Ye, Fe = ge.distr == 2 ? Gn[Ye[1]] - Gn[Ye[0]] : ne, Ae = x.ticks, xe = x.border, vt = Ae.show ? Ae.size : 0, Et = jt(vt * Je), Zt = jt((x.alignTo == 2 ? x._size - vt - x.gap : x.gap) * Je), ot = x._rotate * -Sc / 180, Ot = A(x._pos * Je), Jn = (Et + Zt) * Q, On = Ot + Jn;
      z = O == 0 ? On : 0, P = O == 1 ? On : 0;
      let ai = x.font[0], Ti = x.align == 1 ? ro : x.align == 2 ? wh : ot > 0 ? ro : ot < 0 ? wh : O == 0 ? "center" : E == 3 ? wh : ro, qi = ot || O == 1 ? "middle" : E == 2 ? dl : qm;
      Yo(ai, G, Ti, qi);
      let Qn = x.font[1] * x.lineGap, ci = Ye.map((_n) => A(l(_n, ge, me, Oe))), Ei = x._values;
      for (let _n = 0; _n < Ei.length; _n++) {
        let Xn = Ei[_n];
        if (Xn != null) {
...
`) == -1 ? [Xn] : Xn.split(/\n/gm);
          for (let Ln = 0; Ln < ds.length; Ln++) {
            let Lp = ds[Ln];
            ot ? (p.save(), p.translate(P, z + Ln * Qn), p.rotate(ot), p.fillText(Lp, 0, 0), p.restore()) : p.fillText(Lp, P, z + Ln * Qn);
          }
        }
      }
      Ae.show && Zs(ci, Ae.filter(i, qe, w, pe, Fe), O, E, Ot, Et, ut(Ae.width * Je, 3), Ae.stroke(i, w), Ae.dash, Ae.cap);
      let Ui = x.grid;
  ...
  function ji(w) {
    R.forEach((x, E) => {
      E > 0 && (x._paths = null, w && (r == 1 ? (x.min = null, x.max = null) : x.facets.forEach((O) => {
  ...
  function Bf(w, x = false) {
    yr = true, eo = x, w(i), Ci(), x && hs.length > 0 && queueMicrotask(Sa);
  }
  i.batch = Bf;
  function Ci() {
    if (Ze && (Df(), Ze = false), tt && (Of(), tt = false), tn) {
      if (bt(b, ro, nt), bt(b, dl, dt), bt(b, kl, Re), bt(b, Cl, de), bt(S, ro, nt), bt(S, dl, dt), bt(S, kl, Re), bt(S, Cl, de), bt(m, kl, Pt), bt(m, Cl, pr), h.width = jt(Pt * Je), h.height = jt(pr * Je), N.forEach(({ _el: w, _show: x, _size: E, _pos: O, side: P }) => {
        if (w != null) if (x) {
          let z = P === 3 || P === 0 ? E : 0, G = P % 2 == 1;
          bt(w, G ? "left" : "top", O - z), bt(w, G ? "width" : "height", E), bt(w, G ? "top" : "left", G ? dt : nt), bt(w, G ? "height" : "width", G ? de : Re), Yu(w, Ms);
        } else ti(w, Ms);
      }), fs = Pr = Ys = qo = Tn = Uo = Go = Js = jo = null, rn = 1, je(true), nt != Lr || dt != Ct || Re != kn || de != it) {
        ji(false);
        let w = Re / kn, x = de / it;
        if (De && !Mt && fe.left >= 0) {
          ...
          for (let E = 0; E < Wn.length; E++) {
            let O = Wn[E];
            O != null && (nn[E] *= w, Dr[E] *= x, Xi(O, ui(nn[E]), ui(Dr[E]), Re, de));
          }
        }
        if (c.show && !jn && c.left >= 0 && c.width > 0) {
          c.left *= w, c.width *= w, c.top *= x, c.height *= x;
          for (let E in dn) bt(u, E, c[E]);
        }
  ...
  function us(w, x) {
    ...
    if (E.from == null) {
      ...
      w == H && E.distr == 2 && It > 0 && (x.min = _i(x.min, e[0]), x.max = _i(x.max, e[0]), x.min == x.max && x.max++), ie[w] = x, Ze = true, Lt();
    }
  }
  i.setScale = us;
  let Zo, el, Ir, Nr, ka, Ca, Fr, vr, tl, nl, rt, at, Mi = false;
  const Ft = fe.drag;
  let Tt = Ft.x, Ht = Ft.y;
  De && (fe.x && (Zo = fi(H2, S)), fe.y && (el = fi(V2, S)), q.ori == 0 ? (Ir = Zo, Nr = el) : (Ir = el, Nr = Zo), rt = fe.left, at = fe.top);
  const c = i.select = $t({ show: true, over: true, left: 0, width: 0, top: 0, height: 0 }, n.select), u = c.show ? fi(F2, c.over ? S : b) : null;
  function d(w, x) {
    if (c.show) {
      for (let E in w) c[E] = w[E], E in dn && bt(u, E, w[E]);
      x !== false && Xt("setSelect");
    }
  }
  i.setSelect = d;
  function g(w) {
    if (R[w].show) Ke && Yu(Xe[w], Ms);
    else if (Ke && ti(Xe[w], Ms), De) {
      let E = Wi ? Wn[0] : Wn[w];
      E != null && Xi(E, -10, -10, Re, de);
    }
  }
  function y(w, x, E) {
    us(w, { min: x, max: E });
  ...
  function v(w, x, E, O) {
    ...
    }), E !== false && Xt("setSeries", w, x), O && il("setSeries", i, w, x);
  }
  i.setSeries = v;
  function k(w, x) {
    $t(W[w], x);
  ...
  i.addBand = C, i.setBand = k, i.delBand = T;
  function D(w, x) {
  ...
  function I(w) {
    if (w != V) {
      let x = w == null, E = li.alpha != 1;
      R.forEach((O, P) => {
        if (r == 1 || P > 0) {
          let z = x || P == 0 || P == w;
          O._focus = x ? null : z, E && D(P, z ? 1 : li.alpha);
        }
      }), V = w, E && Lt();
    }
  }
  ...
  function Y(w, x, E) {
    let O = B[x];
    E && (w = w / Je - (O.ori == 1 ? dt : nt));
    let P = Re;
    O.ori == 1 && (P = de, w = P - w), O.dir == -1 && (w = P - w);
    let z = O._min, G = O._max, Q = w / P, ne = z + (G - z) * Q, pe = O.distr;
    return pe == 3 ? Eo(10, ne) : pe == 4 ? iL(ne, O.asinh) : pe == 100 ? O.bwd(ne) : ne;
  }
  function X(w, x) {
    let E = Y(w, H, x);
    return _i(E, e[0], Nt, _t);
  }
  i.valToIdx = (w) => _i(w, e[0]), i.posToIdx = X, i.posToVal = Y, i.valToPos = (w, x, E) => B[x].ori == 0 ? s(w, B[x], E ? un : Re, E ? Cn : 0) : o(w, B[x], E ? Vn : de, E ? Hn : 0), i.setCursor = (w, x, E) => {
    rt = w.left, at = w.top, Be(null, x, E);
  };
  function we(w, x) {
    bt(u, ro, c.left = w), bt(u, kl, c.width = x);
  }
  function ce(w, x) {
    bt(u, dl, c.top = w), bt(u, Cl, c.height = x);
  }
  let Ce = q.ori == 0 ? we : ce, Ee = q.ori == 1 ? we : ce;
  function Pe() {
    if (Ke && ye.live) for (let w = r == 2 ? 1 : 0; w < R.length; w++) {
      if (w == 0 && Sn) continue;
      let x = ye.values[w], E = 0;
      for (let O in x) fn[w][E++].firstChild.nodeValue = x[O];
    }
  }
  function st(w, x) {
    if (w != null && (w.idxs ? w.idxs.forEach((E, O) => {
      Le[O] = E;
    }) : lL(w.idx) || Le.fill(w.idx), ye.idx = Le[0]), Ke && ye.live) {
      for (let E = 0; E < R.length; E++) (E > 0 || r == 1 && !Sn) && yt(E, Le[E]);
      Pe();
    }
  ...
  i.setLegend = st;
  function yt(w, x) {
    let E = R[w], O = w == 0 && Z == 2 ? Gn : e[w], P;
    Sn ? P = E.values(i, w, x) ?? ki : (P = E.value(i, x == null ? null : O[x], w, x), P = P == null ? ki : { _: P }), ye.values[w] = P;
  }
  function Be(w, x, E) {
    ...
    if (rt < 0 || It == 0 || P) {
      ...
      let ge = -10, me = -10, Oe = 0, Ye = 0, qe = true, Fe = "", Ae = "";
      for (let xe = r == 2 ? 1 : 0; xe < R.length; xe++) {
        let vt = R[xe], Et = Le[xe], Zt = Et == null ? null : r == 1 ? e[xe][Et] : e[xe][1][Et], ot = fe.dataIdx(i, xe, O, ne), Ot = ot == null ? null : r == 1 ? e[xe][ot] : e[xe][1][ot];
        if (Mn = Mn || Ot != Zt || ot != Et, Le[xe] = ot, xe > 0 && vt.show) {
          let Jn = ot == null ? -10 : ot == O ? pe : J(r == 1 ? e[0][ot] : e[xe][0][ot], q, z, 0), On = Ot == null ? -10 : se(Ot, r == 1 ? B[vt.scale] : B[vt.facets[1].scale], G, 0);
          if (qn && Ot != null) {
            let ai = q.ori == 1 ? rt : at, Ti = qt(li.dist(i, xe, ot, On, ai));
            if (Ti < L) {
              let qi = li.bias;
              if (qi != 0) {
                let Qn = Y(ai, vt.scale), ci = Ot >= 0 ? 1 : -1, Ei = Qn >= 0 ? 1 : -1;
                Ei == ci && (Ei == 1 ? qi == 1 ? Ot >= Qn : Ot <= Qn : qi == 1 ? Ot <= Qn : Ot >= Qn) && (L = Ti, F = xe);
              } else L = Ti, F = xe;
            }
          }
          if (Mn || Wi) {
            let ai, Ti;
            q.ori == 0 ? (ai = Jn, Ti = On) : (ai = On, Ti = Jn);
            let qi, Qn, ci, Ei, Ui, _n, Xn = true, ds = Kt.bbox;
            if (ds != null) {
              Xn = false;
              let Ln = ds(i, xe);
              ci = Ln.left, Ei = Ln.top, qi = Ln.width, Qn = Ln.height;
            } else ci = ai, Ei = Ti, qi = Qn = Kt.size(i, xe);
            if (_n = Kt.fill(i, xe), Ui = Kt.stroke(i, xe), Wi) xe == F && L <= li.prox && (ge = ci, me = Ei, Oe = qi, Ye = Qn, qe = Xn, Fe = _n, Ae = Ui);
            else {
              let Ln = Wn[xe];
              Ln != null && (nn[xe] = ci, Dr[xe] = Ei, i0(Ln, qi, Qn, Xn), t0(Ln, _n, Ui), Xi(Ln, ui(ci), ui(Ei), Re, de));
            }
          }
        }
      }
      if (Wi) {
        ...
        if (Mn || vt) {
          let Et = Wn[0];
          Et != null && (nn[0] = ge, Dr[0] = me, i0(Et, Oe, Ye, qe), t0(Et, Fe, Ae), Xi(Et, ui(ge), ui(me), Re, de));
        }
      }
    }
    if (c.show && Mi) if (w != null) {
      let [Q, ne] = Vt.scales, [pe, ge] = Vt.match, [me, Oe] = w.cursor.sync.scales, Ye = w.cursor.drag;
      if (Tt = Ye._x, Ht = Ye._y, Tt || Ht) {
        let { left: qe, top: Fe, width: Ae, height: xe } = w.select, vt = w.scales[me].ori, Et = w.posToVal, Zt, ot, Ot, Jn, On, ai = Q != null && pe(Q, me), Ti = ne != null && ge(ne, Oe);
        ai && Tt ? (vt == 0 ? (Zt = qe, ot = Ae) : (Zt = Fe, ot = xe), Ot = B[Q], Jn = J(Et(Zt, me), Ot, z, 0), On = J(Et(Zt + ot, me), Ot, z, 0), Ce(Li(Jn, On), qt(On - Jn))) : Ce(0, z), Ti && Ht ? (vt == 1 ? (Zt = qe, ot = Ae) : (Zt = Fe, ot = xe), Ot = B[ne], Jn = se(Et(Zt, Oe), Ot, G, 0), On = se(Et(Zt + ot, Oe), Ot, G, 0), Ee(Li(Jn, On), qt(On - Jn))) : Ee(0, G);
      } else Ai();
    } else {
      let Q = qt(tl - ka), ne = qt(nl - Ca);
      if (q.ori == 1) {
        let Oe = Q;
        Q = ne, ne = Oe;
      }
      Tt = Ft.x && Q >= Ft.dist, Ht = Ft.y && ne >= Ft.dist;
      let pe = Ft.uni;
      pe != null ? Tt && Ht && (Tt = Q >= pe, Ht = ne >= pe, !Tt && !Ht && (ne > Q ? Ht = true : Tt = true)) : Ft.x && Ft.y && (Tt || Ht) && (Tt = Ht = true);
      let ge, me;
      Tt && (q.ori == 0 ? (ge = Fr, me = rt) : (ge = vr, me = at), Ce(Li(ge, me), qt(me - ge)), Ht || Ee(0, G)), Ht && (q.ori == 1 ? (ge = Fr, me = rt) : (ge = vr, me = at), Ee(Li(ge, me), qt(me - ge)), Tt || Ce(0, z)), !Tt && !Ht && (Ce(0, 0), Ee(0, 0));
    }
    if (Ft._x = Tt, Ft._y = Ht, w == null) {
      if (E) {
        if (_p != null) {
          let [Q, ne] = Vt.scales;
          Vt.values[0] = Q != null ? Y(q.ori == 0 ? rt : at, Q) : null, Vt.values[1] = ne != null ? Y(q.ori == 1 ? rt : at, ne) : null;
        }
        il(xh, i, rt, at, Re, de, O);
      }
      if (qn) {
        let Q = E && Vt.setSeries, ne = li.prox;
  ...
  function En(w, x, E, O, P, z, G) {
    fe._lock || Mi && w != null && w.movementX == 0 && w.movementY == 0 || (Dt(w, x, E, O, P, z, G, false, w != null), w != null ? Be(null, true, true) : Be(x, true, false));
  }
  function Dt(w, x, E, O, P, z, G, Q, ne) {
    if (Se == null && je(false), gr(w), w != null) E = w.clientX - Se.left, O = w.clientY - Se.top;
    else {
      if (E < 0 || O < 0) {
        rt = -10, at = -10;
        return;
      }
      let [pe, ge] = Vt.scales, me = x.cursor.sync, [Oe, Ye] = me.values, [qe, Fe] = me.scales, [Ae, xe] = Vt.match, vt = x.axes[0].side % 2 == 1, Et = q.ori == 0 ? Re : de, Zt = q.ori == 1 ? Re : de, ot = vt ? z : P, Ot = vt ? P : z, Jn = vt ? O : E, On = vt ? E : O;
      if (qe != null ? E = Ae(pe, qe) ? l(Oe, B[pe], Et, 0) : -10 : E = Et * (Jn / ot), Fe != null ? O = xe(ge, Fe) ? l(Ye, B[ge], Zt, 0) : -10 : O = Zt * (On / Ot), q.ori == 1) {
        let ai = E;
        E = O, O = ai;
      }
    }
    ne && (x == null || x.cursor.event.type == xh) && ((E <= 1 || E >= Re - 1) && (E = xs(E, Re)), (O <= 1 || O >= de - 1) && (O = xs(O, de))), Q ? (ka = E, Ca = O, [Fr, vr] = fe.move(i, E, O)) : (rt = E, at = O);
  }
  ...
  let Ma, to, kp, Cp;
  function Mp(w, x, E, O, P, z, G) {
    Mi = true, Tt = Ht = Ft._x = Ft._y = false, Dt(w, x, E, O, P, z, G, true, false), w != null && (Qt(Sh, Uu, Ap, false), il(Gm, i, Fr, vr, Re, de, null));
    let { left: Q, top: ne, width: pe, height: ge } = c;
    Ma = Q, to = ne, kp = pe, Cp = ge;
  }
  function Ap(w, x, E, O, P, z, G) {
    Mi = Ft._x = Ft._y = false, Dt(w, x, E, O, P, z, G, false, true);
    let { left: Q, top: ne, width: pe, height: ge } = c, me = pe > 0 || ge > 0, Oe = Ma != Q || to != ne || kp != pe || Cp != ge;
    if (me && Oe && d(c), Ft.setScale && me && Oe) {
      let Ye = Q, qe = pe, Fe = ne, Ae = ge;
      if (q.ori == 1 && (Ye = ne, qe = ge, Fe = Q, Ae = pe), Tt && y(H, Y(Ye, H), Y(Ye + qe, H)), Ht) for (let xe in B) {
        let vt = B[xe];
        xe != H && vt.from == null && vt.min != ht && y(xe, Y(Fe + Ae, xe), Y(Fe, xe));
      }
      Ai();
    } else fe.lock && (fe._lock = !fe._lock, Be(x, true, w != null));
    w != null && (Fn(Sh, Uu), il(Sh, i, rt, at, Re, de, null));
  }
  function Gw(w, x, E, O, P, z, G) {
    if (fe._lock) return;
    gr(w);
    let Q = Mi;
    if (Mi) {
      let ne = true, pe = true, ge = 10, me, Oe;
      q.ori == 0 ? (me = Tt, Oe = Ht) : (me = Ht, Oe = Tt), me && Oe && (ne = rt <= ge || rt >= Re - ge, pe = at <= ge || at >= de - ge), me && ne && (rt = rt < Fr ? 0 : Re), Oe && pe && (at = at < vr ? 0 : de), Be(null, true, true), Mi = false;
    }
    rt = -10, at = -10, Le.fill(null), Be(null, true, true), Q && (Mi = Q);
  }
  function Tp(w, x, E, O, P, z, G) {
    fe._lock || (gr(w), Gs(), Ai(), w != null && il(Qm, i, rt, at, Re, de, null));
  }
  function Ep() {
  ...
  Bs(Qc, yo, Ep);
  const no = {};
  no.mousedown = Mp, no.mousemove = En, no.mouseup = Ap, no.dblclick = Tp, no.setSeries = (w, x, E, O) => {
    let P = Vt.match[2];
    E = P(i, x, E), E != -1 && v(E, O, true, false);
  }, De && (Qt(Gm, S, Mp), Qt(xh, S, En), Qt(Ym, S, (w) => {
    gr(w), je(false);
  }), Qt(Jm, S, Gw), Qt(Qm, S, Tp), td.add(i), i.syncRect = je);
  const Aa = i.hooks = n.hooks || {};
  function Xt(w, x, E) {
    eo ? hs.push([w, x, E]) : w in Aa && Aa[w].forEach((O) => {
      O.call(null, i, x, E);
    });
  }
  (n.plugins || []).forEach((w) => {
    for (let x in w.hooks) Aa[x] = (Aa[x] || []).concat(w.hooks[x]);
  });
  const Op = (w, x, E) => E, Vt = $t({ key: null, setSeries: false, filters: { pub: a0, sub: a0 }, scales: [H, R[1] ? R[1].scale : null], match: [c0, c0, Op], values: [null, null] }, fe.sync);
  Vt.match.length == 2 && Vt.match.push(Op), fe.sync = Vt;
  const _p = Vt.key, If = Rw(_p);
  function il(w, x, E, O, P, z, G) {
    Vt.filters.pub(w, x, E, O, P, z, G) && If.pub(w, x, E, O, P, z, G);
  }
  If.sub(i);
  function Yw(w, x, E, O, P, z, G) {
    Vt.filters.sub(w, x, E, O, P, z, G) && no[w](null, x, E, O, P, z, G);
  }
  i.pub = Yw;
  function Jw() {
    If.unsub(i), td.delete(i), dr.clear(), Ju(Qc, yo, Ep), f.remove(), Ne == null ? void 0 : Ne.remove(), Xt("destroy");
  }
  i.destroy = Jw;
  function Nf() {
    Xt("init", n, e), ya(e || n.data, false), ie[H] ? us(H, ie[H]) : Gs(), jn = c.show && (c.width > 0 || c.height > 0), Mt = Mn = true, Bt(n.width, n.height);
  }
  return R.forEach(Un), N.forEach(ma), t ? t instanceof HTMLElement ? (t.appendChild(f), Nf()) : t(i, Nf) : Nf(), i;
}
yn.assign = $t;
yn.fmtNum = pp;
yn.rangeNum = Xc;
...
yn.pxRatio = Je;
yn.join = pL;
yn.fmtDate = mp, yn.tzDate = ML;
yn.sync = Rw;
{
  yn.addGap = lD, yn.clipGaps = Cf;
  let n = yn.paths = { points: Hw };
  n.linear = Ww, n.stepped = fD, n.bars = hD, n.spline = dD;
}
const CD = ["#2563eb", "#dc2626", "#16a34a", "#d97706", "#9333ea", "#0891b2", "#e11d48", "#65a30d"], MD = ["#60a5fa", "#f87171", "#4ade80", "#fbbf24", "#c084fc", "#22d3ee", "#fb7185", "#a3e635"];
function AD() {
...
function OD() {
  ...
  function i(s) {
    ...
    for (let b = 1; b < s.series.length; b++) {
      ...
      const M = s.data[b][o];
      if (M == null) continue;
      const A = S.stroke instanceof Function ? S.stroke(s, b) : S.stroke, _ = Number.isInteger(M) ? M.toString() : M.toFixed(2);
      l.push(`<span style="color:${A}">${ED(S.label ?? "")}</span>: ${_}`);
    }
    if (l.length === 0) {
      n.style.display = "none";
      return;
...
function _D(n, e, t) {
  var _a2;
  const i = AD(), r = e.series.length, s = ((_a2 = e.series[0]) == null ? void 0 : _a2.timestamps) ?? [], o = [new Float64Array(s), ...e.series.map((h) => new Float64Array(h.values))], l = [{ label: "Time" }, ...e.series.map((h, p) => ({ label: h.name, stroke: TD(i, p), width: 2, points: { show: r === 1 && s.length < 20 } }))], a = i ? "#2a2a2a" : "#f0f0f0", f = { width: t, height: 120, cursor: { show: true, drag: { x: false, y: false } }, legend: { show: false }, scales: { x: { time: true } }, axes: [{ show: true, stroke: i ? "#888" : "#999", grid: { stroke: a, width: 1 }, ticks: { stroke: a, width: 1 }, font: "10px system-ui, sans-serif", size: 28 }, { show: false, grid: { stroke: a, width: 1 } }], series: l, plugins: [OD()] };
  return new yn(f, o, n);
}
function LD(n, e) {
  const t = [], i = n.split(`
...
const jw = _e.define(), qw = _e.define(), Uw = _e.define(), id = Yt.define({ create() {
  ...
  for (const l of e.effects) {
    if (l.is(Uw) && (s = ((_a2 = l.value) == null ? void 0 : _a2.pos) ?? null, o = ((_b2 = l.value) == null ? void 0 : _b2.message) ?? ""), l.is(jw)) {
      s = null, o = "";
    ...
    l.is(qw) && (i = new Set(i), i.has(l.value) ? i.delete(l.value) : i.add(l.value));
  }
...
class DD extends Ni {
  ...
  toDOM(e) {
    ...
    return t.className = "cm-chart-toggle", t.textContent = this.isCollapsed ? "+" : "\u2212", t.addEventListener("mousedown", (i) => {
      i.preventDefault(), e.dispatch({ effects: qw.of(this.stepIndex) });
    }), t;
  }
  ignoreEvent() {
    return false;
...
class RD extends Ni {
  ...
  toDOM(e) {
    ...
    if (t.className = "cm-chart-widget", t.dataset.stepIndex = String(this.stepIndex), this.step.series.length > 0 && this.step.series[0].timestamps.length > 0) {
      const i = Math.max(200, e.contentDOM.clientWidth - 40), r = _D(t, this.step, i);
      t.__uplot = r;
...
const PD = he.decorations.compute([id], (n) => {
  const { mappings: e, collapsed: t, version: i, errorAfterPos: r, errorMessage: s } = n.field(id), o = [];
  let l = false;
  for (const a of e) {
    if (a.lineStart > n.doc.length) continue;
    const f = r != null && a.lineEnd >= r;
    if (o.push(ve.widget({ widget: new DD(a.stepIndex, t.has(a.stepIndex)), side: -1 }).range(a.lineStart)), !t.has(a.stepIndex) && a.lineEnd <= n.doc.length) {
      let h;
      f ? l ? h = new L0("skipped due to previous error") : (h = new L0(s), l = true) : h = new RD(a.step, a.stepIndex, i), o.push(ve.widget({ widget: h, block: true, side: 1 }).range(a.lineEnd));
    }
  }
  return ve.set(o, true);
}), BD = kt.fromClass(class {
  update(n) {
...
const FD = { datasets: async () => {
  ...
  var _a2;
  return ((_a2 = (await bh())[n]) == null ? void 0 : _a2[e]) ?? [];
} }, HD = UE(FD);
let D0 = 0, Eh = null;
async function VD(n) {
  const e = n.state.doc.toString(), t = ++D0;
  try {
    const i = Vb(e), r = await E2(i);
    if (t !== D0) return;
    const s = LD(e, r);
    n.dispatch({ effects: jw.of(s) });
  } catch {
  }
}
const WD = { editorMode: localStorage.getItem("mpl-editorMode") || "vim", theme: localStorage.getItem("mpl-theme") || "dark", codeEditor: null, codeVimCompartment: new nr(), codeThemeCompartment: new nr(), codeCompletionCompartment: new nr(), codeDiagnosticsCompartment: new nr(), codeSignatureHelpCompartment: new nr(), codeHoverCompartment: new nr(), isInitialized: false, selectedExampleIndex: 0, examples: [], async init() {
  try {
    Th(this.theme) === "dark" && document.documentElement.classList.add("dark-theme"), window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", () => {
      this.theme === "system" && this.onThemeChange();
    }), this.setupKeyboardShortcuts(), this.examples = await ND(), await PE(), this.isInitialized = true, await this.loadSelectedExample(), this.codeEditor && (this.parseEditorContent(this.codeEditor.state.doc.toString()), this.codeEditor.focus());
  } catch (n) {
  ...
  return this.editorMode === "vim" ? CE() : [];
}, getThemeExtension() {
  return Th(this.theme) === "dark" ? JT : [];
}, getExtensions() {
  return [jk(), uk(), fM(), IC(), ek(), ok(), $e.allowMultipleSelections.of(true), kC(), Mv(VC, { fallback: true }), UC(), uT(), Hd(), Ck(), Tk(), vk(), mA(), yd.of([...mT, ...fA, ...BA, ...bM, ...DC, ...Cb, ...LT]), this.codeVimCompartment.of(this.getVimExtension()), this.codeThemeCompartment.of(this.getThemeExtension()), he.lineWrapping, zE, this.codeCompletionCompartment.of(HD), this.codeDiagnosticsCompartment.of(XE), this.codeSignatureHelpCompartment.of(nO), this.codeHoverCompartment.of(aO), ID(), he.updateListener.of((n) => {
  ...
  if (this.isInitialized) {
    try {
      ...
      if (this.codeEditor) try {
        const t = (_a2 = Hb(n)) == null ? void 0 : _a2.find((i) => i.severity === "error");
        if (t) {
          const i = t.message ?? "parse error";
          this.codeEditor.dispatch({ effects: Uw.of({ pos: t.from ?? 0, message: i }) });
        }
      } catch {
      }
      return;
    }
    Eh && clearTimeout(Eh), Eh = setTimeout(() => {
      this.codeEditor && VD(this.codeEditor);
    }, 200);
  }
}, onEditorModeChange() {
  ...
  localStorage.setItem("mpl-theme", this.theme), Th(this.theme) === "dark" ? document.documentElement.classList.add("dark-theme") : document.documentElement.classList.remove("dark-theme");
  ...
  if (n) try {
    ...
    this.codeEditor && (this.codeEditor.dispatch({ changes: { from: 0, to: this.codeEditor.state.doc.length, insert: t } }), this.codeEditor.focus());
  } catch (e) {
